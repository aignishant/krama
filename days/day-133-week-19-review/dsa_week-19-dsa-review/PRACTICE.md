# Practice — Cold re-solve: Tree distance sums
...
First re-solve [day 127](../../day-127-longest-dag-path/dsa_longest-dag-path/README.md), then the core below from
[day 131](../../day-131-tree-distance-sums/dsa_tree-distance-sums/README.md), both from blank code. A harder unresolved problem
...
Return sum of distances from each vertex to all others in a tree rooted arbitrarily; n >= 1.
...
5. Run `python course.py practice 133` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n) time; stretch**.
