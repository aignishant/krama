...
day: 164
track: lang-python
title: "Error messages with line numbers, and a test suite"
theme: "Build F, day 4: errors and tests"
phase: "Languages: six five-day builds"
status: empty
---

# Day 164 · Python — Error messages with line numbers, and a test suite

**Today's theme:** Build F, day 4: errors and tests

**After today you can:** You can report a syntax error a human can act on, and prove the interpreter with tests.

**The interviewer asks it as:** *How do you produce a good error message from a parser?*
