# Day 081 DSA — Minimum spanning cost

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum spanning cost** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-81. **Theme:** Weighted graphs and connectivity.

## Prerequisite and recall

Prior DSA session: [day 80](../../day-080-disjoint-set-queries/dsa_disjoint-set-queries/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 80](../../day-080-disjoint-set-queries/dsa_disjoint-set-queries/README.md), [day 74](../../day-074-dependency-order/dsa_dependency-order/README.md), [day 60](../../day-060-kth-tree-value/dsa_kth-tree-value/README.md)
...
**Minimum spanning cost.** Undirected weighted graph: return minimum total spanning-tree weight, or -1 if disconnected; n >= 1.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(E log E) time.
