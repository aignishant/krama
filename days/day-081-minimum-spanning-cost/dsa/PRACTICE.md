# Practice — Minimum spanning cost

## Contract

Undirected weighted graph: return minimum total spanning-tree weight, or -1 if disconnected; n >= 1.
...
5. Run `python course.py practice 81` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(E log E) time**.
