...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Search capstone** is not yet expanded.
...
Prior DSA session: [day 163](../../day-163-scheduling-capstone/dsa_scheduling-capstone/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 163](../../day-163-scheduling-capstone/dsa_scheduling-capstone/README.md), [day 157](../../day-157-mock-graph/dsa_mock-graph/README.md), [day 143](../../day-143-trapped-rainwater/dsa_trapped-rainwater/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Trie-guided exponential search; state assumptions.
