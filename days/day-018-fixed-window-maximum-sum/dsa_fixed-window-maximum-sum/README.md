# Day 018 DSA — Fixed window maximum sum
...
7. **Recall later without practice:** read the [DSA summary file](../../../docs/DSA_RECALL.md#day-018-fixed-window-maximum-sum) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.
...
**Budget:** 60 minutes. **Outcome:** DSA-18. **Theme:** Two pointers and sliding windows.

## Prerequisite and recall

Prior DSA session: [day 17](../../day-017-container-capacity/dsa_container-capacity/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 17](../../day-017-container-capacity/dsa_container-capacity/README.md), [day 11](../../day-011-group-anagrams/dsa_group-anagrams/README.md)
...
**Fixed window maximum sum.** Return maximum sum of exactly k adjacent values; 1 <= k <= n.
