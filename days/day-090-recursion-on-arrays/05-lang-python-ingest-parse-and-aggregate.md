...
day: 90
track: lang-python
title: "Ingest, parse, and aggregate with generators and multiprocessing"
theme: "Mini project 6: a log analytics pipeline"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 090 · Python — Ingest, parse, and aggregate with generators and multiprocessing

**Today's theme:** Mini project 6: a log analytics pipeline

**After today you can:** You can build the same pipeline in all three, benchmark them, and explain the numbers.

**The interviewer asks it as:** *Process 100 GB of logs and give me the top errors per hour. How?*
