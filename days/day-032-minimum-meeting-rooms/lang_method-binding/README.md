...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Method binding** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-32.
**Weekly theme:** Classes and descriptors.

## Assignment

Inspect a bound method's __self__ and __func__; contrast staticmethod and classmethod.
