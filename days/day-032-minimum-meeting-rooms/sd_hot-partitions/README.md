...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Hot partitions** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-32.
**Weekly theme:** Storage engine tradeoffs.

## Assignment

Show why a single popular link can overload one partition even when total storage is balanced.
