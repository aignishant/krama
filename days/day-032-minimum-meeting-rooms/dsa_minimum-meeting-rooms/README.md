# Day 032 DSA — Minimum meeting rooms

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum meeting rooms** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-32. **Theme:** Sorting, intervals and selection.

## Prerequisite and recall

Prior DSA session: [day 31](../../day-031-insert-an-interval/dsa_insert-an-interval/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 31](../../day-031-insert-an-interval/dsa_insert-an-interval/README.md), [day 25](../../day-025-integer-square-root/dsa_integer-square-root/README.md), [day 11](../../day-011-group-anagrams/dsa_group-anagrams/README.md)
...
**Minimum meeting rooms.** For positive-length half-open intervals [start,end), return peak simultaneous meetings.
