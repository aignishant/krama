# Practice — Minimum meeting rooms
...
For positive-length half-open intervals [start,end), return peak simultaneous meetings.
...
5. Run `python course.py practice 32` from the repository root. The starter is intentionally RED.
