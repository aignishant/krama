...
day: 109
track: lang-go
title: "Generic constraints, type sets, and interface embedding"
theme: "Static typing, deep"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 109 · Go — Generic constraints, type sets, and interface embedding

**Today's theme:** Static typing, deep

**After today you can:** You can express 'any type with a Len method' in each language and get a compile-time error when it is wrong.

**The interviewer asks it as:** *How do you constrain a generic type?*
