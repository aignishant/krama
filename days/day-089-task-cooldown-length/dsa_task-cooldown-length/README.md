...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Task cooldown length** is not yet expanded.
...
Prior DSA session: [day 88](../../day-088-circular-fuel-route/dsa_circular-fuel-route/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 88](../../day-088-circular-fuel-route/dsa_circular-fuel-route/README.md), [day 82](../../day-082-strong-components/dsa_strong-components/README.md), [day 68](../../day-068-tree-reconstruction/dsa_tree-reconstruction/README.md)
