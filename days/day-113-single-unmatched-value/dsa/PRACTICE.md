# Practice — Single unmatched value

## Contract

Every integer appears twice except one. Return that value.
...
5. Run `python course.py practice 113` from the repository root. The starter is intentionally RED.
