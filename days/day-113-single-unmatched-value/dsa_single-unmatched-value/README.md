# Day 113 DSA — Single unmatched value

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Single unmatched value** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-113. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 112](../../day-112-week-16-review/dsa_week-16-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 112](../../day-112-week-16-review/dsa_week-16-dsa-review/README.md), [day 106](../../day-106-zero-one-knapsack/dsa_zero-one-knapsack/README.md), [day 92](../../day-092-climbing-steps/dsa_climbing-steps/README.md)
...
**Single unmatched value.** Every integer appears twice except one. Return that value.
