...
day: 175
track: lang-python
title: "Notification and analytics workers on Kafka"
theme: "Capstone, day 5: events and workers"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 175 · Python — Notification and analytics workers on Kafka

**Today's theme:** Capstone, day 5: events and workers

**After today you can:** You can react to an order event in two services without double-processing.

**The interviewer asks it as:** *What happens if the notification worker receives the same event twice?*
