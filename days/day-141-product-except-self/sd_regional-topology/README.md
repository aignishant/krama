# Day 141 — Regional topology

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Regional topology** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-141.
**Weekly theme:** Multi-region and advanced tradeoffs.

## Assignment

Compare active-passive and active-active for writes; state latency and conflict consequences.
