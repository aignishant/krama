...
Insert new into sorted disjoint closed intervals and merge overlaps.
...
5. Run `python course.py practice 31` from the repository root. The starter is intentionally RED.
