# Day 031 DSA — Insert an interval

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Insert an interval** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-31. **Theme:** Sorting, intervals and selection.

## Prerequisite and recall

Prior DSA session: [day 30](../../day-030-merge-overlapping-intervals/dsa_merge-overlapping-intervals/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 30](../../day-030-merge-overlapping-intervals/dsa_merge-overlapping-intervals/README.md), [day 24](../../day-024-rotated-search/dsa_rotated-search/README.md), [day 10](../../day-010-pair-sum-indices/dsa_pair-sum-indices/README.md)
...
**Insert an interval.** Insert new into sorted disjoint closed intervals and merge overlaps.
