...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Access-pattern modeling** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-31.
**Weekly theme:** Storage engine tradeoffs.

## Assignment

Model recent clicks for one link and aggregate clicks per owner; avoid choosing a database before the queries.
