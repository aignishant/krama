...
7. **Recall later without practice:** read [this day's card](../../../docs/LANG_RECALL.md#day-013-partial-application) for a previously studied topic; reading is not completion.
