...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Partial application** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-13.
**Weekly theme:** Functions and scope.

## Assignment

Use functools.partial to specialize a function; test binding conflicts and distinguish it from a closure.
