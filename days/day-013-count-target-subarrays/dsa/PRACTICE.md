# Practice — Count target subarrays

## Contract

Count contiguous nonempty subarrays summing to k; values may be negative.
...
5. Run `python course.py practice 13` from the repository root. The starter is intentionally RED.
