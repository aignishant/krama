...
day: 158
track: lang-cpp
title: "A columnar time-series store with downsampling"
theme: "Build E, day 3: time-series storage"
phase: "Languages: six five-day builds"
status: empty
---

# Day 158 · C++ — A columnar time-series store with downsampling

**Today's theme:** Build E, day 3: time-series storage

**After today you can:** You can store a million points a minute and query a day in milliseconds.

**The interviewer asks it as:** *How would you store time-series data?*
