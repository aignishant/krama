...
day: 113
track: lang-go
title: "container/list, container/ring, and why maps and slices win"
theme: "Standard library tour II: containers"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 113 · Go — container/list, container/ring, and why maps and slices win

**Today's theme:** Standard library tour II: containers

**After today you can:** You can choose the right container by the operation you need, in each language.

**The interviewer asks it as:** *Which container would you use for an LRU cache?*
