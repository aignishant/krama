# Day 165 — Capstone resilience

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone resilience** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-165.
**Weekly theme:** Final design portfolio.

## Assignment

Document five failure scenarios, detection signals, user impact and recovery steps.
