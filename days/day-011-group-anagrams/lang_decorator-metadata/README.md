...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Decorator metadata** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-11.
**Weekly theme:** Functions and scope.

## Assignment

Write a tracing decorator with functools.wraps and inspect name, docstring and __wrapped__.
