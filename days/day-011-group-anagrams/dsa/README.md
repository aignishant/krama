...
Prior DSA session: [day 10](../../day-010-pair-sum-indices/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 10](../../day-010-pair-sum-indices/dsa/README.md), [day 4](../../day-004-reverse-a-segment/dsa/README.md)
