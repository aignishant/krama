...
Group lowercase strings by letters. Sort strings within each group and sort the groups lexicographically.
...
5. Run `python course.py practice 11` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Explain character-key construction plus output sorting costs**.
