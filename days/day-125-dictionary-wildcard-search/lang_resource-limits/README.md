# Day 125 — Resource limits

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Resource limits** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-125.
**Weekly theme:** Persistence and safe I/O.

## Assignment

Read a stream in bounded chunks with a maximum total size and test rejection at the boundary.
