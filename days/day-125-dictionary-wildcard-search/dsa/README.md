...
Prior DSA session: [day 124](../../day-124-smallest-covering-window/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 124](../../day-124-smallest-covering-window/dsa/README.md), [day 118](../../day-118-mutable-range-minima/dsa/README.md), [day 104](../../day-104-word-segmentation/dsa/README.md)
...
[HINTS.md](HINTS.md), so the first attempt remains independent. Expected target: Query may branch exponentially in wildcard count.
