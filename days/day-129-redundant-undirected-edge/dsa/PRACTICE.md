# Practice — Redundant undirected edge

## Contract

A tree has one extra edge added. Return the first input edge whose insertion connects already-connected vertices.
...
5. Run `python course.py practice 129` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Near-linear with disjoint sets**.
