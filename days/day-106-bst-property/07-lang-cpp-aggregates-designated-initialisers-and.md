...
day: 106
track: lang-cpp
title: "Aggregates, designated initialisers, and builder structs"
theme: "Data modelling idioms"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 106 · C++ — Aggregates, designated initialisers, and builder structs

**Today's theme:** Data modelling idioms

**After today you can:** You can model a config or a record idiomatically in each language, with validation.

**The interviewer asks it as:** *How do you validate a struct on construction?*
