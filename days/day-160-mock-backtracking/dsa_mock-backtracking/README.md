# Day 160 DSA — Mock backtracking

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock backtracking** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-160. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 159](../../day-159-mock-heap/dsa_mock-heap/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 159](../../day-159-mock-heap/dsa_mock-heap/README.md), [day 153](../../day-153-minimum-interval-for-queries/dsa_minimum-interval-for-queries/README.md), [day 139](../../day-139-autocomplete-ranking/dsa_autocomplete-ranking/README.md)
...
**Mock backtracking.** Return all palindrome partitions of text, each a list of substrings; sort outer list lexicographically.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Output-sensitive exponential; palindrome precomputation optional.
