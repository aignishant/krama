...
Return all palindrome partitions of text, each a list of substrings; sort outer list lexicographically.
...
5. Run `python course.py practice 160` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Output-sensitive exponential; palindrome precomputation optional**.
