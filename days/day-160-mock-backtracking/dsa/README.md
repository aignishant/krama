...
Prior DSA session: [day 159](../../day-159-mock-heap/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 159](../../day-159-mock-heap/dsa/README.md), [day 153](../../day-153-minimum-interval-for-queries/dsa/README.md), [day 139](../../day-139-autocomplete-ranking/dsa/README.md)
