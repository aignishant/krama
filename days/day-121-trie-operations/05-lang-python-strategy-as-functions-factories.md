...
day: 121
track: lang-python
title: "Strategy as functions, factories as classmethods, builders as kwargs"
theme: "Design patterns I: strategy, factory, builder"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 121 · Python — Strategy as functions, factories as classmethods, builders as kwargs

**Today's theme:** Design patterns I: strategy, factory, builder

**After today you can:** You can implement the three most-asked creational patterns idiomatically in each language.

**The interviewer asks it as:** *Implement the builder pattern. Now say why Python rarely needs it.*
