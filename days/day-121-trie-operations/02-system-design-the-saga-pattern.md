...
**After today you can:** You can replace a distributed transaction with compensating actions.

**The interviewer asks it as:** *Booking a trip touches flights, hotels and payments. Design it.*
