...
**After today you can:** You can implement all three and state the complexity in terms of word length.

**The interviewer asks it as:** *Implement a trie with insert, search and startsWith.*
