...
day: 112
track: lang-python
title: "itertools, functools, bisect, and heapq"
theme: "Standard library tour I: algorithms"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 112 · Python — itertools, functools, bisect, and heapq

**Today's theme:** Standard library tour I: algorithms

**After today you can:** You can reach for the standard function instead of writing the loop, in each language.

**The interviewer asks it as:** *How would you find the k largest items?*
