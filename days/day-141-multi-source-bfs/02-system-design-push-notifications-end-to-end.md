...
**After today you can:** You can trace a notification from your server to the phone's lock screen.

**The interviewer asks it as:** *How does a push notification actually reach the device?*
