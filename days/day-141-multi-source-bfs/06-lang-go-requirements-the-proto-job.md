...
day: 141
track: lang-go
title: "Requirements, the .proto job schema, and the Go worker skeleton"
theme: "Build B, day 1: a job queue. Design"
phase: "Languages: six five-day builds"
status: empty
---

# Day 141 · Go — Requirements, the .proto job schema, and the Go worker skeleton

**Today's theme:** Build B, day 1: a job queue. Design

**After today you can:** You can design a job system with a submit API, a queue, workers, and status.

**The interviewer asks it as:** *Design a background job system.*
