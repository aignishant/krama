...
day: 91
track: lang-python
title: "confluent-kafka: produce, consume, commit"
theme: "Message brokers: Kafka"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 091 · Python — confluent-kafka: produce, consume, commit

**Today's theme:** Message brokers: Kafka

**After today you can:** You can publish and consume events with a consumer group in each language.

**The interviewer asks it as:** *What is a message queue for?*
