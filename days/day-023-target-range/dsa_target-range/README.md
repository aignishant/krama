# Day 023 DSA — Target range

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Target range** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-23. **Theme:** Binary search and ordered answers.

## Prerequisite and recall

Prior DSA session: [day 22](../../day-022-lower-bound/dsa_lower-bound/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 22](../../day-022-lower-bound/dsa_lower-bound/README.md), [day 16](../../day-016-unique-triples/dsa_unique-triples/README.md), [day 2](../../day-002-find-the-first-maximum/dsa_find-the-first-maximum/README.md)
...
**Target range.** Return first and last target indices in sorted nums, or [-1,-1].
