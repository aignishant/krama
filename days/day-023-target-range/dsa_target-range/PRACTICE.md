...
Return first and last target indices in sorted nums, or [-1,-1].
...
5. Run `python course.py practice 23` from the repository root. The starter is intentionally RED.
