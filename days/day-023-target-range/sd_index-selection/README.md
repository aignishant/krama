...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-23.
**Weekly theme:** Relational storage and indexes.

## Assignment

Choose an index for owner plus newest-first lookup; show why a different column order changes usefulness.
