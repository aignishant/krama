...
day: 117
track: lang-cpp
title: "clang-tidy, cppcheck, and warnings as errors"
theme: "Linting and static analysis"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 117 · C++ — clang-tidy, cppcheck, and warnings as errors

**Today's theme:** Linting and static analysis

**After today you can:** You can make the tools catch a real bug before a human reads the code, in each language.

**The interviewer asks it as:** *What does a linter catch that tests do not?*
