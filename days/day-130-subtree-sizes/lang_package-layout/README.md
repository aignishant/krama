# Day 130 — Package layout

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Package layout** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-130.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Sketch a src-layout package, tests and pyproject.toml; explain runtime versus build dependencies.
