...
day: 86
track: lang-python
title: "Generators, iterators over files, and chunked reads"
theme: "Streaming large data"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 086 · Python — Generators, iterators over files, and chunked reads

**Today's theme:** Streaming large data

**After today you can:** You can process a 50 GB file with constant memory in each language.

**The interviewer asks it as:** *Why is io.Reader everywhere in Go?*
