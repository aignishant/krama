# Practice — Validate search tree

## Contract

Return whether every left descendant is strictly smaller and every right descendant strictly larger. Duplicates invalid.
...
Input:
```json
{"tree":[5,[1,null,null],[4,[3,null,null],[6,null,null]]]}
```
...
5. Run `python course.py practice 59` from the repository root. The starter is intentionally RED.
