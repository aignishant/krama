...
day: 110
track: lang-python
title: "TaskGroup, semaphores, cancellation, and aiohttp"
theme: "Async, deep"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 110 · Python — TaskGroup, semaphores, cancellation, and aiohttp

**Today's theme:** Async, deep

**After today you can:** You can run bounded concurrent work with error propagation in each language.

**The interviewer asks it as:** *Ten calls are in flight and one fails. What happens to the other nine?*
