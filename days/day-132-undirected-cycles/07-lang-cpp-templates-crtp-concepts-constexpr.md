...
day: 132
track: lang-cpp
title: "Templates, CRTP, concepts, constexpr, and compile-time tables"
theme: "C++, deep: templates and constexpr"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 132 · C++ — Templates, CRTP, concepts, constexpr, and compile-time tables

**Today's theme:** C++, deep: templates and constexpr

**After today you can:** You can write a compile-time lookup table and a CRTP base class, and say what each buys.

**The interviewer asks it as:** *What is CRTP, and why would you use it?*
