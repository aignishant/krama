...
day: 120
track: lang-python
title: "A published Python package with docs and tests"
theme: "Mini project 8: a rate-limiter library"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 120 · Python — A published Python package with docs and tests

**Today's theme:** Mini project 8: a rate-limiter library

**After today you can:** You can ship a small, correct, documented library in all three languages.

**The interviewer asks it as:** *Show me a library you wrote. How would I use it?*
