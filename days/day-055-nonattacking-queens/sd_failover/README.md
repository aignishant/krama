...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Failover** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-55.
**Weekly theme:** Replication and consistency.

## Assignment

Draw leader failure, detection, election and client retry; identify split-brain prevention.
