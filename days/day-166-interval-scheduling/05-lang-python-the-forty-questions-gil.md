...
day: 166
track: lang-python
title: "The forty questions: GIL, memory, decorators, generators, typing"
theme: "Python interview questions"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 166 · Python — The forty questions: GIL, memory, decorators, generators, typing

**Today's theme:** Python interview questions

**After today you can:** You can answer the forty most-asked Python questions out loud.

**The interviewer asks it as:** *What is the GIL, and when does it matter?*
