...
**After today you can:** You can design the suggestion index, the ranking, and the update pipeline.

**The interviewer asks it as:** *Design Google's search suggestions.*
