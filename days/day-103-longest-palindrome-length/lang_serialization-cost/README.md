# Day 103 — Serialization cost

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Serialization cost** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-103.
**Weekly theme:** Threads and processes.

## Assignment

Measure transfer cost for a modest payload and explain when process parallelism loses to overhead.
