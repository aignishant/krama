# Day 103 DSA — Longest palindrome length

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Longest palindrome length** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-103. **Theme:** Dynamic programming on grids and strings.

## Prerequisite and recall

Prior DSA session: [day 102](../../day-102-edit-distance/dsa_edit-distance/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 102](../../day-102-edit-distance/dsa_edit-distance/README.md), [day 96](../../day-096-increasing-subsequence/dsa_increasing-subsequence/README.md), [day 82](../../day-082-strong-components/dsa_strong-components/README.md)
...
**Longest palindrome length.** Return length of longest contiguous palindromic substring; empty returns 0. Implement interval DP.
