...
day: 115
track: lang-cpp
title: "vcpkg or Conan, a CMake package config, and an install target"
theme: "Publishing a library"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 115 · C++ — vcpkg or Conan, a CMake package config, and an install target

**Today's theme:** Publishing a library

**After today you can:** You can publish a library someone else can install, in each language.

**The interviewer asks it as:** *How do you version a library without breaking users?*
