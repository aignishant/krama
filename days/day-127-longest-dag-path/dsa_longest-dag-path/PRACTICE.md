...
Return max edge count along any path in a directed acyclic graph; n >= 1.
...
5. Run `python course.py practice 127` from the repository root. The starter is intentionally RED.
