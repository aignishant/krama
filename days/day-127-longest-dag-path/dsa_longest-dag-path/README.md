# Day 127 DSA — Longest DAG path

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Longest DAG path** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-127. **Theme:** Advanced graph and tree practice.

## Prerequisite and recall

Prior DSA session: [day 126](../../day-126-week-18-review/dsa_week-18-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 126](../../day-126-week-18-review/dsa_week-18-dsa-review/README.md), [day 120](../../day-120-normalize-text-units/dsa_normalize-text-units/README.md), [day 106](../../day-106-zero-one-knapsack/dsa_zero-one-knapsack/README.md)
...
**Longest DAG path.** Return max edge count along any path in a directed acyclic graph; n >= 1.
