# Day 148 DSA — Interleaved strings

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Interleaved strings** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-148. **Theme:** Mixed pattern selection II.

## Prerequisite and recall

Prior DSA session: [day 147](../../day-147-week-21-review/dsa_week-21-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 147](../../day-147-week-21-review/dsa_week-21-dsa-review/README.md), [day 141](../../day-141-product-except-self/dsa_product-except-self/README.md), [day 127](../../day-127-longest-dag-path/dsa_longest-dag-path/README.md)
...
**Interleaved strings.** Return whether c interleaves a and b while preserving each string's internal order.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(len(a)*len(b)) time.
