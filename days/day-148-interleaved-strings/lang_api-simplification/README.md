# Day 148 — API simplification

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **API simplification** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-148.
**Weekly theme:** Code review and refactoring.

## Assignment

Refactor a boolean-flag-heavy function into explicit operations while keeping behavior tests.
