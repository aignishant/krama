# Day 085 — Trust boundaries

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Trust boundaries** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-85.
**Weekly theme:** Security and tenancy.

## Assignment

Mark untrusted input and privileged calls on the link-service diagram; choose validation at each boundary.
