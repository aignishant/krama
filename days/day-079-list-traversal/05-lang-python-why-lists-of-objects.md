...
day: 79
track: lang-python
title: "Why lists of objects are slow, and arrays of numbers are fast"
theme: "Cache-friendly data layout"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 079 · Python — Why lists of objects are slow, and arrays of numbers are fast

**Today's theme:** Cache-friendly data layout

**After today you can:** You can explain, with a measurement, why the same loop is ten times faster with a different layout.

**The interviewer asks it as:** *Why is iterating a linked list slower than iterating an array?*
