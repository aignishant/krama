...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Schema constraints** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-22.
**Weekly theme:** Relational storage and indexes.

## Assignment

Write tables and unique/foreign-key constraints for links and owners; distinguish product rules from lookup needs.
