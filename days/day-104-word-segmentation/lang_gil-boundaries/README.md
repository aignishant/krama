# Day 104 — GIL boundaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **GIL boundaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-104.
**Weekly theme:** Threads and processes.

## Assignment

Separate interpreter-specific threading behavior from language guarantees; check current documentation before discussing free-threaded builds.
