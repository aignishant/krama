# Day 110 — Weak references

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Weak references** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-110.
**Weekly theme:** Profiling and memory.

## Assignment

Build a weak-reference lookup for objects and distinguish cache ownership from observation.
