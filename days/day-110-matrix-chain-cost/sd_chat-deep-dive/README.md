# Day 110 — Chat deep dive

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Chat deep dive** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-110.
**Weekly theme:** Chat case study.

## Assignment

Trace retry, deduplication and per-conversation ordering across reconnects.
