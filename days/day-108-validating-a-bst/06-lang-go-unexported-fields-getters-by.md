...
day: 108
track: lang-go
title: "Unexported fields, getters by convention, and method values"
theme: "Encapsulation"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 108 · Go — Unexported fields, getters by convention, and method values

**Today's theme:** Encapsulation

**After today you can:** You can hide a field and expose a computed one in each language.

**The interviewer asks it as:** *When would you use a getter instead of a public field?*
