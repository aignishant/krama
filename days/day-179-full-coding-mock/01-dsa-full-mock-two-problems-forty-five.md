...
**After today you can:** You can perform under a clock, with someone watching, which is a separate skill.

**The interviewer asks it as:** *One medium, one hard. The clock is running.*
