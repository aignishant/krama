# Practice — Minimum positive window

## Contract

Return shortest nonempty subarray length with sum >= target, or 0. Values and target are positive integers.
...
5. Run `python course.py practice 20` from the repository root. The starter is intentionally RED.
