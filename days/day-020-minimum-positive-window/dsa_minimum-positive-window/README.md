# Day 020 DSA — Minimum positive window
...
7. **Recall later without practice:** read the [DSA summary file](../../../docs/DSA_RECALL.md#day-020-minimum-positive-window) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.
...
**Budget:** 60 minutes. **Outcome:** DSA-20. **Theme:** Two pointers and sliding windows.

## Prerequisite and recall

Prior DSA session: [day 19](../../day-019-longest-distinct-substring/dsa_longest-distinct-substring/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 19](../../day-019-longest-distinct-substring/dsa_longest-distinct-substring/README.md), [day 13](../../day-013-count-target-subarrays/dsa_count-target-subarrays/README.md)
...
**Minimum positive window.** Return shortest nonempty subarray length with sum >= target, or 0. Values and target are positive integers.
...
Read [the topic explanation](CONCEPTS.md), including its trace and readiness check, before the first attempt.
The [week 3 pattern guide](../../../docs/DSA_PATTERN_GUIDE.md) is optional wider context.
