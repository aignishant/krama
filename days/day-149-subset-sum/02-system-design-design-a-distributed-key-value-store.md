...
**After today you can:** You can design partitioning, replication, and the consistency guarantee.

**The interviewer asks it as:** *Design a key-value store like DynamoDB.*
