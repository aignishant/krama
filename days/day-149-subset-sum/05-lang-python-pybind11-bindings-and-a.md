...
day: 149
track: lang-python
title: "pybind11 bindings and a Python API"
theme: "Build C, day 4: bindings"
phase: "Languages: six five-day builds"
status: empty
---

# Day 149 · Python — pybind11 bindings and a Python API

**Today's theme:** Build C, day 4: bindings

**After today you can:** You can call the C++ engine from Python and Go.

**The interviewer asks it as:** *How do you expose a C++ library to other languages?*
