...
day: 157
track: lang-go
title: "Collecting CPU, memory, and app metrics; shipping over gRPC"
theme: "Build E, day 2: the agent"
phase: "Languages: six five-day builds"
status: empty
---

# Day 157 · Go — Collecting CPU, memory, and app metrics; shipping over gRPC

**Today's theme:** Build E, day 2: the agent

**After today you can:** You can collect and ship metrics from a host every ten seconds.

**The interviewer asks it as:** *How does a metrics agent avoid overloading the collector?*
