...
day: 95
track: lang-python
title: "A token bucket, and tenacity for retries with backoff"
theme: "Rate limiting and retries"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 095 · Python — A token bucket, and tenacity for retries with backoff

**Today's theme:** Rate limiting and retries

**After today you can:** You can protect a service from too many calls and retry safely, in each language.

**The interviewer asks it as:** *Why is retrying immediately worse than not retrying at all?*
