...
**After today you can:** You can run requirements, estimation, API, data model, architecture and deep-dive in order.

**The interviewer asks it as:** *Design something. Show me your process, not just your answer.*
