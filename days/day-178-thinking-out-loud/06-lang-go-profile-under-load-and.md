...
day: 178
track: lang-go
title: "Profile under load and fix the top hotspot"
theme: "Capstone, day 8: load test and review"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 178 · Go — Profile under load and fix the top hotspot

**Today's theme:** Capstone, day 8: load test and review

**After today you can:** You can state the platform's throughput and latency and what you fixed to get there.

**The interviewer asks it as:** *What is your p99 latency, and what limits it?*
