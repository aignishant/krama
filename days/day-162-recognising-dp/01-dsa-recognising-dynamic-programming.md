...
day: 162
track: dsa
title: "Recognising dynamic programming in an interview"
phase: "Dynamic programming"
status: empty
---

# Day 162 · DSA — Recognising dynamic programming in an interview

**After today you can:** You can tell within two minutes whether a problem is greedy, DP, or search.

**The interviewer asks it as:** *Is this greedy or DP? How do you know?*
