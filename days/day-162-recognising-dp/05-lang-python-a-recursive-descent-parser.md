...
day: 162
track: lang-python
title: "A recursive-descent parser in Python"
theme: "Build F, day 2: the parser"
phase: "Languages: six five-day builds"
status: empty
---

# Day 162 · Python — A recursive-descent parser in Python

**Today's theme:** Build F, day 2: the parser

**After today you can:** You can turn tokens into a tree with correct precedence, in each language.

**The interviewer asks it as:** *How does a parser handle operator precedence?*
