...
day: 130
track: lang-go
title: "A tour of a well-written Go package from the standard library"
theme: "Reading idiomatic code"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 130 · Go — A tour of a well-written Go package from the standard library

**Today's theme:** Reading idiomatic code

**After today you can:** You can read a real codebase in each language and say what is idiomatic and what is not.

**The interviewer asks it as:** *What does idiomatic mean in your language?*
