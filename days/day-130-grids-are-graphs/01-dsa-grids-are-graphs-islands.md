...
**After today you can:** You can treat a matrix as a graph and get the neighbour logic right every time.

**The interviewer asks it as:** *Count the number of islands in this grid.*
