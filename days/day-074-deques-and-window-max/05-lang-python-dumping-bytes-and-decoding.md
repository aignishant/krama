...
day: 74
track: lang-python
title: "Dumping bytes and decoding them with the Python library"
theme: "The wire format, decoded by hand"
phase: "Languages: Protocol Buffers and gRPC"
status: empty
---

# Day 074 · Python — Dumping bytes and decoding them with the Python library

**Today's theme:** The wire format, decoded by hand

**After today you can:** You can look at 08 96 01 and say what field and what value it is.

**The interviewer asks it as:** *How is a protobuf message laid out in bytes?*
