...
day: 89
track: lang-go
title: "Interfaces plus registration, and why the plugin package is avoided"
theme: "Plugins"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 089 · Go — Interfaces plus registration, and why the plugin package is avoided

**Today's theme:** Plugins

**After today you can:** You can let someone add behaviour to your program without recompiling it, in each language.

**The interviewer asks it as:** *How would you let users extend your tool?*
