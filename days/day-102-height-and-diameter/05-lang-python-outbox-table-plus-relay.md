...
day: 102
track: lang-python
title: "Outbox table plus relay in Python"
theme: "The outbox pattern and event sourcing"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 102 · Python — Outbox table plus relay in Python

**Today's theme:** The outbox pattern and event sourcing

**After today you can:** You can publish an event and write to the database atomically, in each language.

**The interviewer asks it as:** *How do you write to Postgres and publish to Kafka without losing either?*
