...
day: 170
track: lang-python
title: "A guided read of a popular Python service codebase"
theme: "Reading production code"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 170 · Python — A guided read of a popular Python service codebase

**Today's theme:** Reading production code

**After today you can:** You can open a large unfamiliar codebase in each language and find where a request is handled.

**The interviewer asks it as:** *You join a team with a 200k-line codebase. Day one, what do you do?*
