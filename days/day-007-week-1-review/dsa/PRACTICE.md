...
First re-solve [day 1](../../day-001-count-target-values/dsa/README.md), then the core below from
[day 5](../../day-005-merge-sorted-arrays/dsa/README.md), both from blank code. A harder unresolved problem
...
Return a new sorted list containing all values from sorted lists a and b, including duplicates.
...
5. Run `python course.py practice 7` from the repository root. The starter is intentionally RED.
