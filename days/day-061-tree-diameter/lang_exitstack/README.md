...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **ExitStack** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-61.
**Weekly theme:** Exceptions and resource lifetime.

## Assignment

Manage a variable number of resources and confirm reverse-order cleanup with a local trace.
