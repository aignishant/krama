...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-12.
**Weekly theme:** Functions and scope.

## Assignment

Write a configurable validation decorator without swallowing the wrapped exception.
