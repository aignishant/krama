...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Timeout propagation** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-12.
**Weekly theme:** Networking and HTTP.

## Assignment

Draw a three-hop call with one overall deadline and smaller per-hop budgets; show what cancellation does downstream.
