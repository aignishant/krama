# Practice — Zero-one knapsack

## Contract

Return max value fitting capacity; positive weights, nonnegative values, each item used at most once.
...
5. Run `python course.py practice 106` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n*capacity) time**.
