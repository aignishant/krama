# Day 106 DSA — Zero-one knapsack

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Zero-one knapsack** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-106. **Theme:** Knapsack and advanced DP states.

## Prerequisite and recall

Prior DSA session: [day 105](../../day-105-week-15-review/dsa_week-15-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 105](../../day-105-week-15-review/dsa_week-15-dsa-review/README.md), [day 99](../../day-099-grid-path-count/dsa_grid-path-count/README.md), [day 85](../../day-085-maximum-compatible-meetings/dsa_maximum-compatible-meetings/README.md)
...
**Zero-one knapsack.** Return max value fitting capacity; positive weights, nonnegative values, each item used at most once.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n*capacity) time.
