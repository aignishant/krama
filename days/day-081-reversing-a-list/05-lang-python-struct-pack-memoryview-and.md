...
day: 81
track: lang-python
title: "struct.pack, memoryview, and reading a binary header"
theme: "Binary data"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 081 · Python — struct.pack, memoryview, and reading a binary header

**Today's theme:** Binary data

**After today you can:** You can read and write a binary file format with a header in each language.

**The interviewer asks it as:** *What is endianness, and when does it bite?*
