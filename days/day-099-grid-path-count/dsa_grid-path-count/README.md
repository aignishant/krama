...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Grid path count** is not yet expanded.
...
Prior DSA session: [day 98](../../day-098-week-14-review/dsa_week-14-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 98](../../day-098-week-14-review/dsa_week-14-dsa-review/README.md), [day 92](../../day-092-climbing-steps/dsa_climbing-steps/README.md), [day 78](../../day-078-nonnegative-shortest-paths/dsa_nonnegative-shortest-paths/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(rows*cols) time; O(cols) state.
