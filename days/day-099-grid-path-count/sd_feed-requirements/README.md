# Day 099 — Feed requirements

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Feed requirements** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-99.
**Weekly theme:** Feed case study.

## Assignment

Choose chronological versus ranked feed, follow semantics and acceptable freshness.
