...
day: 174
track: lang-cpp
title: "The C++ pricing engine: rules, discounts, and sub-millisecond latency"
theme: "Capstone, day 4: the pricing engine"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 174 · C++ — The C++ pricing engine: rules, discounts, and sub-millisecond latency

**Today's theme:** Capstone, day 4: the pricing engine

**After today you can:** You can build a service that answers in under a millisecond and prove it.

**The interviewer asks it as:** *Why is this service in C++?*
