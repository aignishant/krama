...
**After today you can:** You can sieve primes, compute a GCD, and do modular arithmetic without overflow worry.

**The interviewer asks it as:** *Find all primes below one million.*
