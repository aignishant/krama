...
day: 116
track: lang-go
title: "godoc conventions, examples that run as tests"
theme: "Documentation"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 116 · Go — godoc conventions, examples that run as tests

**Today's theme:** Documentation

**After today you can:** You can document a package so a stranger can use it, in each language.

**The interviewer asks it as:** *What belongs in a README?*
