# Day 008 DSA — First repeated value

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **First repeated value** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-08. **Theme:** Hashing and prefix sums.

## Prerequisite and recall

Prior DSA session: [day 7](../../day-007-week-1-review/dsa_week-1-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 7](../../day-007-week-1-review/dsa_week-1-dsa-review/README.md), [day 1](../../day-001-count-target-values/dsa_count-target-values/README.md)
...
**First repeated value.** Return the first value whose second occurrence is encountered scanning left to right, or null.
