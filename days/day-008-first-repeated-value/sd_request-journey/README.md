...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Request journey** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-08.
**Weekly theme:** Networking and HTTP.

## Assignment

Draw DNS lookup, connection establishment, TLS, request and response for a browser opening a shortened URL.
