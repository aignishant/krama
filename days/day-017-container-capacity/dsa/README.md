...
Prior DSA session: [day 16](../../day-016-unique-triples/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 16](../../day-016-unique-triples/dsa/README.md), [day 10](../../day-010-pair-sum-indices/dsa/README.md)
