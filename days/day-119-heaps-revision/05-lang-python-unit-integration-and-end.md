...
day: 119
track: lang-python
title: "Unit, integration, and end-to-end with pytest markers"
theme: "Test strategy"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 119 · Python — Unit, integration, and end-to-end with pytest markers

**Today's theme:** Test strategy

**After today you can:** You can say what to test at which level, and keep the suite fast, in each language.

**The interviewer asks it as:** *What is the testing pyramid and where does most of your time go?*
