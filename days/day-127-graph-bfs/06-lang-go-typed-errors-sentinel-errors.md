...
day: 127
track: lang-go
title: "Typed errors, sentinel errors, and mapping to gRPC codes"
theme: "Error architecture"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 127 · Go — Typed errors, sentinel errors, and mapping to gRPC codes

**Today's theme:** Error architecture

**After today you can:** You can design how errors flow from the database to the user, in each language.

**The interviewer asks it as:** *A row is missing. What does the user see, and how did it get there?*
