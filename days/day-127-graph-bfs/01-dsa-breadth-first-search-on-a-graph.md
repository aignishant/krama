...
**After today you can:** You can write BFS with a queue and a visited set, and never revisit a node.

**The interviewer asks it as:** *Traverse this graph breadth-first.*
