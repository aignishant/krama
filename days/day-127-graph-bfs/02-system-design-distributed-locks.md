...
**After today you can:** You can implement one and name the failure mode that makes it unsafe.

**The interviewer asks it as:** *Implement a distributed lock. What if the holder crashes?*
