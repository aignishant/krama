...
day: 70
track: lang-go
title: "status.Error, codes, context deadlines, and metadata.MD"
theme: "gRPC IV: errors, deadlines, metadata"
phase: "Languages: Protocol Buffers and gRPC"
status: empty
---

# Day 070 · Go — status.Error, codes, context deadlines, and metadata.MD

**Today's theme:** gRPC IV: errors, deadlines, metadata

**After today you can:** You can return a proper error with a code, propagate a deadline, and pass a request ID, in each language.

**The interviewer asks it as:** *How do errors work in gRPC?*
