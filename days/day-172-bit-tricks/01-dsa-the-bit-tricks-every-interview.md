...
**After today you can:** You can count set bits, check powers of two, and clear the lowest bit, from memory.

**The interviewer asks it as:** *Count the number of ones in the binary representation.*
