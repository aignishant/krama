...
day: 172
track: lang-python
title: "FastAPI gateway: auth, validation, and gRPC calls"
theme: "Capstone, day 2: the gateway"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 172 · Python — FastAPI gateway: auth, validation, and gRPC calls

**Today's theme:** Capstone, day 2: the gateway

**After today you can:** You can accept a request at the edge, validate it, and forward it over gRPC.

**The interviewer asks it as:** *What belongs in an API gateway?*
