...
day: 84
track: lang-python
title: "pathlib, os.walk, tempfile, permissions, and watching for changes"
theme: "The filesystem"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 084 · Python — pathlib, os.walk, tempfile, permissions, and watching for changes

**Today's theme:** The filesystem

**After today you can:** You can walk a tree, write atomically, and react to changes in each language.

**The interviewer asks it as:** *How do you write a file so a crash never leaves it half-written?*
