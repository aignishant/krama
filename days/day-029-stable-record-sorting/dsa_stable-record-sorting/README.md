# Day 029 DSA — Stable record sorting

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Stable record sorting** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-29. **Theme:** Sorting, intervals and selection.

## Prerequisite and recall

Prior DSA session: [day 28](../../day-028-week-4-review/dsa_week-4-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 28](../../day-028-week-4-review/dsa_week-4-dsa-review/README.md), [day 22](../../day-022-lower-bound/dsa_lower-bound/README.md), [day 8](../../day-008-first-repeated-value/dsa_first-repeated-value/README.md)
...
**Stable record sorting.** Return records sorted ascending by score while preserving original order on ties. Implement merge sort once.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n log n) time; O(n) space.
