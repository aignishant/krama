...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Attribute lookup** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-29.
**Weekly theme:** Classes and descriptors.

## Assignment

Demonstrate instance versus class attributes and explain lookup after shadowing an instance name.
