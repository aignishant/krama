...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tree indexes** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-29.
**Weekly theme:** Storage engine tradeoffs.

## Assignment

Sketch page lookup and a page split in an ordered index; identify read and write amplification.
