...
Return length of longest subarray containing at most k distinct integers; k >= 0.
...
5. Run `python course.py practice 155` from the repository root. The starter is intentionally RED.
