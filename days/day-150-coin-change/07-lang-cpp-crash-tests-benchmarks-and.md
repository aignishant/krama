...
day: 150
track: lang-cpp
title: "Crash tests, benchmarks, and docs"
theme: "Build C, day 5: ship it"
phase: "Languages: six five-day builds"
status: empty
---

# Day 150 · C++ — Crash tests, benchmarks, and docs

**Today's theme:** Build C, day 5: ship it

**After today you can:** You can prove the engine survives a crash and ship it with benchmarks.

**The interviewer asks it as:** *How would you test that a database survives a power cut?*
