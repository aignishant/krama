...
**After today you can:** You can design IDs that are unique, roughly sortable, and generated without coordination.

**The interviewer asks it as:** *Generate unique IDs across a hundred servers. No central counter.*
