...
First re-solve [day 29](../../day-029-stable-record-sorting/dsa_stable-record-sorting/README.md), then the core below from
[day 33](../../day-033-kth-smallest/dsa_kth-smallest/README.md), both from blank code. A harder unresolved problem
...
Return kth smallest value, counting duplicates; k is one-based and valid. Implement partition-based selection.
...
5. Run `python course.py practice 35` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Expected O(n), worst O(n^2); explain pivot choice**.
