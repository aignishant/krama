...
day: 92
track: lang-python
title: "Consumer groups, partitions, and ordering guarantees from Python"
theme: "Pub/sub patterns"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 092 · Python — Consumer groups, partitions, and ordering guarantees from Python

**Today's theme:** Pub/sub patterns

**After today you can:** You can explain at-least-once versus at-most-once and write an idempotent consumer in each language.

**The interviewer asks it as:** *What happens if your consumer crashes after processing but before committing?*
