# Day 088 DSA — Circular fuel route

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Circular fuel route** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-88. **Theme:** Greedy choices and exchange arguments.

## Prerequisite and recall

Prior DSA session: [day 87](../../day-087-minimum-jumps/dsa_minimum-jumps/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 87](../../day-087-minimum-jumps/dsa_minimum-jumps/README.md), [day 81](../../day-081-minimum-spanning-cost/dsa_minimum-spanning-cost/README.md), [day 67](../../day-067-prefix-dictionary/dsa_prefix-dictionary/README.md)
...
**Circular fuel route.** Return smallest valid start index completing the circuit, or -1. gas and cost have equal positive length and nonnegative values.
