# Day 142 — Recovery objectives

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Recovery objectives** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-142.
**Weekly theme:** Multi-region and advanced tradeoffs.

## Assignment

Choose hypothetical RPO and RTO and show which backup/replication actions support them.
