# Practice — Longest consecutive run

## Contract

Return length of longest consecutive integer set sequence; duplicates do not extend it.
...
5. Run `python course.py practice 142` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Expected O(n) time**.
