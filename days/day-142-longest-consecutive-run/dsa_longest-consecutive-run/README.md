# Day 142 DSA — Longest consecutive run

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Longest consecutive run** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-142. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 141](../../day-141-product-except-self/dsa_product-except-self/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 141](../../day-141-product-except-self/dsa_product-except-self/README.md), [day 135](../../day-135-frequency-stack/dsa_frequency-stack/README.md), [day 121](../../day-121-prefix-border-lengths/dsa_prefix-border-lengths/README.md)
...
**Longest consecutive run.** Return length of longest consecutive integer set sequence; duplicates do not extend it.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Expected O(n) time.
