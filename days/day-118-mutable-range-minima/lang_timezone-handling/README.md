# Day 118 — Timezone handling

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Timezone handling** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-118.
**Weekly theme:** Files, text and data boundaries.

## Assignment

Create aware datetimes with zoneinfo and reason about ambiguous local times using documented behavior.
