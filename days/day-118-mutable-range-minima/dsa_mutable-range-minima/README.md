# Day 118 DSA — Mutable range minima

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mutable range minima** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-118. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 117](../../day-117-mutable-range-sums/dsa_mutable-range-sums/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 117](../../day-117-mutable-range-sums/dsa_mutable-range-sums/README.md), [day 111](../../day-111-visit-every-city/dsa_visit-every-city/README.md), [day 97](../../day-097-decode-digits/dsa_decode-digits/README.md)
...
**Mutable range minima.** Process [set,index,value] and [min,left,right] inclusive on nonempty nums; return minima. Use a segment tree.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) per query/update.
This is a target to justify, not a claim that any implementation meets it.

## Learn and explain

Read [week 17 in the DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md) for this week's mechanism before the first attempt.
...
Use the lecture notes matching **Bits, arithmetic and range structures** for additional teaching; reading the whole
