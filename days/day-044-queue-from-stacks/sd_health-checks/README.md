# Day 044 — Health checks

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Health checks** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-44.
**Weekly theme:** Load balancing and partitioning.

## Assignment

Separate liveness from readiness; trace rollout behavior while dependencies are unavailable.
