# Day 044 DSA — Queue from stacks

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Queue from stacks** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-44. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 43](../../day-043-balanced-delimiters/dsa_balanced-delimiters/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 43](../../day-043-balanced-delimiters/dsa_balanced-delimiters/README.md), [day 37](../../day-037-middle-node/dsa_middle-node/README.md), [day 23](../../day-023-target-range/dsa_target-range/README.md)
...
**Queue from stacks.** Process [push,x] and [pop] operations; pops are valid. Return popped values. Use two stacks.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Amortized O(1) per operation.
