...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Isolation anomalies** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-26.
**Weekly theme:** Relational storage and indexes.

## Assignment

Write an interleaving where two transactions overspend the same quota; choose a remedy and its retry behavior.
