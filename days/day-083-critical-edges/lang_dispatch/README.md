...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Dispatch** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-83.
**Weekly theme:** Functional tools and caching.

## Assignment

Use singledispatch for two data types and explain first-argument runtime dispatch.
