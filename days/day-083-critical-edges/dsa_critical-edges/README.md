# Day 083 DSA — Critical edges

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Critical edges** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-83. **Theme:** Weighted graphs and connectivity.

## Prerequisite and recall

Prior DSA session: [day 82](../../day-082-strong-components/dsa_strong-components/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 82](../../day-082-strong-components/dsa_strong-components/README.md), [day 76](../../day-076-multi-source-spread/dsa_multi-source-spread/README.md), [day 62](../../day-062-lowest-shared-ancestor/dsa_lowest-shared-ancestor/README.md)
...
**Critical edges.** In a simple undirected graph return sorted bridges [min(u,v),max(u,v)], lexicographically sorted.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(V+E) traversal plus sorting; stretch.
