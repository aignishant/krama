...
**After today you can:** You can use XOR to cancel pairs, which solves a whole family of interview questions.

**The interviewer asks it as:** *Every number appears twice except one. Find it, in O(1) space.*
