...
day: 173
track: lang-go
title: "Order service: Postgres, transactions, and the outbox"
theme: "Capstone, day 3: the order service"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 173 · Go — Order service: Postgres, transactions, and the outbox

**Today's theme:** Capstone, day 3: the order service

**After today you can:** You can create an order atomically with an event that will definitely be published.

**The interviewer asks it as:** *How do you guarantee the order event is published exactly once?*
