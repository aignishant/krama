# Practice — Coin combinations

## Contract

Return count of unordered combinations forming amount from distinct positive coins, unlimited use.
...
5. Run `python course.py practice 95` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(amount*coin_count) time**.
