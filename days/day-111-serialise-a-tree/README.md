...
4. [05-lang-python-multiprocessing-the-gil-and.md](05-lang-python-multiprocessing-the-gil-and.md) — the Python lesson
5. [06-lang-go-gomaxprocs-the-m-p.md](06-lang-go-gomaxprocs-the-m-p.md) — the Go lesson
6. [07-lang-cpp-std-execution-policies-and.md](07-lang-cpp-std-execution-policies-and.md) — the C++ lesson
