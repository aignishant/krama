...
day: 111
track: lang-python
title: "multiprocessing, the GIL, and free-threaded Python"
theme: "Parallelism and the scheduler"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 111 · Python — multiprocessing, the GIL, and free-threaded Python

**Today's theme:** Parallelism and the scheduler

**After today you can:** You can use every core in each language and say what stops you from doing so.

**The interviewer asks it as:** *How many goroutines can you run on one core?*
