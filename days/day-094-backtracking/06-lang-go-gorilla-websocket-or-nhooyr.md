...
day: 94
track: lang-go
title: "gorilla/websocket or nhooyr, and a broadcast hub"
theme: "WebSockets"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 094 · Go — gorilla/websocket or nhooyr, and a broadcast hub

**Today's theme:** WebSockets

**After today you can:** You can push live updates to a browser from each language.

**The interviewer asks it as:** *How does a WebSocket differ from HTTP?*
