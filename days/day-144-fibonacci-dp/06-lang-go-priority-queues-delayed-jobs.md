...
day: 144
track: lang-go
title: "Priority queues, delayed jobs, and a scheduler loop"
theme: "Build B, day 4: scheduling and priorities"
phase: "Languages: six five-day builds"
status: empty
---

# Day 144 · Go — Priority queues, delayed jobs, and a scheduler loop

**Today's theme:** Build B, day 4: scheduling and priorities

**After today you can:** You can schedule a job for later and run urgent ones first.

**The interviewer asks it as:** *How do you run a job at a specific time in a distributed system?*
