...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Container protocol** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-24.
**Weekly theme:** Data model protocols.

## Assignment

Implement __len__, __iter__ and __contains__ for a tiny immutable collection.
