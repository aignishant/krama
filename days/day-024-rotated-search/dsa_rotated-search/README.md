# Day 024 DSA — Rotated search

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Rotated search** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-24. **Theme:** Binary search and ordered answers.

## Prerequisite and recall

Prior DSA session: [day 23](../../day-023-target-range/dsa_target-range/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 23](../../day-023-target-range/dsa_target-range/README.md), [day 17](../../day-017-container-capacity/dsa_container-capacity/README.md), [day 3](../../day-003-stable-compaction/dsa_stable-compaction/README.md)
...
**Rotated search.** Return target index in a rotation of a strictly increasing array, or -1.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) time.
