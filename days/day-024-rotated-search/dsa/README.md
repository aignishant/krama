...
Prior DSA session: [day 23](../../day-023-target-range/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 23](../../day-023-target-range/dsa/README.md), [day 17](../../day-017-container-capacity/dsa/README.md), [day 3](../../day-003-stable-compaction/dsa/README.md)
