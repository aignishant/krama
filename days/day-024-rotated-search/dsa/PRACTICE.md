...
Return target index in a rotation of a strictly increasing array, or -1.
...
5. Run `python course.py practice 24` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(log n) time**.
