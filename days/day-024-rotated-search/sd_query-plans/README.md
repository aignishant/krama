...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Query plans** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-24.
**Weekly theme:** Relational storage and indexes.

## Assignment

Read the database guide on EXPLAIN and describe scan, filter and sort stages for one query; no measured plan is claimed without running it.
