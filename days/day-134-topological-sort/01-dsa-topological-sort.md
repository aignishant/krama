...
**After today you can:** You can order tasks by dependency with Kahn's algorithm and with DFS.

**The interviewer asks it as:** *Order these tasks so that every dependency comes first.*
