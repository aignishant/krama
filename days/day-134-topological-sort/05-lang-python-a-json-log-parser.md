...
day: 134
track: lang-python
title: "A JSON log parser in Python, profiled"
theme: "One program, three languages, measured"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 134 · Python — A JSON log parser in Python, profiled

**Today's theme:** One program, three languages, measured

**After today you can:** You can show the same task at three speeds and explain every gap with a profile.

**The interviewer asks it as:** *Why is the Go version 20 times faster than Python here?*
