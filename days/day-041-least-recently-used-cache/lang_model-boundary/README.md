# Day 041 — Model boundary

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Model boundary** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-41.
**Weekly theme:** Data classes and modeling.

## Assignment

Convert an untrusted mapping into a validated model without silently accepting missing required fields.
