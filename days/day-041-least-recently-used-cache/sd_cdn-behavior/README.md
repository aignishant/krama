# Day 041 — CDN behavior

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **CDN behavior** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-41.
**Weekly theme:** Caching and content delivery.

## Assignment

Place a CDN in the request path and specify cache key, private-data exclusions and invalidation needs.
