...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Least recently used cache** is not yet expanded.
...
Prior DSA session: [day 40](../../day-040-remove-from-end/dsa_remove-from-end/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 40](../../day-040-remove-from-end/dsa_remove-from-end/README.md), [day 34](../../day-034-count-inversions/dsa_count-inversions/README.md), [day 20](../../day-020-minimum-positive-window/dsa_minimum-positive-window/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Expected O(1) per operation; O(capacity) space.
