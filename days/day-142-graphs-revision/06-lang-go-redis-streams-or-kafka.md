...
day: 142
track: lang-go
title: "Redis Streams or Kafka, the worker loop, and acknowledgements"
theme: "Build B, day 2: the queue and the worker"
phase: "Languages: six five-day builds"
status: empty
---

# Day 142 · Go — Redis Streams or Kafka, the worker loop, and acknowledgements

**Today's theme:** Build B, day 2: the queue and the worker

**After today you can:** You can implement at-least-once delivery with acknowledgements and visibility timeouts.

**The interviewer asks it as:** *What happens if a worker dies mid-job?*
