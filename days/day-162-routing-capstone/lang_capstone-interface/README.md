# Day 162 — Capstone interface

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone interface** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-162.
**Weekly theme:** Python capstone and retention.

## Assignment

Specify a tiny local job runner's typed inputs, outputs and failure contract; keep the scope small.
