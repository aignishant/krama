...
day: 83
track: lang-go
title: "os/exec, pipes, and os/signal with graceful shutdown"
theme: "Processes, subprocesses, and signals"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 083 · Go — os/exec, pipes, and os/signal with graceful shutdown

**Today's theme:** Processes, subprocesses, and signals

**After today you can:** You can run another program, capture its output, and handle Ctrl-C cleanly, in each language.

**The interviewer asks it as:** *What happens when you press Ctrl-C on your server?*
