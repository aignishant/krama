# Day 121 — Search indexing

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Search indexing** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-121.
**Weekly theme:** Search and notifications case studies.

## Assignment

Draw write -> event -> index flow and handling of document edits/deletions.
