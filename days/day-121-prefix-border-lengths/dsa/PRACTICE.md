# Practice — Prefix border lengths

## Contract

For each prefix of text return the length of its longest proper prefix that is also a suffix.
...
5. Run `python course.py practice 121` from the repository root. The starter is intentionally RED.
