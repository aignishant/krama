...
Prior DSA session: [day 120](../../day-120-normalize-text-units/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 120](../../day-120-normalize-text-units/dsa/README.md), [day 114](../../day-114-set-bit-counts/dsa/README.md), [day 100](../../day-100-minimum-grid-path/dsa/README.md)
