# Day 121 — CSV streaming

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **CSV streaming** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-121.
**Weekly theme:** Persistence and safe I/O.

## Assignment

Read CSV using newline handling and explicit encoding; test quoted delimiters and embedded newlines.
