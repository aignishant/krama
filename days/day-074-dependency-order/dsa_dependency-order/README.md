# Day 074 DSA — Dependency order

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Dependency order** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-74. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 73](../../day-073-island-count/dsa_island-count/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 73](../../day-073-island-count/dsa_island-count/README.md), [day 67](../../day-067-prefix-dictionary/dsa_prefix-dictionary/README.md), [day 53](../../day-053-balanced-parentheses/dsa_balanced-parentheses/README.md)
...
**Dependency order.** For directed prerequisite edges u->v, return lexicographically smallest topological order; return [] on a cycle.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O((V+E) log(V+1)) with min-heap.
