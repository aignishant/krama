...
**After today you can:** You can design file sync, chunking, deduplication and conflict resolution.

**The interviewer asks it as:** *Design Dropbox. Two devices edit the same file offline.*
