...
**After today you can:** You can use an integer as a set and solve small-n exponential problems fast.

**The interviewer asks it as:** *Solve the travelling salesman for n equal to 15.*
