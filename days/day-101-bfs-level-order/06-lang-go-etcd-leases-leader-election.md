...
day: 101
track: lang-go
title: "etcd leases, leader election, and the lock lease trap"
theme: "Distributed locks and leader election"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 101 · Go — etcd leases, leader election, and the lock lease trap

**Today's theme:** Distributed locks and leader election

**After today you can:** You can ensure only one instance runs the nightly job, and say why that is hard.

**The interviewer asks it as:** *How do you make sure only one instance runs a job?*
