...
Prior DSA session: [day 166](../../day-166-counterexample-capstone/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 166](../../day-166-counterexample-capstone/dsa/README.md), [day 160](../../day-160-mock-backtracking/dsa/README.md), [day 146](../../day-146-find-duplicate-without-mutation/dsa/README.md)
