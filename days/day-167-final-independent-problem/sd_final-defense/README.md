# Day 167 — Final defense

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Final defense** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-167.
**Weekly theme:** Final design portfolio.

## Assignment

Record a concise design explanation; answer a 10x traffic change and a full-region outage using your existing design.
