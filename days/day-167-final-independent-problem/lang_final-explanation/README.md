# Day 167 — Final explanation

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Final explanation** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-167.
**Weekly theme:** Python capstone and retention.

## Assignment

Explain three design decisions, one bug caught by tests and one deferred improvement with a measurable trigger.
