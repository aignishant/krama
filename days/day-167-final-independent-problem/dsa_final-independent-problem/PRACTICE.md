# Practice — Final independent problem
...
Return maximum number of envelopes nested with strictly increasing width and height; equal dimensions cannot nest.
...
5. Run `python course.py practice 167` from the repository root. The starter is intentionally RED.
