# Day 167 DSA — Final independent problem

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Final independent problem** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-167. **Theme:** Capstone and retention.

## Prerequisite and recall

Prior DSA session: [day 166](../../day-166-counterexample-capstone/dsa_counterexample-capstone/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 166](../../day-166-counterexample-capstone/dsa_counterexample-capstone/README.md), [day 160](../../day-160-mock-backtracking/dsa_mock-backtracking/README.md), [day 146](../../day-146-find-duplicate-without-mutation/dsa_find-duplicate-without-mutation/README.md)
...
**Final independent problem.** Return maximum number of envelopes nested with strictly increasing width and height; equal dimensions cannot nest.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n log n) time.
