# Day 062 — Exception groups

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Exception groups** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-62.
**Weekly theme:** Exceptions and resource lifetime.

## Assignment

Create an ExceptionGroup and handle one subgroup with except* without losing the rest.
