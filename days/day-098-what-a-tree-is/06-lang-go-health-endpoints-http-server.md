...
day: 98
track: lang-go
title: "Health endpoints, http.Server.Shutdown, and draining"
theme: "Health checks and graceful shutdown"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 098 · Go — Health endpoints, http.Server.Shutdown, and draining

**Today's theme:** Health checks and graceful shutdown

**After today you can:** You can stop a service without dropping in-flight requests, in each language.

**The interviewer asks it as:** *What is the difference between liveness and readiness?*
