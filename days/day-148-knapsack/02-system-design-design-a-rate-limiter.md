...
**After today you can:** You can rate limit across many servers, with shared state and a fallback.

**The interviewer asks it as:** *Design a rate limiter for an API used by a million clients.*
