...
day: 148
track: lang-cpp
title: "Flushing, sorted files, bloom filters, and compaction"
theme: "Build C, day 3: SSTables and compaction"
phase: "Languages: six five-day builds"
status: empty
---

# Day 148 · C++ — Flushing, sorted files, bloom filters, and compaction

**Today's theme:** Build C, day 3: SSTables and compaction

**After today you can:** You can flush the memtable to disk and merge files without losing data.

**The interviewer asks it as:** *What is compaction, and why is it needed?*
