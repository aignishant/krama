# Day 144 — Special method lookup

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Special method lookup** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-144.
**Weekly theme:** Internals and version-aware Python.

## Assignment

Demonstrate implicit special-method lookup on a type versus assigning a same-named instance attribute.
