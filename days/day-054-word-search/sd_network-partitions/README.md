# Day 054 — Network partitions

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Network partitions** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-54.
**Weekly theme:** Replication and consistency.

## Assignment

Describe which requests continue during a partition and what guarantee is sacrificed for this operation.
