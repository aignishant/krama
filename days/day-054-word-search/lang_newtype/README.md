...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **NewType** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-54.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Separate two integer identifier domains using NewType; show that runtime representation remains unchanged.
