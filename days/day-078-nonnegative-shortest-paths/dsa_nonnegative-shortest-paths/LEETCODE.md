# Day 078 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/network-delay-time/)

**Difficulty:** Medium. **Original course day:** 78.

**Contract comparison:** Online returns a single maximum arrival delay; local practice returns all source distances.
