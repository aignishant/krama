# Practice — Frequency ranking

## Contract

Return distinct integers sorted by descending frequency, breaking ties by smaller value.
...
5. Run `python course.py practice 9` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n+k log k) time**.
