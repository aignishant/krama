...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Closure binding** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-09.
**Weekly theme:** Functions and scope.

## Assignment

Create callbacks in a loop, reproduce late binding and fix it with a captured value.
