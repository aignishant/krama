...
7. **Recall later without practice:** read [this day's recall card](../../../docs/DSA_RECALL.md#day-009-frequency-ranking) for a previously studied topic. Reading is not learner completion.
...
**Budget:** 60 minutes. **Outcome:** DSA-09. **Theme:** Hashing and prefix sums.

## Prerequisite and recall

Prior DSA session: [day 8](../../day-008-first-repeated-value/dsa_first-repeated-value/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 8](../../day-008-first-repeated-value/dsa_first-repeated-value/README.md), [day 2](../../day-002-find-the-first-maximum/dsa_find-the-first-maximum/README.md)
...
**Frequency ranking.** Return distinct integers sorted by descending frequency, breaking ties by smaller value.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n+k log k) time.
