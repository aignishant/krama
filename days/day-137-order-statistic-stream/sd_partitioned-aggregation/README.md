# Day 137 — Partitioned aggregation

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Partitioned aggregation** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-137.
**Weekly theme:** Analytics and stream processing.

## Assignment

Separate local partial counts from merged totals; identify a hot aggregation key.
