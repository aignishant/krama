...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Edit distance** is not yet expanded.
...
Prior DSA session: [day 101](../../day-101-common-subsequence-length/dsa_common-subsequence-length/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 101](../../day-101-common-subsequence-length/dsa_common-subsequence-length/README.md), [day 95](../../day-095-coin-combinations/dsa_coin-combinations/README.md), [day 81](../../day-081-minimum-spanning-cost/dsa_minimum-spanning-cost/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(nm) time.
