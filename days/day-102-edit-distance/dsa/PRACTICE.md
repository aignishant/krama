...
Return minimum insertions, deletions and replacements to turn a into b, each cost 1.
...
5. Run `python course.py practice 102` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(nm) time**.
