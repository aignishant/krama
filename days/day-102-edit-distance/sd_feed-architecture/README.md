# Day 102 — Feed architecture

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Feed architecture** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-102.
**Weekly theme:** Feed case study.

## Assignment

Compare fan-out on write, read and hybrid; draw where candidate entries are stored.
