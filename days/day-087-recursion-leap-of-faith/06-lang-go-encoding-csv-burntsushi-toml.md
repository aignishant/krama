...
day: 87
track: lang-go
title: "encoding/csv, BurntSushi/toml, and yaml.v3"
theme: "Other data formats"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 087 · Go — encoding/csv, BurntSushi/toml, and yaml.v3

**Today's theme:** Other data formats

**After today you can:** You can read the three most common config and data formats in each language.

**The interviewer asks it as:** *YAML or TOML for config, and why?*
