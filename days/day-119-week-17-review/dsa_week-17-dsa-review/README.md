...
**Budget:** 60 minutes. **Outcome:** DSA-119. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 118](../../day-118-mutable-range-minima/dsa_mutable-range-minima/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 118](../../day-118-mutable-range-minima/dsa_mutable-range-minima/README.md), [day 112](../../day-112-week-16-review/dsa_week-16-dsa-review/README.md), [day 98](../../day-098-week-14-review/dsa_week-14-dsa-review/README.md)
