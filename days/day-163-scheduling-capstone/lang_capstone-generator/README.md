# Day 163 — Capstone generator

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone generator** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-163.
**Weekly theme:** Python capstone and retention.

## Assignment

Implement lazy job input and deterministic cleanup when consumption stops early.
