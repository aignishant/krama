# Day 163 — Capstone architecture

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone architecture** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-163.
**Weekly theme:** Final design portfolio.

## Assignment

Produce one readable component diagram with data ownership and synchronous/asynchronous arrows.
