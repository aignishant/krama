...
Original reading, after cold recall: [Day 43](../../day-043-balanced-delimiters/lang_annotations-at-runtime/README.md) · [Day 44](../../day-044-queue-from-stacks/lang_optional-and-narrowing/README.md) · [Day 45](../../day-045-minimum-stack/lang_typed-dictionaries/README.md) · [Day 46](../../day-046-warmer-days/lang_protocols/README.md) · [Day 47](../../day-047-largest-histogram-rectangle/lang_generics/README.md) · [Day 48](../../day-048-sliding-window-maxima/lang_overloads/README.md).

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-49.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Revisit days 43–48. From memory reproduce one surprising behavior, write a regression test for its repair, and explain the mechanism.
