...
day: 131
track: lang-go
title: "Done channels, fan-in, fan-out, select with default, and time.After"
theme: "Go, deep: channel patterns"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 131 · Go — Done channels, fan-in, fan-out, select with default, and time.After

**Today's theme:** Go, deep: channel patterns

**After today you can:** You can write the five classic Go concurrency patterns from memory and explain each with a diagram.

**The interviewer asks it as:** *How do you stop a goroutine?*
