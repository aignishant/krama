...
**After today you can:** You can prove that BFS gives the shortest path when every edge costs the same.

**The interviewer asks it as:** *Find the shortest path from A to B. Why does BFS work here?*
