# Day 036 DSA — Reverse a linked list

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Reverse a linked list** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-36. **Theme:** Linked lists and pointer invariants.

## Prerequisite and recall

Prior DSA session: [day 35](../../day-035-week-5-review/dsa_week-5-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 35](../../day-035-week-5-review/dsa_week-5-dsa-review/README.md), [day 29](../../day-029-stable-record-sorting/dsa_stable-record-sorting/README.md), [day 15](../../day-015-sorted-pair-existence/dsa_sorted-pair-existence/README.md)
...
**Reverse a linked list.** Build singly linked nodes from values, reverse links, serialize the resulting values. Do not solve by reversing the input list.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(1) reversal workspace, excluding adapter.
