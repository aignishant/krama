...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Dataclass defaults** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-36.
**Weekly theme:** Data classes and modeling.

## Assignment

Use default_factory for a mutable field and prove instances do not share it.
