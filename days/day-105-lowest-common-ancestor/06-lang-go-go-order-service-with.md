...
day: 105
track: lang-go
title: "Go order service with gRPC, Postgres, and the outbox"
theme: "Mini project 7: orders, events, and notifications"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 105 · Go — Go order service with gRPC, Postgres, and the outbox

**Today's theme:** Mini project 7: orders, events, and notifications

**After today you can:** You can ship three services that talk over gRPC and Kafka, with CI and health checks.

**The interviewer asks it as:** *Design an order pipeline with a notification step. Where can it lose a message?*
