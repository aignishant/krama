...
For a nonempty integer binary tree return largest sum on a nonempty simple path; values may be negative.
...
Input:
```json
{"tree":[-10,[9,null,null],[20,[15,null,null],[7,null,null]]]}
```
...
5. Run `python course.py practice 150` from the repository root. The starter is intentionally RED.
