# Day 150 DSA — Maximum path sum

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Maximum path sum** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-150. **Theme:** Mixed pattern selection II.

## Prerequisite and recall

Prior DSA session: [day 149](../../day-149-course-completion-time/dsa_course-completion-time/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 149](../../day-149-course-completion-time/dsa_course-completion-time/README.md), [day 143](../../day-143-trapped-rainwater/dsa_trapped-rainwater/README.md), [day 129](../../day-129-redundant-undirected-edge/dsa_redundant-undirected-edge/README.md)
...
**Maximum path sum.** For a nonempty integer binary tree return largest sum on a nonempty simple path; values may be negative.
