# Day 050 — Callable signatures

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Callable signatures** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-50.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Annotate a higher-order function and preserve its arguments with ParamSpec where appropriate.
