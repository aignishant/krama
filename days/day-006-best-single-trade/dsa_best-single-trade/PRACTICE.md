...
Given daily prices, return the largest nonnegative profit from one buy followed by one sell; no trade returns 0.
...
5. Run `python course.py practice 6` from the repository root. The starter is intentionally RED.
