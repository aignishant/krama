...
Prior DSA session: [day 5](../../day-005-merge-sorted-arrays/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 5](../../day-005-merge-sorted-arrays/dsa/README.md)
