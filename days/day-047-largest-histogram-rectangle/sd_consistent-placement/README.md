# Day 047 — Consistent placement

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Consistent placement** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-47.
**Weekly theme:** Load balancing and partitioning.

## Assignment

Draw a hash ring with virtual nodes and a node addition; distinguish data movement from load balance.
