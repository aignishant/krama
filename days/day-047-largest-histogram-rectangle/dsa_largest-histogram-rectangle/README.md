# Day 047 DSA — Largest histogram rectangle

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Largest histogram rectangle** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-47. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 46](../../day-046-warmer-days/dsa_warmer-days/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 46](../../day-046-warmer-days/dsa_warmer-days/README.md), [day 40](../../day-040-remove-from-end/dsa_remove-from-end/README.md), [day 26](../../day-026-minimum-shipping-capacity/dsa_minimum-shipping-capacity/README.md)
...
**Largest histogram rectangle.** Return the largest rectangle area in nonnegative bar heights of unit width.
