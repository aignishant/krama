...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Generics** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-47.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Write a generic first-item helper that preserves element type; define empty-input behavior.
