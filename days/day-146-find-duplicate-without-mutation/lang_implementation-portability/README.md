# Day 146 — Implementation portability

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Implementation portability** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-146.
**Weekly theme:** Internals and version-aware Python.

## Assignment

Review an optimization relying on CPython behavior and write the assumption plus a portable alternative.
