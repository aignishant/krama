# Day 146 DSA — Find duplicate without mutation

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Find duplicate without mutation** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-146. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 145](../../day-145-rotated-minimum-with-duplicates/dsa_rotated-minimum-with-duplicates/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 145](../../day-145-rotated-minimum-with-duplicates/dsa_rotated-minimum-with-duplicates/README.md), [day 139](../../day-139-autocomplete-ranking/dsa_autocomplete-ranking/README.md), [day 125](../../day-125-dictionary-wildcard-search/dsa_dictionary-wildcard-search/README.md)
...
**Find duplicate without mutation.** Length n+1 nums contains values 1..n and exactly one distinct duplicated value, possibly repeated multiple times. Return it without modifying nums.
