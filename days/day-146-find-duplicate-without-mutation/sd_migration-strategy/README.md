# Day 146 — Migration strategy

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Migration strategy** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-146.
**Weekly theme:** Multi-region and advanced tradeoffs.

## Assignment

Plan dual reads/writes, backfill, consistency checks, cutover and rollback for a datastore migration.
