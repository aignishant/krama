# Day 039 DSA — Merge linked lists

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Merge linked lists** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-39. **Theme:** Linked lists and pointer invariants.

## Prerequisite and recall

Prior DSA session: [day 38](../../day-038-cycle-entry/dsa_cycle-entry/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 38](../../day-038-cycle-entry/dsa_cycle-entry/README.md), [day 32](../../day-032-minimum-meeting-rooms/dsa_minimum-meeting-rooms/README.md), [day 18](../../day-018-fixed-window-maximum-sum/dsa_fixed-window-maximum-sum/README.md)
...
**Merge linked lists.** Build two sorted linked lists, merge by relinking their nodes, then serialize.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n+m) time; O(1) merge workspace.
