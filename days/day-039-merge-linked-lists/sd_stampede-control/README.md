...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Stampede control** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-39.
**Weekly theme:** Caching and content delivery.

## Assignment

Compare single-flight loading, TTL jitter and stale-while-revalidate for a popular link.
