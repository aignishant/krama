# Day 045 DSA — Minimum stack

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum stack** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-45. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 44](../../day-044-queue-from-stacks/dsa_queue-from-stacks/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 44](../../day-044-queue-from-stacks/dsa_queue-from-stacks/README.md), [day 38](../../day-038-cycle-entry/dsa_cycle-entry/README.md), [day 24](../../day-024-rotated-search/dsa_rotated-search/README.md)
...
**Minimum stack.** Process [push,x], [pop], and [min]; pop and min are valid. Return min results.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(1) per operation.
