...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Ordering and hashing** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-38.
**Weekly theme:** Data classes and modeling.

## Assignment

Inspect generated equality, order and hash behavior under two dataclass configurations.
