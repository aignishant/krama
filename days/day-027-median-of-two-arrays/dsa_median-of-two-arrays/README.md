# Day 027 DSA — Median of two arrays

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Median of two arrays** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-27. **Theme:** Binary search and ordered answers.

## Prerequisite and recall

Prior DSA session: [day 26](../../day-026-minimum-shipping-capacity/dsa_minimum-shipping-capacity/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 26](../../day-026-minimum-shipping-capacity/dsa_minimum-shipping-capacity/README.md), [day 20](../../day-020-minimum-positive-window/dsa_minimum-positive-window/README.md), [day 6](../../day-006-best-single-trade/dsa_best-single-trade/README.md)
...
**Median of two arrays.** Return the numeric median of sorted a and b; total length is positive.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log(min(n,m)+1)) time; stretch difficulty.
