...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Context managers** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-27.
**Weekly theme:** Data model protocols.

## Assignment

Implement __enter__/__exit__ and test cleanup on success and exception without accidental suppression.
