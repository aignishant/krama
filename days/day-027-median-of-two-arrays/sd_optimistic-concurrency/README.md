...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Optimistic concurrency** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-27.
**Weekly theme:** Relational storage and indexes.

## Assignment

Add a version field to link edits; specify compare-and-swap failure and a client retry decision.
