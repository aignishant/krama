# Day 093 DSA — Nonadjacent loot

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Nonadjacent loot** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-93. **Theme:** Dynamic programming foundations.

## Prerequisite and recall

Prior DSA session: [day 92](../../day-092-climbing-steps/dsa_climbing-steps/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 92](../../day-092-climbing-steps/dsa_climbing-steps/README.md), [day 86](../../day-086-reach-the-end/dsa_reach-the-end/README.md), [day 72](../../day-072-unweighted-distance/dsa_unweighted-distance/README.md)
...
**Nonadjacent loot.** Return maximum sum of nonadjacent nonnegative values; empty returns 0.
