...
day: 159
track: lang-python
title: "A FastAPI dashboard and an alert evaluator"
theme: "Build E, day 4: the dashboard and alerts"
phase: "Languages: six five-day builds"
status: empty
---

# Day 159 · Python — A FastAPI dashboard and an alert evaluator

**Today's theme:** Build E, day 4: the dashboard and alerts

**After today you can:** You can draw a graph and fire an alert on a threshold.

**The interviewer asks it as:** *How do you avoid alert fatigue?*
