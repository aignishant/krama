...
**After today you can:** You can design the video pipeline, adaptive bitrate, and the CDN economics.

**The interviewer asks it as:** *Design Netflix. How is it different from YouTube?*
