...
**After today you can:** You can combine children's answers into a parent's answer, which is DP without a table.

**The interviewer asks it as:** *Find the maximum independent set in a tree.*
