...
day: 126
track: lang-python
title: "Domain, application, infrastructure layers in a Python service"
theme: "Clean architecture"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 126 · Python — Domain, application, infrastructure layers in a Python service

**Today's theme:** Clean architecture

**After today you can:** You can lay out a service so the business rules never import the database, in each language.

**The interviewer asks it as:** *How do you structure a service so the framework can be swapped?*
