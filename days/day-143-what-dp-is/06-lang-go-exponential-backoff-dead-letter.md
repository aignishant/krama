...
day: 143
track: lang-go
title: "Exponential backoff, dead-letter queue, and poison messages"
theme: "Build B, day 3: retries and dead letters"
phase: "Languages: six five-day builds"
status: empty
---

# Day 143 · Go — Exponential backoff, dead-letter queue, and poison messages

**Today's theme:** Build B, day 3: retries and dead letters

**After today you can:** You can retry failed jobs safely and quarantine the ones that will never succeed.

**The interviewer asks it as:** *What is a poison message?*
