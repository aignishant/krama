...
**After today you can:** You can trade a little accuracy for a lot of memory, and say when that is safe.

**The interviewer asks it as:** *How do you check whether a URL has been crawled, using little memory?*
