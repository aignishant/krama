...
Given distinct positive coin values and amount >= 0, return minimum coins or -1; unlimited use.
...
5. Run `python course.py practice 94` from the repository root. The starter is intentionally RED.
