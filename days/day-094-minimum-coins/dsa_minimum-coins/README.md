# Day 094 DSA — Minimum coins

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum coins** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-94. **Theme:** Dynamic programming foundations.

## Prerequisite and recall

Prior DSA session: [day 93](../../day-093-nonadjacent-loot/dsa_nonadjacent-loot/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 93](../../day-093-nonadjacent-loot/dsa_nonadjacent-loot/README.md), [day 87](../../day-087-minimum-jumps/dsa_minimum-jumps/README.md), [day 73](../../day-073-island-count/dsa_island-count/README.md)
...
**Minimum coins.** Given distinct positive coin values and amount >= 0, return minimum coins or -1; unlimited use.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(amount*coin_count) time.
