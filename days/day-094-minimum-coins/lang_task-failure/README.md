# Day 094 — Task failure

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Task failure** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-94.
**Weekly theme:** Async reliability.

## Assignment

Show one TaskGroup child failure canceling peers; inspect the actual exception group.
