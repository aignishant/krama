# Day 068 — Rate limiting

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Rate limiting** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-68.
**Weekly theme:** Reliability patterns.

## Assignment

Compare token bucket and sliding-window counters; define burst allowance, identity and rejection response.
