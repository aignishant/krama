# Day 068 DSA — Tree reconstruction

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tree reconstruction** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-68. **Theme:** Heaps, tries and tree construction.

## Prerequisite and recall

Prior DSA session: [day 67](../../day-067-prefix-dictionary/dsa_prefix-dictionary/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 67](../../day-067-prefix-dictionary/dsa_prefix-dictionary/README.md), [day 61](../../day-061-tree-diameter/dsa_tree-diameter/README.md), [day 47](../../day-047-largest-histogram-rectangle/dsa_largest-histogram-rectangle/README.md)
...
**Tree reconstruction.** Given preorder and inorder traversals with distinct equal value sets, return the nested-list tree.
