# Day 068 — Metamorphic tests

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Metamorphic tests** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-68.
**Weekly theme:** Testing and debugging.

## Assignment

Choose an input transformation that preserves a known result and encode the relationship as a test.
