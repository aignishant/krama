# Day 051 — Variance reasoning

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Variance reasoning** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-51.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Explain why a read-only sequence can be more flexible than a mutable list; construct a mutation counterexample.
