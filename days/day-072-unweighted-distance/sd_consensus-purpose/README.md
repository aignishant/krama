# Day 072 — Consensus purpose

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Consensus purpose** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-72.
**Weekly theme:** Distributed coordination.

## Assignment

Explain which replicated metadata needs agreement; sketch leader and majority without claiming to implement consensus.
