# Day 157 — Typing drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Typing drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-157.
**Weekly theme:** Python interview drills.

## Assignment

Design a typed storage interface with two implementations and explain structural versus nominal typing.
