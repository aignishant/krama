...
Reverse nums between inclusive indices left and right; return the modified list. Inputs satisfy 0 <= left <= right < n.
...
5. Run `python course.py practice 4` from the repository root. The starter is intentionally RED.
