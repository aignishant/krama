...
Prior DSA session: [day 3](../../day-003-stable-compaction/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 3](../../day-003-stable-compaction/dsa/README.md)
