...
day: 69
track: lang-python
title: "Server streaming and bidirectional streaming from Python"
theme: "gRPC III: streaming"
phase: "Languages: Protocol Buffers and gRPC"
status: empty
---

# Day 069 · Python — Server streaming and bidirectional streaming from Python

**Today's theme:** gRPC III: streaming

**After today you can:** You can stream a large result and a live feed over gRPC in each language.

**The interviewer asks it as:** *When would you use a streaming RPC instead of a unary one?*
