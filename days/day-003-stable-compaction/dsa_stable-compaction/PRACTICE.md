...
Return nums with all zeroes moved to the end, preserving other values' order. Mutate the provided list and return it.
...
5. Run `python course.py practice 3` from the repository root. The starter is intentionally RED.
