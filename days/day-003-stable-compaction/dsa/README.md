...
Prior DSA session: [day 2](../../day-002-find-the-first-maximum/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 2](../../day-002-find-the-first-maximum/dsa/README.md)
...
[HINTS.md](HINTS.md), so the first attempt remains independent. Expected target: O(n) time; O(1) auxiliary space.
