...
7. **Recall later without practice:** read the [Python summary file](../../../docs/LANG_RECALL.md#day-003-mutable-defaults) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-03.
**Weekly theme:** Object semantics.

## Assignment

Reproduce state leaking across calls through a list default, then fix with an explicit None sentinel.
...
Optional deeper reading: [Default Argument Values](https://docs.python.org/3.12/tutorial/controlflow.html#default-argument-values).
The exact page was checked on 2026-09-22; see [source records](../../../docs/SOURCES.md).

## Acceptance check

- [ ] Check two omitted calls and an explicitly supplied empty container.
