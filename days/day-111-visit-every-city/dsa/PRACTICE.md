# Practice — Visit every city

## Contract

Nonnegative square cost matrix; return minimum directed Hamiltonian tour starting/ending at 0. n >= 1; diagonal 0.
...
5. Run `python course.py practice 111` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n^2*2^n) time; small n only**.
