# Day 111 — Chat failure review

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Chat failure review** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-111.
**Weekly theme:** Chat case study.

## Assignment

Model gateway loss and reconnect storm; preserve replay position and avoid duplicate user-visible messages.
