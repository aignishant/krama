...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Visit every city** is not yet expanded.
...
Prior DSA session: [day 110](../../day-110-matrix-chain-cost/dsa_matrix-chain-cost/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 110](../../day-110-matrix-chain-cost/dsa_matrix-chain-cost/README.md), [day 104](../../day-104-word-segmentation/dsa_word-segmentation/README.md), [day 90](../../day-090-optimal-merge-cost/dsa_optimal-merge-cost/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n^2*2^n) time; small n only.
