# Day 111 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/shortest-path-visiting-all-nodes/)

**Difficulty:** Hard. **Original course day:** 111.

**Contract comparison:** Related visited-mask state on an unweighted graph, allowing revisits and no return-to-start requirement. It is not the local weighted Hamiltonian tour.
