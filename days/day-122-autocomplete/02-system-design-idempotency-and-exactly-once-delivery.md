...
**After today you can:** You can design an operation that is safe to retry, and explain why exactly-once is a lie.

**The interviewer asks it as:** *The payment request timed out. Is it safe to retry?*
