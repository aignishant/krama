...
day: 122
track: lang-python
title: "Observer with callbacks, decorator as wrapper, adapter as class"
theme: "Design patterns II: observer, decorator, adapter"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 122 · Python — Observer with callbacks, decorator as wrapper, adapter as class

**Today's theme:** Design patterns II: observer, decorator, adapter

**After today you can:** You can implement the three most-asked structural patterns idiomatically in each language.

**The interviewer asks it as:** *How would you notify five parts of the program when a value changes?*
