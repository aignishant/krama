...
**After today you can:** You can return the top suggestions for a prefix and say what you store at each node.

**The interviewer asks it as:** *Design autocomplete for a search box.*
