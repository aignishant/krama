...
day: 153
track: lang-python
title: "A FastAPI WebSocket gateway to the gRPC hub"
theme: "Build D, day 3: WebSockets for the browser"
phase: "Languages: six five-day builds"
status: empty
---

# Day 153 · Python — A FastAPI WebSocket gateway to the gRPC hub

**Today's theme:** Build D, day 3: WebSockets for the browser

**After today you can:** You can bridge a browser to the gRPC hub.

**The interviewer asks it as:** *The browser cannot open a gRPC stream. What do you do?*
