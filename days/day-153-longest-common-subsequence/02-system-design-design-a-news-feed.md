...
**After today you can:** You can compare fan-out on write with fan-out on read and pick per user type.

**The interviewer asks it as:** *Design the Facebook news feed. What about a celebrity with fifty million followers?*
