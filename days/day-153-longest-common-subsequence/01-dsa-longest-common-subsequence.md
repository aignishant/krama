...
**After today you can:** You can fill the LCS grid and reconstruct the actual subsequence, not just its length.

**The interviewer asks it as:** *Find the longest common subsequence of two strings.*
