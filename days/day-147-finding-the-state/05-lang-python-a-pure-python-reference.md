...
day: 147
track: lang-python
title: "A pure-Python reference implementation for testing"
theme: "Build C, day 2: WAL and memtable"
phase: "Languages: six five-day builds"
status: empty
---

# Day 147 · Python — A pure-Python reference implementation for testing

**Today's theme:** Build C, day 2: WAL and memtable

**After today you can:** You can make writes durable and explain what fsync guarantees.

**The interviewer asks it as:** *What is a write-ahead log for?*
