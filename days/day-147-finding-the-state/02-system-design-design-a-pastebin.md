...
**After today you can:** You can design text storage, expiry, and the read-heavy access pattern.

**The interviewer asks it as:** *Design pastebin. What happens when a paste goes viral?*
