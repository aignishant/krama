...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Transactions** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-25.
**Weekly theme:** Relational storage and indexes.

## Assignment

Trace creating a link and updating an owner quota atomically; show a failure between statements.
