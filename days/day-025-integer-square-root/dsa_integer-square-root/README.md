...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Integer square root** is not yet expanded.
...
Prior DSA session: [day 24](../../day-024-rotated-search/dsa_rotated-search/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 24](../../day-024-rotated-search/dsa_rotated-search/README.md), [day 18](../../day-018-fixed-window-maximum-sum/dsa_fixed-window-maximum-sum/README.md), [day 4](../../day-004-reverse-a-segment/dsa_reverse-a-segment/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) comparisons.
