...
day: 125
track: lang-python
title: "Constructor injection with Protocols, and pytest fixtures"
theme: "Dependency injection"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 125 · Python — Constructor injection with Protocols, and pytest fixtures

**Today's theme:** Dependency injection

**After today you can:** You can swap a real database for a fake in a test without a framework, in each language.

**The interviewer asks it as:** *How do you test code that talks to a database?*
