...
**After today you can:** You can see the graph inside a problem that never uses the word.

**The interviewer asks it as:** *Is this a graph problem? What are the nodes and edges?*
