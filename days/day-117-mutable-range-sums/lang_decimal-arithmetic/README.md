# Day 117 — Decimal arithmetic

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Decimal arithmetic** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-117.
**Weekly theme:** Files, text and data boundaries.

## Assignment

Compare a decimal constructed from a string versus a float and explain the input representation effect.
