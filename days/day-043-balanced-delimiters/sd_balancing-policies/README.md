# Day 043 — Balancing policies

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Balancing policies** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-43.
**Weekly theme:** Load balancing and partitioning.

## Assignment

Compare round-robin and least-connections for a mix of short redirects and slow exports.
