# Day 043 DSA — Balanced delimiters

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Balanced delimiters** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-43. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 42](../../day-042-week-6-review/dsa_week-6-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 42](../../day-042-week-6-review/dsa_week-6-dsa-review/README.md), [day 36](../../day-036-reverse-a-linked-list/dsa_reverse-a-linked-list/README.md), [day 22](../../day-022-lower-bound/dsa_lower-bound/README.md)
...
**Balanced delimiters.** Return whether a string containing only ()[]{} is properly nested; empty is valid.
