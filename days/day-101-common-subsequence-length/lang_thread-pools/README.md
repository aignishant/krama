# Day 101 — Thread pools

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Thread pools** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-101.
**Weekly theme:** Threads and processes.

## Assignment

Collect results and exceptions through futures and define executor shutdown behavior.
