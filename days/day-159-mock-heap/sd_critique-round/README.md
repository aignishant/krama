# Day 159 — Critique round

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Critique round** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-159.
**Weekly theme:** Design interviews and critique.

## Assignment

Score your diagrams for clear critical path, quantified assumptions, failure behavior and rejected alternatives.
