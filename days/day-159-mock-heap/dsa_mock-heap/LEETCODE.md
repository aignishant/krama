# Day 159 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/min-cost-to-connect-all-points/)

**Difficulty:** Medium. **Original course day:** 159.
