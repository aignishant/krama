# Day 159 — Debugging drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Debugging drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-159.
**Weekly theme:** Python interview drills.

## Assignment

Take a previous bug, reproduce it from a fresh process and narrate hypothesis, evidence and repair.
