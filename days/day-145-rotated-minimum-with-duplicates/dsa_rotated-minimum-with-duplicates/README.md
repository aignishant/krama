# Day 145 DSA — Rotated minimum with duplicates

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Rotated minimum with duplicates** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-145. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 144](../../day-144-top-frequent-words/dsa_top-frequent-words/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 144](../../day-144-top-frequent-words/dsa_top-frequent-words/README.md), [day 138](../../day-138-expiring-counter/dsa_expiring-counter/README.md), [day 124](../../day-124-smallest-covering-window/dsa_smallest-covering-window/README.md)
...
**Rotated minimum with duplicates.** Return minimum in a nonempty rotated sorted array allowing duplicates.
