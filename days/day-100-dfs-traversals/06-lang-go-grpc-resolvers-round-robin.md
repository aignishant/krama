...
day: 100
track: lang-go
title: "gRPC resolvers, round-robin, and DNS-based discovery"
theme: "Service-to-service: discovery and load balancing"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 100 · Go — gRPC resolvers, round-robin, and DNS-based discovery

**Today's theme:** Service-to-service: discovery and load balancing

**After today you can:** You can have three instances of a service and spread calls across them, from each language.

**The interviewer asks it as:** *How does a client find a healthy instance of a service?*
