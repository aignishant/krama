...
day: 156
track: lang-go
title: "Requirements, the .proto metrics schema, and the Go agent"
theme: "Build E, day 1: an observability toolkit. Design"
phase: "Languages: six five-day builds"
status: empty
---

# Day 156 · Go — Requirements, the .proto metrics schema, and the Go agent

**Today's theme:** Build E, day 1: an observability toolkit. Design

**After today you can:** You can design a metrics agent, a collector, and a dashboard.

**The interviewer asks it as:** *Design a monitoring system.*
