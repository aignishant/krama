...
**After today you can:** You can design message delivery, ordering, offline users and end-to-end encryption.

**The interviewer asks it as:** *Design WhatsApp. What happens when the recipient is offline?*
