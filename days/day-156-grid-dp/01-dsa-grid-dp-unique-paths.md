...
day: 156
track: dsa
title: "Grid DP: unique paths and minimum path sum"
phase: "Dynamic programming"
status: empty
---

# Day 156 · DSA — Grid DP: unique paths and minimum path sum

**After today you can:** You can walk a grid with DP and handle obstacles and boundaries cleanly.

**The interviewer asks it as:** *How many paths from the top left to the bottom right?*
