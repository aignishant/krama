...
day: 171
track: lang-go
title: "The protobuf APIs for orders, inventory, and payments"
theme: "Capstone, day 1: an order platform. Requirements and API"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 171 · Go — The protobuf APIs for orders, inventory, and payments

**Today's theme:** Capstone, day 1: an order platform. Requirements and API

**After today you can:** You can write the requirements and every API of the capstone before writing a line of logic.

**The interviewer asks it as:** *Design an e-commerce order platform.*
