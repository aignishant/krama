...
**After today you can:** You can convert between binary and decimal and read a bit pattern without panic.

**The interviewer asks it as:** *What is 13 in binary? What does shifting left by one do?*
