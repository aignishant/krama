...
Prior DSA session: [day 1](../../day-001-count-target-values/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 1](../../day-001-count-target-values/dsa/README.md)
