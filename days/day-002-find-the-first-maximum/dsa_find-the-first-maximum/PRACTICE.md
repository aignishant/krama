...
Return the first index of the maximum; return -1 for an empty list.
...
5. Run `python course.py practice 2` from the repository root. The starter is intentionally RED.
