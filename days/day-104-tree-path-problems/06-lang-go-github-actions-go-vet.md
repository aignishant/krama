...
day: 104
track: lang-go
title: "GitHub Actions: go vet, staticcheck, test -race, and coverage"
theme: "CI for three languages"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 104 · Go — GitHub Actions: go vet, staticcheck, test -race, and coverage

**Today's theme:** CI for three languages

**After today you can:** You can make every push run the tests for all three languages and block a bad merge.

**The interviewer asks it as:** *What runs when you open a pull request?*
