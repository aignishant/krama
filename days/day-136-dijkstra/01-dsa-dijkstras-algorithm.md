...
**After today you can:** You can find shortest paths with weights, and say why it needs a priority queue.

**The interviewer asks it as:** *Find the shortest path in a weighted graph.*
