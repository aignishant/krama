...
day: 136
track: lang-go
title: "Requirements, the .proto API, and the Go server skeleton"
theme: "Build A, day 1: a distributed cache. Design"
phase: "Languages: six five-day builds"
status: empty
---

# Day 136 · Go — Requirements, the .proto API, and the Go server skeleton

**Today's theme:** Build A, day 1: a distributed cache. Design

**After today you can:** You can write the requirements and the protobuf API for a distributed cache.

**The interviewer asks it as:** *Design a distributed cache. Start with the API.*
