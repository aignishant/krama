...
**After today you can:** You can place a search cluster in an architecture and keep it in sync with the database.

**The interviewer asks it as:** *Where does Elasticsearch sit, and how does it stay up to date?*
