# Day 109 DSA — Weighted scheduling

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Weighted scheduling** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-109. **Theme:** Knapsack and advanced DP states.

## Prerequisite and recall

Prior DSA session: [day 108](../../day-108-signed-target-count/dsa_signed-target-count/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 108](../../day-108-signed-target-count/dsa_signed-target-count/README.md), [day 102](../../day-102-edit-distance/dsa_edit-distance/README.md), [day 88](../../day-088-circular-fuel-route/dsa_circular-fuel-route/README.md)
...
**Weighted scheduling.** Jobs [start,end,value] have positive length, are half-open, and nonnegative value. Return maximum compatible value.
