# Practice — Weighted scheduling

## Contract

Jobs [start,end,value] have positive length, are half-open, and nonnegative value. Return maximum compatible value.
...
5. Run `python course.py practice 109` from the repository root. The starter is intentionally RED.
