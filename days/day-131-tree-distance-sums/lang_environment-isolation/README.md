# Day 131 — Environment isolation

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Environment isolation** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-131.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Record the active interpreter and environment paths and explain how to avoid installing into the wrong interpreter.
