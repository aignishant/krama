# Day 128 — Circular imports

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Circular imports** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-128.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Construct a minimal circular dependency, capture its actual failure and repair the responsibility split.
