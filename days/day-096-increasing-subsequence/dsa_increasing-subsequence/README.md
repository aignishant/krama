# Day 096 DSA — Increasing subsequence

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Increasing subsequence** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-96. **Theme:** Dynamic programming foundations.

## Prerequisite and recall

Prior DSA session: [day 95](../../day-095-coin-combinations/dsa_coin-combinations/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 95](../../day-095-coin-combinations/dsa_coin-combinations/README.md), [day 89](../../day-089-task-cooldown-length/dsa_task-cooldown-length/README.md), [day 75](../../day-075-two-color-graph/dsa_two-color-graph/README.md)
...
**Increasing subsequence.** Return length of longest strictly increasing subsequence. Implement quadratic DP before the faster extension.
