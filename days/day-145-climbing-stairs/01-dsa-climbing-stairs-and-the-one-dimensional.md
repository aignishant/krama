...
**After today you can:** You can write the recurrence for a linear DP before you write any code.

**The interviewer asks it as:** *How many ways to climb n stairs taking one or two steps?*
