...
day: 145
track: lang-go
title: "Metrics, graceful shutdown, and CI"
theme: "Build B, day 5: ship it"
phase: "Languages: six five-day builds"
status: empty
---

# Day 145 · Go — Metrics, graceful shutdown, and CI

**Today's theme:** Build B, day 5: ship it

**After today you can:** You can ship the job system with a dashboard, metrics, and CI.

**The interviewer asks it as:** *How do you know your job system is healthy?*
