# Day 100 DSA — Minimum grid path

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum grid path** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-100. **Theme:** Dynamic programming on grids and strings.

## Prerequisite and recall

Prior DSA session: [day 99](../../day-099-grid-path-count/dsa_grid-path-count/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 99](../../day-099-grid-path-count/dsa_grid-path-count/README.md), [day 93](../../day-093-nonadjacent-loot/dsa_nonadjacent-loot/README.md), [day 79](../../day-079-negative-edge-paths/dsa_negative-edge-paths/README.md)
...
**Minimum grid path.** Return minimum sum along right/down path in a nonempty rectangular integer grid, including endpoints.
