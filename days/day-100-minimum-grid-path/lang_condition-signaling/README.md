# Day 100 — Condition signaling

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Condition signaling** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-100.
**Weekly theme:** Threads and processes.

## Assignment

Use an Event or Condition to coordinate a worker without arbitrary sleeps.
