# Day 100 — Feed API and data

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Feed API and data** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-100.
**Weekly theme:** Feed case study.

## Assignment

Model posts, follows and feed entries; define cursor pagination under concurrent posts.
