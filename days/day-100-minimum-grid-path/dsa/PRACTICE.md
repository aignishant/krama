# Practice — Minimum grid path

## Contract

Return minimum sum along right/down path in a nonempty rectangular integer grid, including endpoints.
...
5. Run `python course.py practice 100` from the repository root. The starter is intentionally RED.
