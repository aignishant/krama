# Day 090 — Async context managers

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Async context managers** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-90.
**Weekly theme:** Async fundamentals.

## Assignment

Implement async setup and cleanup using asynccontextmanager and test failure in the body.
