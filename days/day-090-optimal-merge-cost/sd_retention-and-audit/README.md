# Day 090 — Retention and audit

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Retention and audit** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-90.
**Weekly theme:** Security and tenancy.

## Assignment

Specify hypothetical product retention and deletion behavior, backups and an audit trail; this is a design exercise, not legal advice.
