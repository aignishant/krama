...
**After today you can:** You can draw the path from production writes to a dashboard number.

**The interviewer asks it as:** *How does yesterday's revenue number get onto the dashboard?*
