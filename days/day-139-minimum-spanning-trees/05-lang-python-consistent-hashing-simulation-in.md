...
day: 139
track: lang-python
title: "Consistent hashing simulation in Python"
theme: "Build A, day 4: consistent hashing"
phase: "Languages: six five-day builds"
status: empty
---

# Day 139 · Python — Consistent hashing simulation in Python

**Today's theme:** Build A, day 4: consistent hashing

**After today you can:** You can spread keys over N nodes so adding one moves only 1/N of them.

**The interviewer asks it as:** *What happens to the keys when you add a cache node?*
