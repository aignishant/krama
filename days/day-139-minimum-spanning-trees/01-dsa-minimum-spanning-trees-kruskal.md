...
**After today you can:** You can build the cheapest connecting network and explain both greedy strategies.

**The interviewer asks it as:** *Connect all the cities at minimum cost.*
