...
day: 151
track: dsa
title: "Coin change II: counting the ways"
phase: "Dynamic programming"
status: empty
---

# Day 151 · DSA — Coin change II: counting the ways

**After today you can:** You can count combinations without counting the same set twice, and explain the loop order.

**The interviewer asks it as:** *In how many ways can you make the amount?*
