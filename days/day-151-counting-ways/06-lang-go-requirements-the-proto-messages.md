...
day: 151
track: lang-go
title: "Requirements, the .proto messages, and the Go hub"
theme: "Build D, day 1: a chat system. Design"
phase: "Languages: six five-day builds"
status: empty
---

# Day 151 · Go — Requirements, the .proto messages, and the Go hub

**Today's theme:** Build D, day 1: a chat system. Design

**After today you can:** You can design a chat system with rooms, presence, and history.

**The interviewer asks it as:** *Design a chat application.*
