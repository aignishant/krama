# Day 053 — Quorum reasoning

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Quorum reasoning** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-53.
**Weekly theme:** Replication and consistency.

## Assignment

For N=3 compare R=1/W=1 and R=2/W=2; explain why overlap alone does not establish linearizability.
