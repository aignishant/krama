# Day 053 DSA — Balanced parentheses

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Balanced parentheses** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-53. **Theme:** Recursion and backtracking.

## Prerequisite and recall

Prior DSA session: [day 52](../../day-052-combination-sum/dsa_combination-sum/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 52](../../day-052-combination-sum/dsa_combination-sum/README.md), [day 46](../../day-046-warmer-days/dsa_warmer-days/README.md), [day 32](../../day-032-minimum-meeting-rooms/dsa_minimum-meeting-rooms/README.md)
...
**Balanced parentheses.** Return all strings of n balanced pairs, sorted lexicographically; n >= 0.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Output-sensitive; explain valid-prefix pruning.
