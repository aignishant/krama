...
Return all strings of n balanced pairs, sorted lexicographically; n >= 0.
...
5. Run `python course.py practice 53` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Output-sensitive; explain valid-prefix pruning**.
