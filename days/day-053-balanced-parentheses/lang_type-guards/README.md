...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Type guards** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-53.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Write and test a predicate narrowing an object after checking its real structure.
