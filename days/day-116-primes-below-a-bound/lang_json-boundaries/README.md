# Day 116 — JSON boundaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **JSON boundaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-116.
**Weekly theme:** Files, text and data boundaries.

## Assignment

Validate a parsed JSON object's shape before use; test malformed input and unexpected types.
