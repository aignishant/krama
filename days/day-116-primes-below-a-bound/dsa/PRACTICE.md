# Practice — Primes below a bound

## Contract

Return all primes strictly less than n for n >= 0.
...
5. Run `python course.py practice 116` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n log log n) sieve target**.
