...
7. **Recall later without practice:** read [this day's card](../../../docs/SD_RECALL.md#day-016-api-contract) for a previously studied topic; reading is not completion.

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-16.
**Weekly theme:** Service boundaries and API design.

## Assignment

Write a compact request/response/error contract for creating an expiring link; include input validation.
