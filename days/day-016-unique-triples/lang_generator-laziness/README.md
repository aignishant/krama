...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Generator laziness** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-16.
**Weekly theme:** Iteration and generators.

## Assignment

Build a generator with observable side effects and show creation versus first iteration behavior.
