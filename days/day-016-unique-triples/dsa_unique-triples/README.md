...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Unique triples** is not yet expanded.
...
Prior DSA session: [day 15](../../day-015-sorted-pair-existence/dsa_sorted-pair-existence/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 15](../../day-015-sorted-pair-existence/dsa_sorted-pair-existence/README.md), [day 9](../../day-009-frequency-ranking/dsa_frequency-ranking/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n^2) time excluding output.
