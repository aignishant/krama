...
day: 80
track: lang-cpp
title: "double, long double, integer overflow, and a big-int library"
theme: "Numbers: floats, decimals, and big integers"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 080 · C++ — double, long double, integer overflow, and a big-int library

**Today's theme:** Numbers: floats, decimals, and big integers

**After today you can:** You can add money correctly and say why 0.1 + 0.2 is not 0.3, in each language.

**The interviewer asks it as:** *Why should you never store money as a float?*
