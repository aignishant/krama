# Practice — Cold re-solve: Tree diameter
...
First re-solve [day 57](../../day-057-tree-depth/dsa_tree-depth/README.md), then the core below from
[day 61](../../day-061-tree-diameter/dsa_tree-diameter/README.md), both from blank code. A harder unresolved problem
...
Return maximum edges on any path between two nodes; empty and singleton have diameter 0.
...
Input:
```json
{"tree":[1,[2,[4,null,null],[5,null,null]],[3,null,null]]}
```
...
5. Run `python course.py practice 63` from the repository root. The starter is intentionally RED.
