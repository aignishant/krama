...
**After today you can:** You can say exactly why Dijkstra fails on negative weights, with an example graph.

**The interviewer asks it as:** *Why can't you use Dijkstra here?*
