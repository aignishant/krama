...
day: 137
track: lang-go
title: "Sharded maps, TTLs, eviction, and the gRPC service"
theme: "Build A, day 2: the server core"
phase: "Languages: six five-day builds"
status: empty
---

# Day 137 · Go — Sharded maps, TTLs, eviction, and the gRPC service

**Today's theme:** Build A, day 2: the server core

**After today you can:** You can implement an LRU-with-TTL store behind a gRPC service in Go.

**The interviewer asks it as:** *How do you evict from a cache under memory pressure?*
