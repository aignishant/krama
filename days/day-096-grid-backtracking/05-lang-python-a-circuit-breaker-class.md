...
day: 96
track: lang-python
title: "A circuit breaker class and idempotency keys in a store"
theme: "Circuit breakers and idempotency keys"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 096 · Python — A circuit breaker class and idempotency keys in a store

**Today's theme:** Circuit breakers and idempotency keys

**After today you can:** You can stop cascading failure and make a payment endpoint safe to retry, in each language.

**The interviewer asks it as:** *A client retries a payment. How do you make sure it is charged once?*
