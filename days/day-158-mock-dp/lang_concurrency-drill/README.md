# Day 158 — Concurrency drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Concurrency drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-158.
**Weekly theme:** Python interview drills.

## Assignment

Choose threads, processes or async for three workloads and justify using blocking behavior and data sharing.
