...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock DP** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-158. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 157](../../day-157-mock-graph/dsa_mock-graph/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 157](../../day-157-mock-graph/dsa_mock-graph/README.md), [day 151](../../day-151-smallest-missing-positive/dsa_smallest-missing-positive/README.md), [day 137](../../day-137-order-statistic-stream/dsa_order-statistic-stream/README.md)
...
**Mock DP.** Return maximum sum from a nonempty circular array of nonnegative houses, with no adjacent selected houses; one house may be selected.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(1) auxiliary.
