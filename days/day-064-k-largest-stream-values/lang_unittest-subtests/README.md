# Day 064 — Unittest subtests

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Unittest subtests** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-64.
**Weekly theme:** Testing and debugging.

## Assignment

Write boundary cases using subTest and intentionally break one expectation to inspect failure output.
