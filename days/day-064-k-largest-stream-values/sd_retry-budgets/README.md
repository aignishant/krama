# Day 064 — Retry budgets

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Retry budgets** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-64.
**Weekly theme:** Reliability patterns.

## Assignment

Draw an outage with three retrying layers; quantify amplification and move retries to a deliberate boundary.
