...
day: 118
track: lang-python
title: "hypothesis for property-based tests"
theme: "Fuzz testing"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 118 · Python — hypothesis for property-based tests

**Today's theme:** Fuzz testing

**After today you can:** You can let the computer find the input that breaks your parser, in each language.

**The interviewer asks it as:** *How would you test a parser against inputs you did not think of?*
