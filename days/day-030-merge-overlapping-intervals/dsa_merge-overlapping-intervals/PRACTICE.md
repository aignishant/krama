...
Return sorted merged closed intervals; touching endpoints overlap.
...
5. Run `python course.py practice 30` from the repository root. The starter is intentionally RED.
