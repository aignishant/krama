...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Log structured storage** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-30.
**Weekly theme:** Storage engine tradeoffs.

## Assignment

Sketch memory buffer, immutable files and compaction; compare write cost and read cost.
