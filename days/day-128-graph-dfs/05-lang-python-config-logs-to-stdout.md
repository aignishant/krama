...
day: 128
track: lang-python
title: "Config, logs to stdout, stateless processes, in Python"
theme: "Twelve-factor services"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 128 · Python — Config, logs to stdout, stateless processes, in Python

**Today's theme:** Twelve-factor services

**After today you can:** You can name the twelve factors and point at where each of your services obeys them.

**The interviewer asks it as:** *Why should a service write logs to stdout?*
