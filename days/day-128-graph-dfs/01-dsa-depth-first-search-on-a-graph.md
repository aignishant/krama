...
**After today you can:** You can write DFS recursively and iteratively, and handle disconnected graphs.

**The interviewer asks it as:** *Traverse this graph depth-first. What if it is disconnected?*
