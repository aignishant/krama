# Practice — Cold re-solve: Counterexample capstone
...
First re-solve [day 162](../../day-162-routing-capstone/dsa_routing-capstone/README.md), then the core below from
[day 166](../../day-166-counterexample-capstone/dsa_counterexample-capstone/README.md), both from blank code. A harder unresolved problem
...
Return the maximum sum of a nonempty contiguous subarray; nums nonempty and may be all negative.
...
5. Run `python course.py practice 168` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n) time; O(1) state**.
