# Practice — Set bit counts

## Contract

Return popcount for every integer from 0 through n, where n >= 0.
...
5. Run `python course.py practice 114` from the repository root. The starter is intentionally RED.
