...
day: 97
track: lang-python
title: "prometheus_client and OpenTelemetry"
theme: "Observability: metrics and traces"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 097 · Python — prometheus_client and OpenTelemetry

**Today's theme:** Observability: metrics and traces

**After today you can:** You can expose a metrics endpoint and a trace that crosses two services, in each language.

**The interviewer asks it as:** *What are the three pillars of observability?*
