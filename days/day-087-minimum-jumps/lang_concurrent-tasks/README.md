# Day 087 — Concurrent tasks

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Concurrent tasks** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-87.
**Weekly theme:** Async fundamentals.

## Assignment

Run independent coroutines with TaskGroup and compare elapsed behavior without asserting fragile exact timing.
