# Practice — Minimum jumps

## Contract

Return fewest jumps to final index, -1 if unreachable; nonempty nonnegative nums.
...
5. Run `python course.py practice 87` from the repository root. The starter is intentionally RED.
