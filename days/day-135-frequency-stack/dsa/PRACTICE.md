# Practice — Frequency stack

## Contract

Process [push,value] and [pop]. Pop most frequent value, breaking ties by most recent push among current elements. Return popped values.
...
Input:
```json
{"ops":[["push",5],["push",7],["push",5],["push",7],["push",4],["push",5],["pop"],["pop"]]}
```
...
5. Run `python course.py practice 135` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Expected O(1) per operation**.
