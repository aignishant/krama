# Day 135 — Configuration

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Configuration** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-135.
**Weekly theme:** Production Python service code.

## Assignment

Parse environment-like input into typed settings with explicit missing/invalid errors and no real secrets.
