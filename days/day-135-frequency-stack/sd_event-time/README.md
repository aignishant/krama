...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Event time** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-135.
**Weekly theme:** Analytics and stream processing.

## Assignment

Show late and out-of-order events; distinguish event time, processing time and watermark assumptions.
