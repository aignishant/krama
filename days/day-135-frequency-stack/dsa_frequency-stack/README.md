# Day 135 DSA — Frequency stack

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Frequency stack** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-135. **Theme:** Data structure design and tradeoffs.

## Prerequisite and recall

Prior DSA session: [day 134](../../day-134-time-indexed-values/dsa_time-indexed-values/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 134](../../day-134-time-indexed-values/dsa_time-indexed-values/README.md), [day 128](../../day-128-minimum-effort-grid-route/dsa_minimum-effort-grid-route/README.md), [day 114](../../day-114-set-bit-counts/dsa_set-bit-counts/README.md)
...
**Frequency stack.** Process [push,value] and [pop]. Pop most frequent value, breaking ties by most recent push among current elements. Return popped values.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Expected O(1) per operation.
