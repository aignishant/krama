...
day: 138
track: lang-python
title: "A Python client with connection pooling and retries"
theme: "Build A, day 3: clients"
phase: "Languages: six five-day builds"
status: empty
---

# Day 138 · Python — A Python client with connection pooling and retries

**Today's theme:** Build A, day 3: clients

**After today you can:** You can write a client library in each language against the same protobuf API.

**The interviewer asks it as:** *What does a good client library do for you?*
