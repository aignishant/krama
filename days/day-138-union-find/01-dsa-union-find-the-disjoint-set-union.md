...
**After today you can:** You can implement find and union with path compression and say why it is nearly O(1).

**The interviewer asks it as:** *Are these two nodes in the same group? Now merge two groups.*
