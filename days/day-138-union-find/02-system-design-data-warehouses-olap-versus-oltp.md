...
**After today you can:** You can say why analytics does not run on the production database.

**The interviewer asks it as:** *The analytics query is locking the production table. What do you do?*
