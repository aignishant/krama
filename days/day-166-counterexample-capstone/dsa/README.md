...
Prior DSA session: [day 165](../../day-165-range-capstone/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 165](../../day-165-range-capstone/dsa/README.md), [day 159](../../day-159-mock-heap/dsa/README.md), [day 145](../../day-145-rotated-minimum-with-duplicates/dsa/README.md)
