# Day 123 — Subprocess contracts

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Subprocess contracts** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-123.
**Weekly theme:** Persistence and safe I/O.

## Assignment

Run the current interpreter with an argument list, capture output and check nonzero exit status without shell interpolation.
