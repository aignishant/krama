...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Idempotency semantics** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-10.
**Weekly theme:** Networking and HTTP.

## Assignment

Show two retries of the same create request; choose a client key and define replay versus conflict behavior.
