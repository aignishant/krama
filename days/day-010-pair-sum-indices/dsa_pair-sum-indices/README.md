...
7. **Recall later without practice:** read [this day's recall card](../../../docs/DSA_RECALL.md#day-010-pair-sum-indices) for a previously studied topic. Reading is not learner completion.
...
**Budget:** 60 minutes. **Outcome:** DSA-10. **Theme:** Hashing and prefix sums.

## Prerequisite and recall

Prior DSA session: [day 9](../../day-009-frequency-ranking/dsa_frequency-ranking/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 9](../../day-009-frequency-ranking/dsa_frequency-ranking/README.md), [day 3](../../day-003-stable-compaction/dsa_stable-compaction/README.md)
...
**Pair sum indices.** Return the lexicographically smallest index pair [i,j] with i < j and nums[i]+nums[j]=target; return [] if absent.
