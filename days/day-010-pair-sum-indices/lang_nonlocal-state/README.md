...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Nonlocal state** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-10.
**Weekly theme:** Functions and scope.

## Assignment

Build a closure counter and explain where the state lives; compare with a callable instance.
