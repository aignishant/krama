...
7. **Recall later without practice:** read [this day's recall card](../../../docs/LANG_RECALL.md#day-010-nonlocal-state) for a previously studied topic. Reading is not learner completion.
