...
day: 76
track: lang-go
title: "testing.B, b.N, benchstat, and allocation counts"
theme: "Benchmarking"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 076 · Go — testing.B, b.N, benchstat, and allocation counts

**Today's theme:** Benchmarking

**After today you can:** You can measure a function honestly in each language and say what makes a benchmark lie.

**The interviewer asks it as:** *How would you prove your change made it faster?*
