# Day 057 DSA — Tree depth

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tree depth** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-57. **Theme:** Binary trees and search trees.

## Prerequisite and recall

Prior DSA session: [day 56](../../day-056-week-8-review/dsa_week-8-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 56](../../day-056-week-8-review/dsa_week-8-dsa-review/README.md), [day 50](../../day-050-enumerate-subsets/dsa_enumerate-subsets/README.md), [day 36](../../day-036-reverse-a-linked-list/dsa_reverse-a-linked-list/README.md)
...
**Tree depth.** Trees use null or [value,left,right]. Return maximum number of nodes on a root-to-leaf path.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(height) call stack.
