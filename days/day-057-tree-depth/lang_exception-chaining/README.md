# Day 057 — Exception chaining

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Exception chaining** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-57.
**Weekly theme:** Exceptions and resource lifetime.

## Assignment

Catch a low-level error and raise a domain error with from; inspect both traceback and cause.
