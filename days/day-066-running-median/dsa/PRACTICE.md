# Practice — Running median

## Contract

After each integer insertion return the current median as a number.
...
5. Run `python course.py practice 66` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(log n) per insertion**.
