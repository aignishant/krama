# Day 066 — Mock boundaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock boundaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-66.
**Weekly theme:** Testing and debugging.

## Assignment

Patch a dependency where the consuming module looks it up and explain why the definition module can be the wrong target.
