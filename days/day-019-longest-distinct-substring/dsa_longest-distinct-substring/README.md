# Day 019 DSA — Longest distinct substring
...
7. **Recall later without practice:** read the [DSA summary file](../../../docs/DSA_RECALL.md#day-019-longest-distinct-substring) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.
...
**Budget:** 60 minutes. **Outcome:** DSA-19. **Theme:** Two pointers and sliding windows.

## Prerequisite and recall

Prior DSA session: [day 18](../../day-018-fixed-window-maximum-sum/dsa_fixed-window-maximum-sum/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 18](../../day-018-fixed-window-maximum-sum/dsa_fixed-window-maximum-sum/README.md), [day 12](../../day-012-range-sums/dsa_range-sums/README.md)
...
**Longest distinct substring.** Return the length of the longest substring with no repeated Unicode code point.
