# Day 156 — Protocol drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Protocol drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-156.
**Weekly theme:** Python interview drills.

## Assignment

Implement a small iterable context-managed resource and explain both protocols out loud.
