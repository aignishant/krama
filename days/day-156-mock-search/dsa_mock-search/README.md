# Day 156 DSA — Mock search

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock search** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-156. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 155](../../day-155-mock-arrays/dsa_mock-arrays/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 155](../../day-155-mock-arrays/dsa_mock-arrays/README.md), [day 149](../../day-149-course-completion-time/dsa_course-completion-time/README.md), [day 135](../../day-135-frequency-stack/dsa_frequency-stack/README.md)
...
**Mock search.** Return minimum integer eating speed finishing positive piles within h hours; h >= number of piles and piles nonempty.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n log(max(piles))) time.
