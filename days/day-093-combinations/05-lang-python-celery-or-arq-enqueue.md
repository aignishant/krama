...
day: 93
track: lang-python
title: "Celery or arq: enqueue, retry, and schedule"
theme: "Background jobs"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 093 · Python — Celery or arq: enqueue, retry, and schedule

**Today's theme:** Background jobs

**After today you can:** You can move slow work out of the request path in each language.

**The interviewer asks it as:** *The email takes three seconds to send. Where does that code go?*
