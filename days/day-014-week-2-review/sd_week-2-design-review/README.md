...
3. **Read the assignment:** use [the bounded design task](#assignment) for the cold attempt; compare explanations afterward.
...
7. **Recall later without practice:** read [this day's card](../../../docs/SD_RECALL.md#day-014-week-2-design-review) for a previously studied topic; reading is not completion.
...
Revisit days 8–13. Choose your weakest design decision, revise its diagram or memo, then defend one alternative and walk through one failure.

## Complete reference and personal practice

The assistant wrote [REFERENCE_DESIGN.md](REFERENCE_DESIGN.md). Compare this only after the cold attempt.
[DESIGN.md](DESIGN.md) and its TODOs belong to you. Reference reading uses the
existing concept/critique windows and does not complete the assessment.
