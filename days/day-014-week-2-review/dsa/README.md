...
Prior DSA session: [day 13](../../day-013-count-target-subarrays/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 13](../../day-013-count-target-subarrays/dsa/README.md), [day 7](../../day-007-week-1-review/dsa/README.md)
