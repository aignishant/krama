...
day: 163
track: lang-cpp
title: "A tree-walking evaluator with std::variant values"
theme: "Build F, day 3: the evaluator"
phase: "Languages: six five-day builds"
status: empty
---

# Day 163 · C++ — A tree-walking evaluator with std::variant values

**Today's theme:** Build F, day 3: the evaluator

**After today you can:** You can run programs in your language, with variables, functions, and closures.

**The interviewer asks it as:** *How do closures capture variables in an interpreter?*
