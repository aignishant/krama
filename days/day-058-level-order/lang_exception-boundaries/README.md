# Day 058 — Exception boundaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Exception boundaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-58.
**Weekly theme:** Exceptions and resource lifetime.

## Assignment

Replace a broad catch with specific exceptions and prove programmer bugs remain visible.
