...
day: 103
track: lang-python
title: "Deployment, Service, probes, and resource limits"
theme: "Kubernetes for your service"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 103 · Python — Deployment, Service, probes, and resource limits

**Today's theme:** Kubernetes for your service

**After today you can:** You can run each of your three services on a local cluster with probes and limits.

**The interviewer asks it as:** *What does Kubernetes do when your pod dies?*
