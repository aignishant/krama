# Day 136 — Aggregation windows

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Aggregation windows** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-136.
**Weekly theme:** Analytics and stream processing.

## Assignment

Choose tumbling versus sliding windows; show a late event update and retention cutoff.
