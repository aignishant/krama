# Practice — Least frequently used cache

## Contract

Process put/get like the LRU exercise, capacity >= 1; evict lowest frequency, then least recently used within it. New keys start at frequency 1; get and updating put increment frequency.
...
5. Run `python course.py practice 136` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Expected O(1) operations; stretch**.
