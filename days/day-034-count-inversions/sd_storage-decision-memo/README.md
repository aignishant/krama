...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Storage decision memo** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-34.
**Weekly theme:** Storage engine tradeoffs.

## Assignment

Choose relational versus key-value storage for redirects using three access patterns and two failure requirements.
