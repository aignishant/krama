# Day 034 DSA — Count inversions

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Count inversions** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-34. **Theme:** Sorting, intervals and selection.

## Prerequisite and recall

Prior DSA session: [day 33](../../day-033-kth-smallest/dsa_kth-smallest/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 33](../../day-033-kth-smallest/dsa_kth-smallest/README.md), [day 27](../../day-027-median-of-two-arrays/dsa_median-of-two-arrays/README.md), [day 13](../../day-013-count-target-subarrays/dsa_count-target-subarrays/README.md)
...
**Count inversions.** Count index pairs i < j with nums[i] > nums[j].
