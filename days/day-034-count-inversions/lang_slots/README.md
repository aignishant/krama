...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Slots** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-34.
**Weekly theme:** Classes and descriptors.

## Assignment

Compare presence of __dict__ in slotted and ordinary instances; measure rather than invent a memory saving.
