# Practice — Warmer days

## Contract

For each temperature return days until a strictly warmer temperature, or 0.
...
5. Run `python course.py practice 46` from the repository root. The starter is intentionally RED.
