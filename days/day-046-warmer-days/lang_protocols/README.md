...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Protocols** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-46.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Specify a small structural interface and write two implementations without a common base class.
