# Practice — Course completion time

## Contract

DAG edges u->v and positive durations per node; unlimited parallel workers. Return minimum makespan; empty graph returns 0.
...
5. Run `python course.py practice 149` from the repository root. The starter is intentionally RED.
