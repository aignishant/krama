# Day 149 DSA — Course completion time

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Course completion time** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-149. **Theme:** Mixed pattern selection II.

## Prerequisite and recall

Prior DSA session: [day 148](../../day-148-interleaved-strings/dsa_interleaved-strings/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 148](../../day-148-interleaved-strings/dsa_interleaved-strings/README.md), [day 142](../../day-142-longest-consecutive-run/dsa_longest-consecutive-run/README.md), [day 128](../../day-128-minimum-effort-grid-route/dsa_minimum-effort-grid-route/README.md)
...
**Course completion time.** DAG edges u->v and positive durations per node; unlimited parallel workers. Return minimum makespan; empty graph returns 0.
