# Day 079 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/cheapest-flights-within-k-stops/)

**Difficulty:** Medium. **Original course day:** 79.

**Contract comparison:** Related bounded-relaxation drill with a stop limit and nonnegative fares. It does not replace the local negative-edge/cycle-detection exercise.
