# Day 079 — Iterator duplication

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Iterator duplication** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-79.
**Weekly theme:** Functional tools and caching.

## Assignment

Inspect tee behavior with consumers progressing at different rates; explain buffered memory risk.
