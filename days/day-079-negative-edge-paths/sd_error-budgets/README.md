# Day 079 — Error budgets

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Error budgets** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-79.
**Weekly theme:** Observability and operations.

## Assignment

For a hypothetical 99.9 percent success target over 1 million requests, calculate allowed failures and a release decision.
