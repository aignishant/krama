# Day 065 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/merge-k-sorted-lists/)

**Difficulty:** Hard. **Original course day:** 65.

**Contract comparison:** Online merges linked lists; local practice merges arrays. Reuse heap reasoning, not the adapter.
