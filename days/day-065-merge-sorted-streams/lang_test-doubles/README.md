# Day 065 — Test doubles

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Test doubles** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-65.
**Weekly theme:** Testing and debugging.

## Assignment

Inject a fake clock into timeout logic instead of sleeping in tests.
