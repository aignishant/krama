...
day: 85
track: lang-cpp
title: "std::this_thread::sleep_until, and a timer wheel in outline"
theme: "Timers, tickers, and scheduling"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 085 · C++ — std::this_thread::sleep_until, and a timer wheel in outline

**Today's theme:** Timers, tickers, and scheduling

**After today you can:** You can run a job every minute, reliably, in each language, and say what drift is.

**The interviewer asks it as:** *How would you run a task every day at midnight inside a service?*
