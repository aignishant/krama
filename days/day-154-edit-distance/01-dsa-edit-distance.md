...
**After today you can:** You can derive the three-way recurrence yourself instead of memorising it.

**The interviewer asks it as:** *Find the minimum number of edits to turn one string into another.*
