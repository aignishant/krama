# Day 143 DSA — Trapped rainwater

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Trapped rainwater** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-143. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 142](../../day-142-longest-consecutive-run/dsa_longest-consecutive-run/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 142](../../day-142-longest-consecutive-run/dsa_longest-consecutive-run/README.md), [day 136](../../day-136-least-frequently-used-cache/dsa_least-frequently-used-cache/README.md), [day 122](../../day-122-find-all-pattern-matches/dsa_find-all-pattern-matches/README.md)
...
**Trapped rainwater.** Return total trapped water above nonnegative unit-width bars.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(1) auxiliary stretch.
