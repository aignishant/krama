# Day 143 — Name resolution

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Name resolution** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-143.
**Weekly theme:** Internals and version-aware Python.

## Assignment

Inspect locals, globals and closure variables for a function with nested scope.
