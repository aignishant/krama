# Day 161 DSA — Week 23 DSA review
...
Original reading, after cold recall: [Day 155](../../day-155-mock-arrays/dsa_mock-arrays/README.md) · [Day 156](../../day-156-mock-search/dsa_mock-search/README.md) · [Day 157](../../day-157-mock-graph/dsa_mock-graph/README.md) · [Day 158](../../day-158-mock-dp/dsa_mock-dp/README.md) · [Day 159](../../day-159-mock-heap/dsa_mock-heap/README.md) · [Day 160](../../day-160-mock-backtracking/dsa_mock-backtracking/README.md).
...
**Budget:** 60 minutes. **Outcome:** DSA-161. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 160](../../day-160-mock-backtracking/dsa_mock-backtracking/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 160](../../day-160-mock-backtracking/dsa_mock-backtracking/README.md), [day 154](../../day-154-week-22-review/dsa_week-22-dsa-review/README.md), [day 140](../../day-140-week-20-review/dsa_week-20-dsa-review/README.md)
...
**Cold re-solve: Mock heap.** Return minimum cost to connect all given 2D points using Manhattan-distance edges; empty returns 0.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n^2) dense spanning-tree approach.
