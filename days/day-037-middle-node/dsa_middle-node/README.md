# Day 037 DSA — Middle node

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Middle node** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-37. **Theme:** Linked lists and pointer invariants.

## Prerequisite and recall

Prior DSA session: [day 36](../../day-036-reverse-a-linked-list/dsa_reverse-a-linked-list/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 36](../../day-036-reverse-a-linked-list/dsa_reverse-a-linked-list/README.md), [day 30](../../day-030-merge-overlapping-intervals/dsa_merge-overlapping-intervals/README.md), [day 16](../../day-016-unique-triples/dsa_unique-triples/README.md)
...
**Middle node.** Build singly linked nodes and return the second middle value for even length; null for empty.
