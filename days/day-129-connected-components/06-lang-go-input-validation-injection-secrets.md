...
day: 129
track: lang-go
title: "Input validation, injection, secrets, and the crypto packages"
theme: "Security basics"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 129 · Go — Input validation, injection, secrets, and the crypto packages

**Today's theme:** Security basics

**After today you can:** You can name the top five ways each language gets exploited and how you prevent each.

**The interviewer asks it as:** *What is undefined behaviour, and why does it matter?*
