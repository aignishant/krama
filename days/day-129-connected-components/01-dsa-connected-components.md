...
**After today you can:** You can count the separate pieces of a graph and use that in real problems.

**The interviewer asks it as:** *How many connected components does this graph have?*
