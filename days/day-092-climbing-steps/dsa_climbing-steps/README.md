# Day 092 DSA — Climbing steps

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Climbing steps** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-92. **Theme:** Dynamic programming foundations.

## Prerequisite and recall

Prior DSA session: [day 91](../../day-091-week-13-review/dsa_week-13-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 91](../../day-091-week-13-review/dsa_week-13-dsa-review/README.md), [day 85](../../day-085-maximum-compatible-meetings/dsa_maximum-compatible-meetings/README.md), [day 71](../../day-071-reachability/dsa_reachability/README.md)
...
**Climbing steps.** Return ways to climb n steps using 1 or 2 steps; n >= 0 and there is one empty route for n=0.
