# Day 092 — Bounded concurrency

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Bounded concurrency** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-92.
**Weekly theme:** Async reliability.

## Assignment

Use a semaphore around simulated work and assert observed concurrency never exceeds the bound.
