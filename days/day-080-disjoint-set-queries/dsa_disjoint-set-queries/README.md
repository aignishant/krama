# Day 080 DSA — Disjoint set queries

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Disjoint set queries** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-80. **Theme:** Weighted graphs and connectivity.

## Prerequisite and recall

Prior DSA session: [day 79](../../day-079-negative-edge-paths/dsa_negative-edge-paths/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 79](../../day-079-negative-edge-paths/dsa_negative-edge-paths/README.md), [day 73](../../day-073-island-count/dsa_island-count/README.md), [day 59](../../day-059-validate-search-tree/dsa_validate-search-tree/README.md)
...
**Disjoint set queries.** Process [union,a,b] and [same,a,b] on n isolated vertices. Return booleans for same queries.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Near-constant amortized operations.
