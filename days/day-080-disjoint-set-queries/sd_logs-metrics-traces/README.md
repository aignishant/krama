# Day 080 — Logs metrics traces

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Logs metrics traces** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-80.
**Weekly theme:** Observability and operations.

## Assignment

Choose one example of each for a slow redirect; carry a correlation ID without logging sensitive data.
