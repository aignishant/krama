# Practice — Disjoint set queries

## Contract

Process [union,a,b] and [same,a,b] on n isolated vertices. Return booleans for same queries.
...
Input:
```json
{"n":4,"ops":[["union",0,1],["same",0,1],["same",0,2]]}
```
...
5. Run `python course.py practice 80` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Near-constant amortized operations**.
