...
day: 133
track: lang-python
title: "Descriptors, metaclasses, __new__, and the import system"
theme: "Python, deep: the object model"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 133 · Python — Descriptors, metaclasses, __new__, and the import system

**Today's theme:** Python, deep: the object model

**After today you can:** You can explain how a dataclass or an ORM works underneath, and write a tiny one.

**The interviewer asks it as:** *What is a metaclass, and have you ever needed one?*
