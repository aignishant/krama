...
day: 155
track: dsa
title: "String DP: palindromic substrings and subsequences"
phase: "Dynamic programming"
status: empty
---

# Day 155 · DSA — String DP: palindromic substrings and subsequences

**After today you can:** You can fill a table by substring length, which is the trick these problems need.

**The interviewer asks it as:** *Find the longest palindromic substring. Now the longest palindromic subsequence.*
...
*A scene from ordinary life where this idea already exists. No code, no jargon.*
...
*Time and space, counted by hand from the loops. No hand-waving.*
...
*Five lines. If you remember nothing else from today, remember these.*
