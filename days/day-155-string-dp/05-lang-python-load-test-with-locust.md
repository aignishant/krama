...
day: 155
track: lang-python
title: "Load test with locust"
theme: "Build D, day 5: ship it"
phase: "Languages: six five-day builds"
status: empty
---

# Day 155 · Python — Load test with locust

**Today's theme:** Build D, day 5: ship it

**After today you can:** You can ship the chat system and show a trace of one message end to end.

**The interviewer asks it as:** *Show me one message travelling through your system.*
