...
day: 114
track: lang-python
title: "str methods, textwrap, string.Template, and difflib"
theme: "Standard library tour III: text"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 114 · Python — str methods, textwrap, string.Template, and difflib

**Today's theme:** Standard library tour III: text

**After today you can:** You can parse, transform, and format text without a third-party library, in each language.

**The interviewer asks it as:** *How do you convert a string to an integer safely?*
