# Practice — Reach the end

## Contract

Nonnegative nums[i] is maximum forward jump. Return whether last index is reachable; empty returns false.
...
5. Run `python course.py practice 86` from the repository root. The starter is intentionally RED.
