...
day: 167
track: lang-go
title: "The forty questions: goroutines, channels, interfaces, nil, slices, GC"
theme: "Go interview questions"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 167 · Go — The forty questions: goroutines, channels, interfaces, nil, slices, GC

**Today's theme:** Go interview questions

**After today you can:** You can answer the forty most-asked Go questions out loud.

**The interviewer asks it as:** *Why can a nil pointer inside an interface be non-nil?*
