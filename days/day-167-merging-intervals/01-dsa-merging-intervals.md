...
**After today you can:** You can merge, insert and subtract intervals without missing an edge case.

**The interviewer asks it as:** *Merge all overlapping intervals.*
