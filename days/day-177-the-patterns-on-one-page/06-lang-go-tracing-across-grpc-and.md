...
day: 177
track: lang-go
title: "Tracing across gRPC and Kafka; Kubernetes manifests"
theme: "Capstone, day 7: observe and deploy"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 177 · Go — Tracing across gRPC and Kafka; Kubernetes manifests

**Today's theme:** Capstone, day 7: observe and deploy

**After today you can:** You can deploy the whole platform to a local cluster and follow one order through a trace.

**The interviewer asks it as:** *Show me one order travelling through your system.*
