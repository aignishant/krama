...
**After today you can:** You can name the pattern for any problem you have seen, from a one-line summary.

**The interviewer asks it as:** *Given this problem, which pattern, and why that one?*
