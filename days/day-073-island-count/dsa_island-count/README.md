# Day 073 DSA — Island count

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Island count** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-73. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 72](../../day-072-unweighted-distance/dsa_unweighted-distance/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 72](../../day-072-unweighted-distance/dsa_unweighted-distance/README.md), [day 66](../../day-066-running-median/dsa_running-median/README.md), [day 52](../../day-052-combination-sum/dsa_combination-sum/README.md)
...
**Island count.** Count orthogonally connected components of 1s in a rectangular 0/1 grid; empty grid returns 0.
