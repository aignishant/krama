# Practice — Island count

## Contract

Count orthogonally connected components of 1s in a rectangular 0/1 grid; empty grid returns 0.
...
5. Run `python course.py practice 73` from the repository root. The starter is intentionally RED.
