# Day 073 — Leader terms

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Leader terms** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-73.
**Weekly theme:** Distributed coordination.

## Assignment

Draw a stale leader attempting a write after failover; specify a monotone term or fencing check.
