...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Resharding** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-48.
**Weekly theme:** Load balancing and partitioning.

## Assignment

Outline copy, catch-up, cutover and rollback while writes continue; state how duplicate writes are handled.
