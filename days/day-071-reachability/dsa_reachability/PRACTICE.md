...
Given n vertices 0..n-1 and undirected edges, return whether src reaches dst.
...
5. Run `python course.py practice 71` from the repository root. The starter is intentionally RED.
