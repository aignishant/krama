# Day 071 — Logical ordering

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Logical ordering** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-71.
**Weekly theme:** Distributed coordination.

## Assignment

Construct events on two workers with clock skew; distinguish wall-clock timestamps from causal order.
