# Day 071 — Deque behavior

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Deque behavior** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-71.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Compare endpoint operations on deque with list front deletion using operation reasoning and a small measurement.
