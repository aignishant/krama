# Day 151 — Concurrency review

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Concurrency review** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-151.
**Weekly theme:** Code review and refactoring.

## Assignment

Review an async function for blocking calls, unbounded task creation and swallowed cancellation.
