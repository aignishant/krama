# Practice — Sorted pair existence
...
Return whether two distinct indices in sorted nums sum to target.
...
5. Run `python course.py practice 15` from the repository root. The starter is intentionally RED.
