...
7. **Recall later without practice:** read [this day's card](../../../docs/DSA_RECALL.md#day-015-sorted-pair-existence) for a previously studied topic; reading is not completion.
