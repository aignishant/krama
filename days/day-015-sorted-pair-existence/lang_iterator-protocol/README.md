...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Iterator protocol** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-15.
**Weekly theme:** Iteration and generators.

## Assignment

Implement a finite countdown iterator and prove exhaustion remains exhausted.
