...
7. **Recall later without practice:** read [this day's card](../../../docs/LANG_RECALL.md#day-015-iterator-protocol) for a previously studied topic; reading is not completion.
