...
day: 146
track: lang-cpp
title: "Requirements, the on-disk format, and the C++ engine skeleton"
theme: "Build C, day 1: a storage engine. Design"
phase: "Languages: six five-day builds"
status: empty
---

# Day 146 · C++ — Requirements, the on-disk format, and the C++ engine skeleton

**Today's theme:** Build C, day 1: a storage engine. Design

**After today you can:** You can design a log-structured storage engine and its file format.

**The interviewer asks it as:** *How does a database store data on disk?*
