...
**After today you can:** You can design the encoding, the storage, the read path and the analytics.

**The interviewer asks it as:** *Design a URL shortener like bit.ly.*
