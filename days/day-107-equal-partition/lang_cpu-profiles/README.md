# Day 107 — CPU profiles

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **CPU profiles** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-107.
**Weekly theme:** Profiling and memory.

## Assignment

Profile a deliberately repeated operation with cProfile and distinguish cumulative from self time.
