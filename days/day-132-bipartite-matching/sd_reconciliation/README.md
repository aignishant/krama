# Day 132 — Reconciliation

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Reconciliation** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-132.
**Weekly theme:** Payments and reservations case study.

## Assignment

Compare internal state with provider records; define how unknown outcomes are investigated and repaired.
