...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tree codec round trip** is not yet expanded.
...
Prior DSA session: [day 68](../../day-068-tree-reconstruction/dsa_tree-reconstruction/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 68](../../day-068-tree-reconstruction/dsa_tree-reconstruction/README.md), [day 62](../../day-062-lowest-shared-ancestor/dsa_lowest-shared-ancestor/README.md), [day 48](../../day-048-sliding-window-maxima/dsa_sliding-window-maxima/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time and serialized space.
