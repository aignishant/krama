...
day: 124
track: lang-python
title: "map, filter, reduce, comprehensions, and pure functions"
theme: "Functional style"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 124 · Python — map, filter, reduce, comprehensions, and pure functions

**Today's theme:** Functional style

**After today you can:** You can write a data transformation as a pipeline of pure functions in each language.

**The interviewer asks it as:** *What is a pure function, and why does it matter for testing?*
