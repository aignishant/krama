...
day: 176
track: lang-python
title: "Timeouts, retries, and a circuit breaker in the gateway"
theme: "Capstone, day 6: resilience"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 176 · Python — Timeouts, retries, and a circuit breaker in the gateway

**Today's theme:** Capstone, day 6: resilience

**After today you can:** You can kill any one service and show the platform degrade instead of fall over.

**The interviewer asks it as:** *Kill the pricing service. What does the user see?*
