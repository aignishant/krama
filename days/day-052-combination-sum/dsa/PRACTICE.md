...
From distinct positive candidates return unique sorted combinations summing to target, reusing candidates. Sort final list lexicographically.
...
5. Run `python course.py practice 52` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Output-sensitive exponential search**.
