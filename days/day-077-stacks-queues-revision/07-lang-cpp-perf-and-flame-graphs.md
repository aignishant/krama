...
day: 77
track: lang-cpp
title: "perf, and flame graphs from a Release build with symbols"
theme: "CPU profiling"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 077 · C++ — perf, and flame graphs from a Release build with symbols

**Today's theme:** CPU profiling

**After today you can:** You can find the hottest function in a real program in each language.

**The interviewer asks it as:** *Your service is slow. What do you run first?*
