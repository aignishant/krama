...
Original reading, after cold recall: [Day 78](../../day-078-nonnegative-shortest-paths/sd_slis-and-slos/README.md) · [Day 79](../../day-079-negative-edge-paths/sd_error-budgets/README.md) · [Day 80](../../day-080-disjoint-set-queries/sd_logs-metrics-traces/README.md) · [Day 81](../../day-081-minimum-spanning-cost/sd_tail-latency/README.md) · [Day 82](../../day-082-strong-components/sd_capacity-and-cost/README.md) · [Day 83](../../day-083-critical-edges/sd_incident-review/README.md).

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-84.
**Weekly theme:** Observability and operations.

## Assignment

Revisit days 78–83. Choose your weakest design decision, revise its diagram or memo, then defend one alternative and walk through one failure.
