...
day: 82
track: lang-go
title: "cgo: calling C from Go, and the cost of the boundary"
theme: "Calling across languages"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 082 · Go — cgo: calling C from Go, and the cost of the boundary

**Today's theme:** Calling across languages

**After today you can:** You can write a hot loop in C++ and call it from Python and Go.

**The interviewer asks it as:** *When would you drop down to C++ from Python or Go?*
