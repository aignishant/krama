# Day 033 DSA — Kth smallest

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Kth smallest** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-33. **Theme:** Sorting, intervals and selection.

## Prerequisite and recall

Prior DSA session: [day 32](../../day-032-minimum-meeting-rooms/dsa_minimum-meeting-rooms/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 32](../../day-032-minimum-meeting-rooms/dsa_minimum-meeting-rooms/README.md), [day 26](../../day-026-minimum-shipping-capacity/dsa_minimum-shipping-capacity/README.md), [day 12](../../day-012-range-sums/dsa_range-sums/README.md)
...
**Kth smallest.** Return kth smallest value, counting duplicates; k is one-based and valid. Implement partition-based selection.
