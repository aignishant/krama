...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Inheritance and super** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-33.
**Weekly theme:** Classes and descriptors.

## Assignment

Use a small diamond hierarchy to trace cooperative super calls and inspect the method resolution order.
