...
day: 88
track: lang-cpp
title: "Generating C++ with a script, and CMake configure_file"
theme: "Templates and code generation"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 088 · C++ — Generating C++ with a script, and CMake configure_file

**Today's theme:** Templates and code generation

**After today you can:** You can render a report from data and generate source code from a table, in each language.

**The interviewer asks it as:** *When is generating code better than writing it?*
