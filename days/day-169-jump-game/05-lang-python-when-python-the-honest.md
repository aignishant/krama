...
day: 169
track: lang-python
title: "When Python: the honest case"
theme: "Choosing a language"
phase: "Languages: interview prep and the capstone"
status: empty
---

# Day 169 · Python — When Python: the honest case

**Today's theme:** Choosing a language

**After today you can:** You can pick a language for a given job and defend it in two minutes.

**The interviewer asks it as:** *Which language would you use for this service, and why?*
