# Day 075 — Bisect contracts

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Bisect contracts** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-75.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Test bisect_left and bisect_right with duplicates; distinguish logarithmic search from linear list insertion.
