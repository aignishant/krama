# Day 075 DSA — Two-color graph

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Two-color graph** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-75. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 74](../../day-074-dependency-order/dsa_dependency-order/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 74](../../day-074-dependency-order/dsa_dependency-order/README.md), [day 68](../../day-068-tree-reconstruction/dsa_tree-reconstruction/README.md), [day 54](../../day-054-word-search/dsa_word-search/README.md)
...
**Two-color graph.** Return whether an undirected graph is bipartite; include disconnected components.
