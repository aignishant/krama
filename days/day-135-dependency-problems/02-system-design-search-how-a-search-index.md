...
**After today you can:** You can explain an inverted index and why LIKE does not scale.

**The interviewer asks it as:** *How does full-text search work? Why not just use LIKE?*
