...
day: 135
track: lang-python
title: "A KV server and client in Python"
theme: "Mini project 9: a key-value store with a wire protocol"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 135 · Python — A KV server and client in Python

**Today's theme:** Mini project 9: a key-value store with a wire protocol

**After today you can:** You can design a small binary protocol and ship a server and client for it in all three.

**The interviewer asks it as:** *Design a protocol for a key-value store.*
