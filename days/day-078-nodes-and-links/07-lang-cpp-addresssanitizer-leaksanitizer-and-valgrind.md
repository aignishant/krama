...
day: 78
track: lang-cpp
title: "AddressSanitizer, LeakSanitizer, and valgrind"
theme: "Memory profiling and leaks"
phase: "Languages: performance and systems programming"
status: empty
---

# Day 078 · C++ — AddressSanitizer, LeakSanitizer, and valgrind

**Today's theme:** Memory profiling and leaks

**After today you can:** You can find what is holding memory in each language.

**The interviewer asks it as:** *Memory grows for an hour and then the process dies. Walk me through it.*
