...
**After today you can:** You can collapse a 2D table into one or two rows and say when that is safe.

**The interviewer asks it as:** *Your DP uses O(n*m) space. Can you reduce it?*
