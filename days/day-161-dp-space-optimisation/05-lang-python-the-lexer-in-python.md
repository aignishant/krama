...
day: 161
track: lang-python
title: "The lexer in Python"
theme: "Build F, day 1: a tiny language. The lexer"
phase: "Languages: six five-day builds"
status: empty
---

# Day 161 · Python — The lexer in Python

**Today's theme:** Build F, day 1: a tiny language. The lexer

**After today you can:** You can turn source text into tokens in each language.

**The interviewer asks it as:** *What does a lexer do?*
