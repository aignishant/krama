...
Prior DSA session: [day 81](../../day-081-minimum-spanning-cost/dsa/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 81](../../day-081-minimum-spanning-cost/dsa/README.md), [day 75](../../day-075-two-color-graph/dsa/README.md), [day 61](../../day-061-tree-diameter/dsa/README.md)
