# Day 082 — Capacity and cost

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Capacity and cost** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-82.
**Weekly theme:** Observability and operations.

## Assignment

Estimate monthly storage and compute units symbolically; separate measured inputs from guessed unit prices.
