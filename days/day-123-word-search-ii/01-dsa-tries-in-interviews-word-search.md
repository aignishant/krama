...
**After today you can:** You can combine a trie with backtracking and explain why that beats searching each word.

**The interviewer asks it as:** *Find all dictionary words in the letter grid.*
