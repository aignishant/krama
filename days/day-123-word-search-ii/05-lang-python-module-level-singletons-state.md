...
day: 123
track: lang-python
title: "Module-level singletons, state as enum plus match, command as callable"
theme: "Design patterns III: singleton, state, command"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 123 · Python — Module-level singletons, state as enum plus match, command as callable

**Today's theme:** Design patterns III: singleton, state, command

**After today you can:** You can implement the three most-asked behavioural patterns and say when a singleton is a mistake.

**The interviewer asks it as:** *Implement a singleton. Now tell me why you should not.*
