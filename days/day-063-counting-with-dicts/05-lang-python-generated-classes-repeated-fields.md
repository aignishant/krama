...
day: 63
track: lang-python
title: "Generated classes: repeated fields, map fields, and oneof in Python"
theme: "Messages: scalars, repeated, maps, nested, oneof"
phase: "Languages: Protocol Buffers and gRPC"
status: empty
---

# Day 063 · Python — Generated classes: repeated fields, map fields, and oneof in Python

**Today's theme:** Messages: scalars, repeated, maps, nested, oneof

**After today you can:** You can model an order with line items, an address, and a payment method that is one of three, in .proto.

**The interviewer asks it as:** *How do you express one-of-several in protobuf?*
