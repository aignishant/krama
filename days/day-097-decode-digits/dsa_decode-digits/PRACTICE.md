...
Return number of decodings of a nonempty digit string using 1..26; leading zeroes cannot form letters.
...
5. Run `python course.py practice 97` from the repository root. The starter is intentionally RED.
