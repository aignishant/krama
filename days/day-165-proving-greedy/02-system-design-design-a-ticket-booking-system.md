...
day: 165
track: system-design
title: "Design a ticket booking system at scale"
phase: "High-level design case studies"
status: empty
---

# Day 165 · System Design — Design a ticket booking system at scale

**After today you can:** You can handle a flash sale, seat locking, and a queue of a million users.

**The interviewer asks it as:** *Design ticket booking for a concert that sells out in ten seconds.*
...
*The mechanics, and the real products that do it this way.*
