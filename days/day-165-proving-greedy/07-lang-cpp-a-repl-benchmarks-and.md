...
day: 165
track: lang-cpp
title: "A REPL, benchmarks, and docs"
theme: "Build F, day 5: ship it"
phase: "Languages: six five-day builds"
status: empty
---

# Day 165 · C++ — A REPL, benchmarks, and docs

**Today's theme:** Build F, day 5: ship it

**After today you can:** You can ship an interpreter in three languages and compare their speed.

**The interviewer asks it as:** *Which of your three interpreters is fastest, and why?*
