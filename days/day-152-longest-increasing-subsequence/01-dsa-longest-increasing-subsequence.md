...
**After today you can:** You can write the O(n^2) version and then the O(n log n) one with binary search.

**The interviewer asks it as:** *Find the longest increasing subsequence. Can you do better than O(n^2)?*
