...
day: 152
track: lang-go
title: "The room hub with bidirectional streaming"
theme: "Build D, day 2: gRPC bidirectional streams"
phase: "Languages: six five-day builds"
status: empty
---

# Day 152 · Go — The room hub with bidirectional streaming

**Today's theme:** Build D, day 2: gRPC bidirectional streams

**After today you can:** You can hold thousands of open streams and fan a message out to a room.

**The interviewer asks it as:** *How do you push a message to everyone in a room?*
