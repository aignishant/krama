...
day: 107
track: lang-cpp
title: "RAII, scope guards, and destructors that never throw"
theme: "Cleanup: context managers, defer, RAII"
phase: "Languages: idiomatic depth and design"
status: empty
---

# Day 107 · C++ — RAII, scope guards, and destructors that never throw

**Today's theme:** Cleanup: context managers, defer, RAII

**After today you can:** You can guarantee a file closes or a lock releases on every path, in each language.

**The interviewer asks it as:** *How do you make sure a resource is released even if the code throws?*
