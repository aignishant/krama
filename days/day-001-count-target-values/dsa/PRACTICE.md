...
Return how many elements equal target. Do not mutate nums.
...
5. Run `python course.py practice 1` from the repository root. The starter is intentionally RED.
