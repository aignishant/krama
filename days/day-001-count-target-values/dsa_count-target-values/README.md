...
**Budget:** 60 minutes. **Outcome:** DSA-01. **Theme:** Cost, invariants and arrays.

## Prerequisite and recall

Comfort writing and running Python functions; DSA knowledge is diagnosed here.
Recall one candidate, not all of them: No earlier session; state your baseline confidence.
