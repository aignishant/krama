# Day 091 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/non-overlapping-intervals/)

**Difficulty:** Medium. **Original course day:** 85.

**Contract comparison:** Online asks how many intervals to remove; local practice asks how many to keep.

Official page checked on 2026-09-18; premium statements were not accessible.

## 621. Task Scheduler

[Open the official problem](https://leetcode.com/problems/task-scheduler/)

**Difficulty:** Medium. **Original course day:** 89.
