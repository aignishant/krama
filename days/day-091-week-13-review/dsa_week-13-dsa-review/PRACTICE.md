...
First re-solve [day 85](../../day-085-maximum-compatible-meetings/dsa_maximum-compatible-meetings/README.md), then the core below from
[day 89](../../day-089-task-cooldown-length/dsa_task-cooldown-length/README.md), both from blank code. A harder unresolved problem
