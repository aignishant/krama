# Day 067 — Property checks

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Property checks** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-67.
**Weekly theme:** Testing and debugging.

## Assignment

Use seeded random small inputs to compare an optimized solution with a deliberately simple oracle.
