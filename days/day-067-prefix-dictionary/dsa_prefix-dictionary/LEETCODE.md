# Day 067 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/implement-trie-prefix-tree/)

**Difficulty:** Medium. **Original course day:** 67.

**Contract comparison:** Online tests trie insert/search/prefix operations; local practice counts distinct words sharing a prefix.
