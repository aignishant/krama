# Day 139 — Replay and rebuild

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Replay and rebuild** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-139.
**Weekly theme:** Analytics and stream processing.

## Assignment

Specify immutable input retention, versioned transforms and rebuilding a corrupted aggregate safely.
