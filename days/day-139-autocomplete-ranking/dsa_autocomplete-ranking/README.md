# Day 139 DSA — Autocomplete ranking

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Autocomplete ranking** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-139. **Theme:** Data structure design and tradeoffs.

## Prerequisite and recall

Prior DSA session: [day 138](../../day-138-expiring-counter/dsa_expiring-counter/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 138](../../day-138-expiring-counter/dsa_expiring-counter/README.md), [day 132](../../day-132-bipartite-matching/dsa_bipartite-matching/README.md), [day 118](../../day-118-mutable-range-minima/dsa_mutable-range-minima/README.md)
...
**Autocomplete ranking.** Given unique [word,count] entries and prefix return at most k matches by descending count then lexicographic word; k >= 0.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Explain scan baseline and trie/top-k extension.
