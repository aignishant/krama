# Day 139 — Error taxonomy

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Error taxonomy** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-139.
**Weekly theme:** Production Python service code.

## Assignment

Map validation, transient dependency and internal errors to distinct domain exceptions without leaking low-level details.
