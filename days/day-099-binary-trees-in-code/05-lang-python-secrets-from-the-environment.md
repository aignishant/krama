...
day: 99
track: lang-python
title: "Secrets from the environment, a vault client, and a flag store"
theme: "Config, secrets, and feature flags"
phase: "Languages: messaging, resilience, and deployment"
status: empty
---

# Day 099 · Python — Secrets from the environment, a vault client, and a flag store

**Today's theme:** Config, secrets, and feature flags

**After today you can:** You can ship a feature dark and turn it on for 1% of users, in each language.

**The interviewer asks it as:** *How do you roll out a risky change safely?*
