# Day 134 — Analytics requirements

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Analytics requirements** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-134.
**Weekly theme:** Analytics and stream processing.

## Assignment

Define event volume, freshness, exactness and top-k dashboard queries.
