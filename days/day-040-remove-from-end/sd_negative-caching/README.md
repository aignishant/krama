...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Negative caching** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-40.
**Weekly theme:** Caching and content delivery.

## Assignment

Cache absent links briefly; define how newly created links avoid being hidden too long.
