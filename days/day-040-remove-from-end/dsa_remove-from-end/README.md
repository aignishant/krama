# Day 040 DSA — Remove from end

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Remove from end** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-40. **Theme:** Linked lists and pointer invariants.

## Prerequisite and recall

Prior DSA session: [day 39](../../day-039-merge-linked-lists/dsa_merge-linked-lists/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 39](../../day-039-merge-linked-lists/dsa_merge-linked-lists/README.md), [day 33](../../day-033-kth-smallest/dsa_kth-smallest/README.md), [day 19](../../day-019-longest-distinct-substring/dsa_longest-distinct-substring/README.md)
...
**Remove from end.** Build a linked list and remove its nth node from the end; 1 <= n <= length. Return serialized values.
