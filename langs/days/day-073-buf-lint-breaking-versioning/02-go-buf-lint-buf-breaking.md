...
day: 73
track: go
title: "buf lint, buf breaking, module publishing, and package versioning"
theme: "Schema hygiene: lint, breaking checks, versioning"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 073 · Go — buf lint, buf breaking, module publishing, and package versioning

**Today's theme:** Schema hygiene: lint, breaking checks, versioning

**After today you can:** You can enforce style and compatibility in CI and version an API like a professional team.

**The interviewer asks it as:** *How do you stop a teammate from shipping a breaking schema change?*
