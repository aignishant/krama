...
day: 62
track: go
title: "protoc-gen-go, buf generate, and the generated .pb.go"
theme: "protoc, buf, and code generation"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 062 · Go — protoc-gen-go, buf generate, and the generated .pb.go

**Today's theme:** protoc, buf, and code generation

**After today you can:** You can turn one .proto file into working code in all three languages with one command.

**The interviewer asks it as:** *What does the protobuf compiler generate, and why do you never edit it?*
