...
day: 67
track: go
title: "service in .proto, protoc-gen-go-grpc, and a Go server"
theme: "gRPC I: a unary server in Go"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 067 · Go — service in .proto, protoc-gen-go-grpc, and a Go server

**Today's theme:** gRPC I: a unary server in Go

**After today you can:** You can define a service in .proto and serve one RPC from Go, with Python and C++ servers as comparison.

**The interviewer asks it as:** *What is gRPC, and how is it different from REST?*
