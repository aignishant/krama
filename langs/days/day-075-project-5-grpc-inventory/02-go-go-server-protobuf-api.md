...
day: 75
track: go
title: "Go server: protobuf API, Postgres, streaming stock updates"
theme: "Mini project 5: an inventory service over gRPC"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 075 · Go — Go server: protobuf API, Postgres, streaming stock updates

**Today's theme:** Mini project 5: an inventory service over gRPC

**After today you can:** You can ship a Go gRPC service with schema, migrations, tests, and clients in the other two languages.

**The interviewer asks it as:** *Design a service API with protobuf. Now defend the field choices.*
