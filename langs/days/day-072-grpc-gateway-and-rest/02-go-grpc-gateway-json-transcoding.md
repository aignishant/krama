...
day: 72
track: go
title: "grpc-gateway: JSON transcoding, and when to expose both"
theme: "gRPC and REST together"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 072 · Go — grpc-gateway: JSON transcoding, and when to expose both

**Today's theme:** gRPC and REST together

**After today you can:** You can expose one Go service as both gRPC and REST and say when to do that.

**The interviewer asks it as:** *Your mobile app cannot speak gRPC. What do you do?*
