...
day: 66
track: python
title: "Python protobuf API: SerializeToString, ParseFromString, MessageToJson"
theme: "The Go protobuf API"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 066 · Python — Python protobuf API: SerializeToString, ParseFromString, MessageToJson

**Today's theme:** The Go protobuf API

**After today you can:** You can marshal, unmarshal, compare, and print messages, and say what the Go API does differently.

**The interviewer asks it as:** *How do you convert a protobuf message to JSON, and what gets lost?*
