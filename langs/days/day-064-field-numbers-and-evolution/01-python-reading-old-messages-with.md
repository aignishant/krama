...
day: 64
track: python
title: "Reading old messages with a new schema in Python"
theme: "Field numbers, defaults, and schema evolution"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 064 · Python — Reading old messages with a new schema in Python

**Today's theme:** Field numbers, defaults, and schema evolution

**After today you can:** You can change a schema without breaking old clients, and name the four changes that will break them.

**The interviewer asks it as:** *Can you rename a field in protobuf? Can you change its type?*
