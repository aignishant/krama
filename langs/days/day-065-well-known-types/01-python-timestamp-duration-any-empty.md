...
day: 65
track: python
title: "Timestamp, Duration, Any, Empty, and wrappers from Python"
theme: "Well-known types"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 065 · Python — Timestamp, Duration, Any, Empty, and wrappers from Python

**Today's theme:** Well-known types

**After today you can:** You can represent time, absence, and a payload of unknown type in a message, in each language.

**The interviewer asks it as:** *How do you represent a time in protobuf?*
