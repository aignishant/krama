...
day: 71
track: go
title: "Unary and stream interceptors, per-RPC credentials, TLS"
theme: "gRPC V: interceptors, auth, TLS"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 071 · Go — Unary and stream interceptors, per-RPC credentials, TLS

**Today's theme:** gRPC V: interceptors, auth, TLS

**After today you can:** You can add logging and token auth to every RPC, and secure the connection, in each language.

**The interviewer asks it as:** *How do you authenticate a gRPC call?*
