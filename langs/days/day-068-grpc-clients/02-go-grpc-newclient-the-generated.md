...
day: 68
track: go
title: "grpc.NewClient, the generated client, and connection lifecycle"
theme: "gRPC II: clients in three languages"
phase: "Protocol Buffers and gRPC"
status: empty
---

# Day 068 · Go — grpc.NewClient, the generated client, and connection lifecycle

**Today's theme:** gRPC II: clients in three languages

**After today you can:** You can call the Go server from a Python client and a C++ client.

**The interviewer asks it as:** *How does a gRPC client find and talk to the server?*
