...
5. Run `python course.py practice 39` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n+m) time; O(1) merge workspace**.
