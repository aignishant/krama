# Day 088 — Cancellation

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Cancellation** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-88.
**Weekly theme:** Async fundamentals.

## Assignment

Cancel a task waiting on an event and ensure finally cleanup runs; propagate cancellation.
