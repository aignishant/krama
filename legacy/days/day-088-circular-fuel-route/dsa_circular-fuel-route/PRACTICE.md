...
Return smallest valid start index completing the circuit, or -1. gas and cost have equal positive length and nonnegative values.
...
5. Run `python course.py practice 88` from the repository root. The starter is intentionally RED.
