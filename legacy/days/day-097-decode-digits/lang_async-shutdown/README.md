# Day 097 — Async shutdown

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Async shutdown** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-97.
**Weekly theme:** Async reliability.

## Assignment

Stop intake, finish or cancel workers, and verify no owned tasks remain pending.
