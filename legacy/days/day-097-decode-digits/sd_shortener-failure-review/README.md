# Day 097 — Shortener failure review

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Shortener failure review** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-97.
**Weekly theme:** URL shortener case study.

## Assignment

Walk through cache loss, replica lag and database failover; record three weaknesses and one revised diagram.
