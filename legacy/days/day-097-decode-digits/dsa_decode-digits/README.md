# Day 097 DSA — Decode digits

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Decode digits** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-97. **Theme:** Dynamic programming foundations.

## Prerequisite and recall

Prior DSA session: [day 96](../../day-096-increasing-subsequence/dsa_increasing-subsequence/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 96](../../day-096-increasing-subsequence/dsa_increasing-subsequence/README.md), [day 90](../../day-090-optimal-merge-cost/dsa_optimal-merge-cost/README.md), [day 76](../../day-076-multi-source-spread/dsa_multi-source-spread/README.md)
...
**Decode digits.** Return number of decodings of a nonempty digit string using 1..26; leading zeroes cannot form letters.
