# Day 150 — Mutable ownership review

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Mutable ownership review** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-150.
**Weekly theme:** Code review and refactoring.

## Assignment

Audit a function returning internal collections and decide between copying, views and documented mutation.
