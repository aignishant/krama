# Day 150 — Dependency inversion

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Dependency inversion** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-150.
**Weekly theme:** Low-level design and maintainability.

## Assignment

Design a notification sender that tests without network access using an injected transport.
