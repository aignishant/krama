...
7. **Recall later without practice:** read [this day's card](../../../docs/SD_RECALL.md#day-015-domain-model) for a previously studied topic; reading is not completion.

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-15.
**Weekly theme:** Service boundaries and API design.

## Assignment

Name link, owner and click-event entities and sketch their keys and relationships.
