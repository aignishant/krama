# Day 051 DSA — Enumerate permutations

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Enumerate permutations** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-51. **Theme:** Recursion and backtracking.

## Prerequisite and recall

Prior DSA session: [day 50](../../day-050-enumerate-subsets/dsa_enumerate-subsets/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 50](../../day-050-enumerate-subsets/dsa_enumerate-subsets/README.md), [day 44](../../day-044-queue-from-stacks/dsa_queue-from-stacks/README.md), [day 30](../../day-030-merge-overlapping-intervals/dsa_merge-overlapping-intervals/README.md)
...
**Enumerate permutations.** Return all permutations of distinct nums in lexicographic order.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n*n!) including output.
