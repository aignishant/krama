# Day 051 — Read-your-writes

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Read-your-writes** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-51.
**Weekly theme:** Replication and consistency.

## Assignment

Show a user creating a link then reading a lagging replica; design session routing or a version fence.
