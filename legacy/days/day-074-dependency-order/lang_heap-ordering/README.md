# Day 074 — Heap ordering

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Heap ordering** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-74.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Store priority, tie-breaker and payload tuples in heapq so equal priorities do not compare arbitrary objects.
