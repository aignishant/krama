# Day 074 — Distributed locks

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Distributed locks** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-74.
**Weekly theme:** Distributed coordination.

## Assignment

Show a paused worker resuming after its lease expires; explain why a lock alone cannot prevent stale writes.
