# Day 074 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/course-schedule-ii/)

**Difficulty:** Medium. **Original course day:** 74.

**Contract comparison:** Online permits any valid topological order; local practice requires lexicographically smallest order.
