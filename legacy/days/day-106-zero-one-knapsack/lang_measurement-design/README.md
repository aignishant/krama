# Day 106 — Measurement design

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Measurement design** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-106.
**Weekly theme:** Profiling and memory.

## Assignment

Use timeit for two equivalent small functions with repeated measurements and recorded interpreter version.
