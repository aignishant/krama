# Day 149 — Hidden state

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Hidden state** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-149.
**Weekly theme:** Code review and refactoring.

## Assignment

Remove one module-global mutable dependency by passing it explicitly.
