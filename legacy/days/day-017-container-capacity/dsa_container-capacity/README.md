# Day 017 DSA — Container capacity
...
7. **Recall later without practice:** read the [DSA summary file](../../../docs/DSA_RECALL.md#day-017-container-capacity) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.
...
**Budget:** 60 minutes. **Outcome:** DSA-17. **Theme:** Two pointers and sliding windows.

## Prerequisite and recall

Prior DSA session: [day 16](../../day-016-unique-triples/dsa_unique-triples/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 16](../../day-016-unique-triples/dsa_unique-triples/README.md), [day 10](../../day-010-pair-sum-indices/dsa_pair-sum-indices/README.md)
...
**Container capacity.** For nonnegative heights return max min(h[i],h[j])*(j-i), or 0 if fewer than two heights.
