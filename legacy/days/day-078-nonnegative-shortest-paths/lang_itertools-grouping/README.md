# Day 078 — Itertools grouping

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Itertools grouping** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-78.
**Weekly theme:** Functional tools and caching.

## Assignment

Show groupby groups adjacent keys and compare behavior before and after sorting.
