# Day 078 — SLIs and SLOs

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **SLIs and SLOs** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-78.
**Weekly theme:** Observability and operations.

## Assignment

Define good/total redirect requests and a latency histogram; distinguish user-visible success from process uptime.
