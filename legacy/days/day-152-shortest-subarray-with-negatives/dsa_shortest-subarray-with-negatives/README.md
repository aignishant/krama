# Day 152 DSA — Shortest subarray with negatives

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Shortest subarray with negatives** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-152. **Theme:** Mixed pattern selection II.

## Prerequisite and recall

Prior DSA session: [day 151](../../day-151-smallest-missing-positive/dsa_smallest-missing-positive/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 151](../../day-151-smallest-missing-positive/dsa_smallest-missing-positive/README.md), [day 145](../../day-145-rotated-minimum-with-duplicates/dsa_rotated-minimum-with-duplicates/README.md), [day 131](../../day-131-tree-distance-sums/dsa_tree-distance-sums/README.md)
...
**Shortest subarray with negatives.** Return shortest nonempty subarray length with sum >= k, or -1; k > 0 and nums may be negative.
