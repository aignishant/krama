# Day 152 — Extensibility

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Extensibility** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-152.
**Weekly theme:** Low-level design and maintainability.

## Assignment

Add a second pricing policy to a hypothetical parking service; compare composition and inheritance.
