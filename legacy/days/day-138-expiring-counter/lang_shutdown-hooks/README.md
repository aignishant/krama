# Day 138 — Shutdown hooks

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Shutdown hooks** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-138.
**Weekly theme:** Production Python service code.

## Assignment

Design explicit start/stop methods and a context-managed lifecycle for a worker object.
