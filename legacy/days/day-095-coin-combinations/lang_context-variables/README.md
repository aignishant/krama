# Day 095 — Context variables

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Context variables** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-95.
**Weekly theme:** Async reliability.

## Assignment

Keep per-task request identifiers using contextvars and verify isolation across concurrent tasks.
