# Day 095 — Shortener architecture

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Shortener architecture** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-95.
**Weekly theme:** URL shortener case study.

## Assignment

Draw load balancer, stateless workers, cache and durable store with read/write arrows.
