# Day 085 — Coroutine lifecycle

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Coroutine lifecycle** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-85.
**Weekly theme:** Async fundamentals.

## Assignment

Distinguish coroutine object creation from awaiting and task scheduling with a local trace.
