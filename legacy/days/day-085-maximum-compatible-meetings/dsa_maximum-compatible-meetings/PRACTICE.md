# Practice — Maximum compatible meetings
...
Return max number of nonoverlapping positive-length half-open intervals.
...
5. Run `python course.py practice 85` from the repository root. The starter is intentionally RED.
