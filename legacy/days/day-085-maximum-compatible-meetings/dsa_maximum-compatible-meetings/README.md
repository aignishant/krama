# Day 085 DSA — Maximum compatible meetings

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Maximum compatible meetings** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-85. **Theme:** Greedy choices and exchange arguments.

## Prerequisite and recall

Prior DSA session: [day 84](../../day-084-week-12-review/dsa_week-12-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 84](../../day-084-week-12-review/dsa_week-12-dsa-review/README.md), [day 78](../../day-078-nonnegative-shortest-paths/dsa_nonnegative-shortest-paths/README.md), [day 64](../../day-064-k-largest-stream-values/dsa_k-largest-stream-values/README.md)
...
**Maximum compatible meetings.** Return max number of nonoverlapping positive-length half-open intervals.
