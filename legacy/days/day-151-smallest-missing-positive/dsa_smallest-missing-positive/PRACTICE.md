# Practice — Smallest missing positive
...
Return smallest missing positive integer. You may mutate nums.
...
5. Run `python course.py practice 151` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n) time; O(1) extra space**.
