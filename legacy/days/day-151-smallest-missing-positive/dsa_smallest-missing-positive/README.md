# Day 151 DSA — Smallest missing positive

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Smallest missing positive** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-151. **Theme:** Mixed pattern selection II.

## Prerequisite and recall

Prior DSA session: [day 150](../../day-150-maximum-path-sum/dsa_maximum-path-sum/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 150](../../day-150-maximum-path-sum/dsa_maximum-path-sum/README.md), [day 144](../../day-144-top-frequent-words/dsa_top-frequent-words/README.md), [day 130](../../day-130-subtree-sizes/dsa_subtree-sizes/README.md)
...
**Smallest missing positive.** Return smallest missing positive integer. You may mutate nums.
