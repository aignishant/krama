# Day 151 — Concurrency contracts

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Concurrency contracts** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-151.
**Weekly theme:** Low-level design and maintainability.

## Assignment

Specify ownership and synchronization for a shared cache; identify the atomic operations.
