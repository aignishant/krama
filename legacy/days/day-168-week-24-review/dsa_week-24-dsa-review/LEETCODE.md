# Day 168 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/design-graph-with-shortest-path-calculator/)

**Difficulty:** Hard. **Original course day:** 162.

**Contract comparison:** Online supports adding edges between queries; local practice has a static graph and can cache distances per source.

Official page checked on 2026-09-18; premium statements were not accessible.

## 53. Maximum Subarray

[Open the official problem](https://leetcode.com/problems/maximum-subarray/)

**Difficulty:** Medium. **Original course day:** 166.
