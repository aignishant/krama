# Day 089 — Tenant isolation

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tenant isolation** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-89.
**Weekly theme:** Security and tenancy.

## Assignment

Compare shared rows, schemas and databases for tenants; show how a missing tenant filter is detected.
