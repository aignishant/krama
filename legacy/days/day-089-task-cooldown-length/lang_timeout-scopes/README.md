# Day 089 — Timeout scopes

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Timeout scopes** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-89.
**Weekly theme:** Async fundamentals.

## Assignment

Use asyncio.timeout around a bounded local operation and inspect the resulting exception boundary.
