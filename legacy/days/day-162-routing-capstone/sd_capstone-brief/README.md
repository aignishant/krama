# Day 162 — Capstone brief

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone brief** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-162.
**Weekly theme:** Final design portfolio.

## Assignment

Choose one service from the portfolio and freeze a one-page requirements and capacity brief.
