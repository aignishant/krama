# Day 162 DSA — Routing capstone

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Routing capstone** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-162. **Theme:** Capstone and retention.

## Prerequisite and recall

Prior DSA session: [day 161](../../day-161-week-23-review/dsa_week-23-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 161](../../day-161-week-23-review/dsa_week-23-dsa-review/README.md), [day 155](../../day-155-mock-arrays/dsa_mock-arrays/README.md), [day 141](../../day-141-product-except-self/dsa_product-except-self/README.md)
...
**Routing capstone.** Directed nonnegative edges and multiple [src,dst] queries: return shortest distances, -1 for unreachable. Cache work per distinct source.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Explain preprocessing versus per-query cost.
