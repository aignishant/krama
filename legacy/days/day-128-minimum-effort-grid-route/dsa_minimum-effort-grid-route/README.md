...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Minimum effort grid route** is not yet expanded.
...
Prior DSA session: [day 127](../../day-127-longest-dag-path/dsa_longest-dag-path/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 127](../../day-127-longest-dag-path/dsa_longest-dag-path/README.md), [day 121](../../day-121-prefix-border-lengths/dsa_prefix-border-lengths/README.md), [day 107](../../day-107-equal-partition/dsa_equal-partition/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(RC log(RC)) time.
