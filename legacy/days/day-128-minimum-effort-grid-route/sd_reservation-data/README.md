# Day 128 — Reservation data

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Reservation data** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-128.
**Weekly theme:** Payments and reservations case study.

## Assignment

Model inventory, holds, expiration and reservation states with valid transitions.
