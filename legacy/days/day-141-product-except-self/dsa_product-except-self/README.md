# Day 141 DSA — Product except self

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Product except self** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-141. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 140](../../day-140-week-20-review/dsa_week-20-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 140](../../day-140-week-20-review/dsa_week-20-dsa-review/README.md), [day 134](../../day-134-time-indexed-values/dsa_time-indexed-values/README.md), [day 120](../../day-120-normalize-text-units/dsa_normalize-text-units/README.md)
...
**Product except self.** Return product of all other values for each position; no division; empty returns [].

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(1) auxiliary excluding output.
