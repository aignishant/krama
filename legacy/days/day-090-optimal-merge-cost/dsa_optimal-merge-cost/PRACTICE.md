...
Repeatedly merge any two nonnegative file sizes, paying their sum. Return minimum total cost.
...
5. Run `python course.py practice 90` from the repository root. The starter is intentionally RED.
