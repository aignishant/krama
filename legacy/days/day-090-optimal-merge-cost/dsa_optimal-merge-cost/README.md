# Day 090 DSA — Optimal merge cost

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Optimal merge cost** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-90. **Theme:** Greedy choices and exchange arguments.

## Prerequisite and recall

Prior DSA session: [day 89](../../day-089-task-cooldown-length/dsa_task-cooldown-length/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 89](../../day-089-task-cooldown-length/dsa_task-cooldown-length/README.md), [day 83](../../day-083-critical-edges/dsa_critical-edges/README.md), [day 69](../../day-069-tree-codec-round-trip/dsa_tree-codec-round-trip/README.md)
...
**Optimal merge cost.** Repeatedly merge any two nonnegative file sizes, paying their sum. Return minimum total cost.
