# Day 082 DSA — Strong components

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Strong components** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-82. **Theme:** Weighted graphs and connectivity.

## Prerequisite and recall

Prior DSA session: [day 81](../../day-081-minimum-spanning-cost/dsa_minimum-spanning-cost/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 81](../../day-081-minimum-spanning-cost/dsa_minimum-spanning-cost/README.md), [day 75](../../day-075-two-color-graph/dsa_two-color-graph/README.md), [day 61](../../day-061-tree-diameter/dsa_tree-diameter/README.md)
...
**Strong components.** For directed graph return strongly connected vertex groups, each sorted, with groups lexicographically sorted.
