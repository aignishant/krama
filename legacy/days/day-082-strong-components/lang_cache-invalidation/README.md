# Day 082 — Cache invalidation

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Cache invalidation** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-82.
**Weekly theme:** Functional tools and caching.

## Assignment

Create a cached function reading mutable external state, reproduce staleness and add an explicit invalidation policy.
