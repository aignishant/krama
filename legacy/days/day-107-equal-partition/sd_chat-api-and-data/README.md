# Day 107 — Chat API and data

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Chat API and data** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-107.
**Weekly theme:** Chat case study.

## Assignment

Specify message IDs, conversation sequence and acknowledgment fields.
