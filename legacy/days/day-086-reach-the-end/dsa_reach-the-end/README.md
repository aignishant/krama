# Day 086 DSA — Reach the end

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Reach the end** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-86. **Theme:** Greedy choices and exchange arguments.

## Prerequisite and recall

Prior DSA session: [day 85](../../day-085-maximum-compatible-meetings/dsa_maximum-compatible-meetings/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 85](../../day-085-maximum-compatible-meetings/dsa_maximum-compatible-meetings/README.md), [day 79](../../day-079-negative-edge-paths/dsa_negative-edge-paths/README.md), [day 65](../../day-065-merge-sorted-streams/dsa_merge-sorted-streams/README.md)
...
**Reach the end.** Nonnegative nums[i] is maximum forward jump. Return whether last index is reachable; empty returns false.
