# Day 086 — Authentication and authorization

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Authentication and authorization** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-86.
**Weekly theme:** Security and tenancy.

## Assignment

Separate proving identity from checking ownership when editing a link; show an object-level access test.
