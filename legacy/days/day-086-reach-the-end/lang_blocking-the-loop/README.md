# Day 086 — Blocking the loop

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Blocking the loop** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-86.
**Weekly theme:** Async fundamentals.

## Assignment

Compare a cooperative sleep with a blocking call in an isolated demo; explain the observed scheduling.
