# Day 142 — Object sizes

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Object sizes** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-142.
**Weekly theme:** Internals and version-aware Python.

## Assignment

Compare sys.getsizeof with retained graph size; demonstrate why shallow size omits referents.
