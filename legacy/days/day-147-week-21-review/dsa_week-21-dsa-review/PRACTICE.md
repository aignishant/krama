# Practice — Cold re-solve: Rotated minimum with duplicates
...
First re-solve [day 141](../../day-141-product-except-self/dsa_product-except-self/README.md), then the core below from
[day 145](../../day-145-rotated-minimum-with-duplicates/dsa_rotated-minimum-with-duplicates/README.md), both from blank code. A harder unresolved problem
...
Return minimum in a nonempty rotated sorted array allowing duplicates.
...
5. Run `python course.py practice 147` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(log n) typical; O(n) worst case**.
