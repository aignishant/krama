# Day 147 DSA — Week 21 DSA review
...
Original reading, after cold recall: [Day 141](../../day-141-product-except-self/dsa_product-except-self/README.md) · [Day 142](../../day-142-longest-consecutive-run/dsa_longest-consecutive-run/README.md) · [Day 143](../../day-143-trapped-rainwater/dsa_trapped-rainwater/README.md) · [Day 144](../../day-144-top-frequent-words/dsa_top-frequent-words/README.md) · [Day 145](../../day-145-rotated-minimum-with-duplicates/dsa_rotated-minimum-with-duplicates/README.md) · [Day 146](../../day-146-find-duplicate-without-mutation/dsa_find-duplicate-without-mutation/README.md).
...
**Budget:** 60 minutes. **Outcome:** DSA-147. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 146](../../day-146-find-duplicate-without-mutation/dsa_find-duplicate-without-mutation/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 146](../../day-146-find-duplicate-without-mutation/dsa_find-duplicate-without-mutation/README.md), [day 140](../../day-140-week-20-review/dsa_week-20-dsa-review/README.md), [day 126](../../day-126-week-18-review/dsa_week-18-dsa-review/README.md)
...
**Cold re-solve: Rotated minimum with duplicates.** Return minimum in a nonempty rotated sorted array allowing duplicates.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) typical; O(n) worst case.
This is a target to justify, not a claim that any implementation meets it.

## Learn and explain

Read [week 21 in the DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md) for this week's mechanism before the first attempt.
...
Use the lecture notes matching **Mixed pattern selection I** for additional teaching; reading the whole
