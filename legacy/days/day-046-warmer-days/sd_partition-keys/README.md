# Day 046 — Partition keys

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Partition keys** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-46.
**Weekly theme:** Load balancing and partitioning.

## Assignment

Choose a shard key for links; show a read lookup, a range query and a hotspot.
