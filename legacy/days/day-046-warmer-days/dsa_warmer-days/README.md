# Day 046 DSA — Warmer days

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Warmer days** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-46. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 45](../../day-045-minimum-stack/dsa_minimum-stack/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 45](../../day-045-minimum-stack/dsa_minimum-stack/README.md), [day 39](../../day-039-merge-linked-lists/dsa_merge-linked-lists/README.md), [day 25](../../day-025-integer-square-root/dsa_integer-square-root/README.md)
...
**Warmer days.** For each temperature return days until a strictly warmer temperature, or 0.
