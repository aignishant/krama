# Day 080 — Bounded iteration

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Bounded iteration** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-80.
**Weekly theme:** Functional tools and caching.

## Assignment

Use islice and batched where available in the pinned interpreter; test a final short batch.
