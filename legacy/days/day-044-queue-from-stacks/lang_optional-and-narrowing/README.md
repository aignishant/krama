# Day 044 — Optional and narrowing

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Optional and narrowing** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-44.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Write a function accepting str or None with a clear narrowing branch and no unchecked dereference.
