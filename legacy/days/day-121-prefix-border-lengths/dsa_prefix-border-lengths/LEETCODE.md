# Day 121 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/longest-happy-prefix/)

**Difficulty:** Hard. **Original course day:** 121.

**Contract comparison:** Online returns the final longest border string; local practice returns every prefix-function length.
