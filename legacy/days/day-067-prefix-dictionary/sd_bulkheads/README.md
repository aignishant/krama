...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Bulkheads** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-67.
**Weekly theme:** Reliability patterns.

## Assignment

Allocate separate worker/connection pools to redirects and analytics so analytics cannot exhaust redirects.
