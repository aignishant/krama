...
Return maximum sum of nonadjacent nonnegative values; empty returns 0.
...
5. Run `python course.py practice 93` from the repository root. The starter is intentionally RED.
