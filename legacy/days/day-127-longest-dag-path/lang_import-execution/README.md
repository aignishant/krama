# Day 127 — Import execution

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Import execution** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-127.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Use two tiny temporary modules to show import-time execution and module caching.
