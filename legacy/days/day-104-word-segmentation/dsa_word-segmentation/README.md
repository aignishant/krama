# Day 104 DSA — Word segmentation

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Word segmentation** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-104. **Theme:** Dynamic programming on grids and strings.

## Prerequisite and recall

Prior DSA session: [day 103](../../day-103-longest-palindrome-length/dsa_longest-palindrome-length/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 103](../../day-103-longest-palindrome-length/dsa_longest-palindrome-length/README.md), [day 97](../../day-097-decode-digits/dsa_decode-digits/README.md), [day 83](../../day-083-critical-edges/dsa_critical-edges/README.md)
...
**Word segmentation.** Return whether text can be segmented into one or more dictionary words; empty text is true; words nonempty.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Give a bound that includes substring creation.
