...
Return whether text can be segmented into one or more dictionary words; empty text is true; words nonempty.
...
5. Run `python course.py practice 104` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Give a bound that includes substring creation**.
