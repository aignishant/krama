# Day 108 DSA — Signed target count

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Signed target count** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-108. **Theme:** Knapsack and advanced DP states.

## Prerequisite and recall

Prior DSA session: [day 107](../../day-107-equal-partition/dsa_equal-partition/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 107](../../day-107-equal-partition/dsa_equal-partition/README.md), [day 101](../../day-101-common-subsequence-length/dsa_common-subsequence-length/README.md), [day 87](../../day-087-minimum-jumps/dsa_minimum-jumps/README.md)
...
**Signed target count.** Assign + or - to every nonnegative number and return ways to produce target. Zero choices count separately.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n*reachable_sum_range) time.
