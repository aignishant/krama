# Day 108 — Allocation tracing

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Allocation tracing** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-108.
**Weekly theme:** Profiling and memory.

## Assignment

Use tracemalloc snapshots around retained objects and identify an allocation site.
