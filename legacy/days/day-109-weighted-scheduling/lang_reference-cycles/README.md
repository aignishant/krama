# Day 109 — Reference cycles

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Reference cycles** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-109.
**Weekly theme:** Profiling and memory.

## Assignment

Create a cycle, inspect gc behavior and explain why prompt destruction is not portable semantics.
