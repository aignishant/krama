# Day 109 — Chat architecture

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Chat architecture** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-109.
**Weekly theme:** Chat case study.

## Assignment

Draw gateways, routing registry, message store and offline delivery path.
