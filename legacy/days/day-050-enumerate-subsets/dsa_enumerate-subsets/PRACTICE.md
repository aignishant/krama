...
Return all subsets of distinct nums; sort each subset and sort the final list lexicographically.
...
5. Run `python course.py practice 50` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n*2^n) including copied output**.
