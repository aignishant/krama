# Day 050 DSA — Enumerate subsets

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Enumerate subsets** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-50. **Theme:** Recursion and backtracking.

## Prerequisite and recall

Prior DSA session: [day 49](../../day-049-week-7-review/dsa_week-7-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 49](../../day-049-week-7-review/dsa_week-7-dsa-review/README.md), [day 43](../../day-043-balanced-delimiters/dsa_balanced-delimiters/README.md), [day 29](../../day-029-stable-record-sorting/dsa_stable-record-sorting/README.md)
...
**Enumerate subsets.** Return all subsets of distinct nums; sort each subset and sort the final list lexicographically.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n*2^n) including copied output.
