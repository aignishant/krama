# Day 087 — Abuse prevention

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Abuse prevention** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-87.
**Weekly theme:** Security and tenancy.

## Assignment

Design limits for anonymous link creation and suspicious redirects without treating IP as a perfect identity.
