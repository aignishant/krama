# Practice — Cold re-solve: Increasing subsequence
...
First re-solve [day 92](../../day-092-climbing-steps/dsa_climbing-steps/README.md), then the core below from
[day 96](../../day-096-increasing-subsequence/dsa_increasing-subsequence/README.md), both from blank code. A harder unresolved problem
...
Return length of longest strictly increasing subsequence. Implement quadratic DP before the faster extension.
...
5. Run `python course.py practice 98` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n^2) core; O(n log n) optional**.
