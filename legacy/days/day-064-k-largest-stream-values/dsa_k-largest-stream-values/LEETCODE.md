# Day 064 — LeetCode interview practice
...
**Difficulty:** Medium. **Original course day:** 64.

**Contract comparison:** Online returns one kth-largest value; local practice returns the entire top-k set in descending order.
