# Day 064 DSA — K largest stream values

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **K largest stream values** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-64. **Theme:** Heaps, tries and tree construction.

## Prerequisite and recall

Prior DSA session: [day 63](../../day-063-week-9-review/dsa_week-9-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 63](../../day-063-week-9-review/dsa_week-9-dsa-review/README.md), [day 57](../../day-057-tree-depth/dsa_tree-depth/README.md), [day 43](../../day-043-balanced-delimiters/dsa_balanced-delimiters/README.md)
...
**K largest stream values.** Return the k largest values of nums sorted descending; 0 <= k <= n.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n log(k+1)) plus output sorting.
