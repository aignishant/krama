# Practice — Cold re-solve: Largest histogram rectangle
...
First re-solve [day 43](../../day-043-balanced-delimiters/dsa_balanced-delimiters/README.md), then the core below from
[day 47](../../day-047-largest-histogram-rectangle/dsa_largest-histogram-rectangle/README.md), both from blank code. A harder unresolved problem
...
Return the largest rectangle area in nonnegative bar heights of unit width.
...
5. Run `python course.py practice 49` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **O(n) time; O(n) space**.
