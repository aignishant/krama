# Day 166 — Capstone profile

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone profile** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-166.
**Weekly theme:** Python capstone and retention.

## Assignment

Measure one representative workload and document the main cost without premature optimization.
