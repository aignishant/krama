# Day 166 — Capstone tradeoffs

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone tradeoffs** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-166.
**Weekly theme:** Final design portfolio.

## Assignment

Write a decision record with two rejected alternatives and measurable triggers to revisit the choice.
