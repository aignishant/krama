...
1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Ordering** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-60.
**Weekly theme:** Queues and event processing.

## Assignment

Choose partition keys for per-link order; show why global ordering would constrain throughput.
