# Day 060 DSA — Kth tree value

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Kth tree value** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-60. **Theme:** Binary trees and search trees.

## Prerequisite and recall

Prior DSA session: [day 59](../../day-059-validate-search-tree/dsa_validate-search-tree/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 59](../../day-059-validate-search-tree/dsa_validate-search-tree/README.md), [day 53](../../day-053-balanced-parentheses/dsa_balanced-parentheses/README.md), [day 39](../../day-039-merge-linked-lists/dsa_merge-linked-lists/README.md)
...
**Kth tree value.** For a strict binary search tree return kth smallest value; k is valid and one-based.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(height+k) time with iterative traversal.
