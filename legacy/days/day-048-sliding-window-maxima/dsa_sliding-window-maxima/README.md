# Day 048 DSA — Sliding window maxima

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Sliding window maxima** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-48. **Theme:** Stacks, queues and monotone structures.

## Prerequisite and recall

Prior DSA session: [day 47](../../day-047-largest-histogram-rectangle/dsa_largest-histogram-rectangle/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 47](../../day-047-largest-histogram-rectangle/dsa_largest-histogram-rectangle/README.md), [day 41](../../day-041-least-recently-used-cache/dsa_least-recently-used-cache/README.md), [day 27](../../day-027-median-of-two-arrays/dsa_median-of-two-arrays/README.md)
...
**Sliding window maxima.** Return maximum of each length-k window; 1 <= k <= n.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(k) space.
