# Day 140 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/time-based-key-value-store/)

**Difficulty:** Medium. **Original course day:** 134.
...
[Open the official problem](https://leetcode.com/problems/number-of-recent-calls/)

**Difficulty:** Easy. **Original course day:** 138.

**Contract comparison:** Online recent-call window includes its left boundary; the local counter uses an open left boundary and allows equal timestamps.
