# Day 081 — Tail latency

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tail latency** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-81.
**Weekly theme:** Observability and operations.

## Assignment

Explain why fan-out magnifies stragglers; sketch bounded parallelism and timeout behavior.
