# Day 081 — Function caching

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Function caching** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-81.
**Weekly theme:** Functional tools and caching.

## Assignment

Use lru_cache on a pure function and inspect hits/misses; identify argument hashability requirements.
