# Day 124 — Untrusted serialization

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Untrusted serialization** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-124.
**Weekly theme:** Persistence and safe I/O.

## Assignment

Explain why pickle is inappropriate for untrusted input; implement a JSON-based boundary for a small model.
