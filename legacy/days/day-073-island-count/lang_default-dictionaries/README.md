# Day 073 — Default dictionaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Default dictionaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-73.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Show which access forms create a missing entry and which do not.
