# Day 102 — Process pools

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Process pools** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-102.
**Weekly theme:** Threads and processes.

## Assignment

Run a top-level picklable function under an if __name__ guard; explain Windows spawn constraints.
