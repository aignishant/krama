# Day 096 — Shortener deep dive

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Shortener deep dive** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-96.
**Weekly theme:** URL shortener case study.

## Assignment

Choose one: hot-key mitigation or alias generation; compare two alternatives and explain the choice.
