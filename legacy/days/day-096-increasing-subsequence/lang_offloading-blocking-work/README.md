# Day 096 — Offloading blocking work

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Offloading blocking work** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-96.
**Weekly theme:** Async reliability.

## Assignment

Use asyncio.to_thread for a small blocking function; explain why canceling the await does not forcibly stop the thread.
