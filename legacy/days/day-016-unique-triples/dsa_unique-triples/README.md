...
7. **Recall later without practice:** read [this day's card](../../../docs/DSA_RECALL.md#day-016-unique-triples) for a previously studied topic; reading is not completion.
