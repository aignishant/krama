# Day 132 DSA — Bipartite matching

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Bipartite matching** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-132. **Theme:** Advanced graph and tree practice.

## Prerequisite and recall

Prior DSA session: [day 131](../../day-131-tree-distance-sums/dsa_tree-distance-sums/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 131](../../day-131-tree-distance-sums/dsa_tree-distance-sums/README.md), [day 125](../../day-125-dictionary-wildcard-search/dsa_dictionary-wildcard-search/README.md), [day 111](../../day-111-visit-every-city/dsa_visit-every-city/README.md)
...
**Bipartite matching.** Left vertices 0..left-1, right 0..right-1, edges [l,r]. Return maximum number of disjoint pairs.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(VE) augmenting-path baseline.
