# Day 132 — Dependency policy

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Dependency policy** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-132.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Classify direct and transitive dependencies and define upgrade, compatibility and reproducibility checks.
