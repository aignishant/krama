...
Return the first value whose second occurrence is encountered scanning left to right, or null.
...
5. Run `python course.py practice 8` from the repository root. The starter is intentionally RED.
