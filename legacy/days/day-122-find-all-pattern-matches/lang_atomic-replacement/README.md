# Day 122 — Atomic replacement

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Atomic replacement** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-122.
**Weekly theme:** Persistence and safe I/O.

## Assignment

Write a temporary sibling file then replace the target; explain filesystem and durability limits separately.
