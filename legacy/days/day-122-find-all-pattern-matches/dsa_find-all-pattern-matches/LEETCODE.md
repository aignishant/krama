# Day 122 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/)

**Difficulty:** Easy. **Original course day:** 122.

**Contract comparison:** Online returns the first match; local practice returns all matches including overlaps.
