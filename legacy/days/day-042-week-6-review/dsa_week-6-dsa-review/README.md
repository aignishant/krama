...
Original reading, after cold recall: [Day 36](../../day-036-reverse-a-linked-list/dsa_reverse-a-linked-list/README.md) · [Day 37](../../day-037-middle-node/dsa_middle-node/README.md) · [Day 38](../../day-038-cycle-entry/dsa_cycle-entry/README.md) · [Day 39](../../day-039-merge-linked-lists/dsa_merge-linked-lists/README.md) · [Day 40](../../day-040-remove-from-end/dsa_remove-from-end/README.md) · [Day 41](../../day-041-least-recently-used-cache/dsa_least-recently-used-cache/README.md).
...
**Budget:** 60 minutes. **Outcome:** DSA-42. **Theme:** Linked lists and pointer invariants.

## Prerequisite and recall

Prior DSA session: [day 41](../../day-041-least-recently-used-cache/dsa_least-recently-used-cache/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 41](../../day-041-least-recently-used-cache/dsa_least-recently-used-cache/README.md), [day 35](../../day-035-week-5-review/dsa_week-5-dsa-review/README.md), [day 21](../../day-021-week-3-review/dsa_week-3-dsa-review/README.md)
...
**Cold re-solve: Remove from end.** Build a linked list and remove its nth node from the end; 1 <= n <= length. Return serialized values.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time; O(1) traversal space.
