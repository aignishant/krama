# Day 120 DSA — Normalize text units

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Normalize text units** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-120. **Theme:** String algorithms and pattern matching.

## Prerequisite and recall

Prior DSA session: [day 119](../../day-119-week-17-review/dsa_week-17-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 119](../../day-119-week-17-review/dsa_week-17-dsa-review/README.md), [day 113](../../day-113-single-unmatched-value/dsa_single-unmatched-value/README.md), [day 99](../../day-099-grid-path-count/dsa_grid-path-count/README.md)
...
**Normalize text units.** Return list of lowercase alphanumeric Unicode code points from text; use code points, not grapheme clusters.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n) time plus output.
