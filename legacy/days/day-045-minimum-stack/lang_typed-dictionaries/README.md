# Day 045 — Typed dictionaries

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Typed dictionaries** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-45.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Describe a JSON-like payload with TypedDict and required versus optional keys; distinguish schema description from runtime checks.
