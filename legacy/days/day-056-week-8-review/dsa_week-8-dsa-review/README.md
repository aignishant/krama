...
Original reading, after cold recall: [Day 50](../../day-050-enumerate-subsets/dsa_enumerate-subsets/README.md) · [Day 51](../../day-051-enumerate-permutations/dsa_enumerate-permutations/README.md) · [Day 52](../../day-052-combination-sum/dsa_combination-sum/README.md) · [Day 53](../../day-053-balanced-parentheses/dsa_balanced-parentheses/README.md) · [Day 54](../../day-054-word-search/dsa_word-search/README.md) · [Day 55](../../day-055-nonattacking-queens/dsa_nonattacking-queens/README.md).
...
**Budget:** 60 minutes. **Outcome:** DSA-56. **Theme:** Recursion and backtracking.

## Prerequisite and recall

Prior DSA session: [day 55](../../day-055-nonattacking-queens/dsa_nonattacking-queens/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 55](../../day-055-nonattacking-queens/dsa_nonattacking-queens/README.md), [day 49](../../day-049-week-7-review/dsa_week-7-dsa-review/README.md), [day 35](../../day-035-week-5-review/dsa_week-5-dsa-review/README.md)
...
**Cold re-solve: Word search.** Return whether word can be formed by orthogonal steps in a rectangular character grid without reusing a cell. Empty word is true.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(rows*cols*4^L) upper bound.
