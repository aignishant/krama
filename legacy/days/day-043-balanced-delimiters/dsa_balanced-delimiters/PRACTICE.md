...
Return whether a string containing only ()[]{} is properly nested; empty is valid.
...
5. Run `python course.py practice 43` from the repository root. The starter is intentionally RED.
