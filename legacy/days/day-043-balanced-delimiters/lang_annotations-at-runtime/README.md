# Day 043 — Annotations at runtime

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Annotations at runtime** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-43.
**Weekly theme:** Typing foundations for experienced developers.

## Assignment

Annotate a function then deliberately pass the wrong type; show annotations alone do not enforce validation.
