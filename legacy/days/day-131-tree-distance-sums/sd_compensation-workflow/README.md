# Day 131 — Compensation workflow

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Compensation workflow** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-131.
**Weekly theme:** Payments and reservations case study.

## Assignment

Draw reserve -> authorize -> confirm with timeouts and compensations; distinguish reversible and irreversible effects.
