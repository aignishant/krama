# Day 155 DSA — Mock arrays

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock arrays** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-155. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 154](../../day-154-week-22-review/dsa_week-22-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 154](../../day-154-week-22-review/dsa_week-22-dsa-review/README.md), [day 148](../../day-148-interleaved-strings/dsa_interleaved-strings/README.md), [day 134](../../day-134-time-indexed-values/dsa_time-indexed-values/README.md)
...
**Mock arrays.** Return length of longest subarray containing at most k distinct integers; k >= 0.
