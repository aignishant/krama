# Day 155 — Semantics drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Semantics drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-155.
**Weekly theme:** Python interview drills.

## Assignment

Explain aliasing, equality, hashability and mutable defaults using four tiny executable counterexamples.
