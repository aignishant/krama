...
7. **Recall later without practice:** read [this day's recall card](../../../docs/SD_RECALL.md#day-012-timeout-propagation) for a previously studied topic. Reading is not learner completion.
