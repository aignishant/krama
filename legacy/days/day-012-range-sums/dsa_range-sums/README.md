...
7. **Recall later without practice:** read [this day's recall card](../../../docs/DSA_RECALL.md#day-012-range-sums) for a previously studied topic. Reading is not learner completion.
...
**Budget:** 60 minutes. **Outcome:** DSA-12. **Theme:** Hashing and prefix sums.

## Prerequisite and recall

Prior DSA session: [day 11](../../day-011-group-anagrams/dsa_group-anagrams/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 11](../../day-011-group-anagrams/dsa_group-anagrams/README.md), [day 5](../../day-005-merge-sorted-arrays/dsa_merge-sorted-arrays/README.md)
...
**Range sums.** For each inclusive [left,right] query return the sum. Queries are valid for nums; an empty nums has no queries.
