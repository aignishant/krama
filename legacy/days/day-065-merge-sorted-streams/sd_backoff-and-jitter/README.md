# Day 065 — Backoff and jitter

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Backoff and jitter** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-65.
**Weekly theme:** Reliability patterns.

## Assignment

Sketch retry times for synchronized versus jittered clients and define a maximum attempt/deadline budget.
