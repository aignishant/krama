# Day 159 DSA — Mock heap

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock heap** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-159. **Theme:** Mock interviews and weak-area repair.

## Prerequisite and recall

Prior DSA session: [day 158](../../day-158-mock-dp/dsa_mock-dp/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 158](../../day-158-mock-dp/dsa_mock-dp/README.md), [day 152](../../day-152-shortest-subarray-with-negatives/dsa_shortest-subarray-with-negatives/README.md), [day 138](../../day-138-expiring-counter/dsa_expiring-counter/README.md)
...
**Mock heap.** Return minimum cost to connect all given 2D points using Manhattan-distance edges; empty returns 0.
