# Day 099 — Thread ownership

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Thread ownership** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-99.
**Weekly theme:** Threads and processes.

## Assignment

Design shared-counter synchronization with a Lock; do not assume a race must reproduce on every run.
