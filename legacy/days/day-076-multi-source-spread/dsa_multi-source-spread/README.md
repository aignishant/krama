# Day 076 DSA — Multi-source spread

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Multi-source spread** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-76. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 75](../../day-075-two-color-graph/dsa_two-color-graph/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 75](../../day-075-two-color-graph/dsa_two-color-graph/README.md), [day 69](../../day-069-tree-codec-round-trip/dsa_tree-codec-round-trip/README.md), [day 55](../../day-055-nonattacking-queens/dsa_nonattacking-queens/README.md)
...
**Multi-source spread.** Grid 0 is empty, 1 fresh, 2 active. Active cells spread orthogonally each step. Return steps to activate all fresh cells or -1.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(rows*cols) time.
