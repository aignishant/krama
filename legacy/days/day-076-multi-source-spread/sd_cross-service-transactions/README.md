# Day 076 — Cross-service transactions

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Cross-service transactions** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-76.
**Weekly theme:** Distributed coordination.

## Assignment

Compare coordinated commit and compensating actions for a reservation plus charge workflow.
