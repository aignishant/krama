# Day 076 — Sorting keys

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Sorting keys** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-76.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Demonstrate stable multi-key sorting and why a key function is preferable to repeated derived comparisons.
