# Practice — Lowest shared ancestor
...
Values are unique and both p and q exist. Return the value of their lowest common ancestor, possibly one node itself.
...
Input:
```json
{"tree":[3,[5,[6,null,null],[2,null,null]],[1,null,null]],"p":6,"q":2}
```
...
5. Run `python course.py practice 62` from the repository root. The starter is intentionally RED.
