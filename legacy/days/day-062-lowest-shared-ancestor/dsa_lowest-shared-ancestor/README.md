# Day 062 DSA — Lowest shared ancestor

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Lowest shared ancestor** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-62. **Theme:** Binary trees and search trees.

## Prerequisite and recall

Prior DSA session: [day 61](../../day-061-tree-diameter/dsa_tree-diameter/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 61](../../day-061-tree-diameter/dsa_tree-diameter/README.md), [day 55](../../day-055-nonattacking-queens/dsa_nonattacking-queens/README.md), [day 41](../../day-041-least-recently-used-cache/dsa_least-recently-used-cache/README.md)
...
**Lowest shared ancestor.** Values are unique and both p and q exist. Return the value of their lowest common ancestor, possibly one node itself.
