# Day 134 — Structured logs

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Structured logs** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-134.
**Weekly theme:** Production Python service code.

## Assignment

Emit a correlation field via logging without including credentials or full sensitive payloads.
