# Day 134 DSA — Time-indexed values

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Time-indexed values** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-134. **Theme:** Data structure design and tradeoffs.

## Prerequisite and recall

Prior DSA session: [day 133](../../day-133-week-19-review/dsa_week-19-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 133](../../day-133-week-19-review/dsa_week-19-dsa-review/README.md), [day 127](../../day-127-longest-dag-path/dsa_longest-dag-path/README.md), [day 113](../../day-113-single-unmatched-value/dsa_single-unmatched-value/README.md)
...
**Time-indexed values.** Process [set,key,value,timestamp] with strictly increasing timestamps per key, and [get,key,timestamp]. Return latest value <= timestamp or null.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) get; amortized O(1) append.
