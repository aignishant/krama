...
7. **Recall later without practice:** read the [system design summary file](../../../docs/SD_RECALL.md#day-020-modular-monolith) for previously studied topics. Cards appear as days are taught; their presence does not mark study complete.

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-20.
**Weekly theme:** Service boundaries and API design.

## Assignment

Draw internal modules for links and analytics; state an observable trigger for extracting a service.
