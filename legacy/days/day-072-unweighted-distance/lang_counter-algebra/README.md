# Day 072 — Counter algebra

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Counter algebra** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-72.
**Weekly theme:** Collections and algorithms in Python.

## Assignment

Test Counter subtraction versus subtract, including zero and negative counts.
