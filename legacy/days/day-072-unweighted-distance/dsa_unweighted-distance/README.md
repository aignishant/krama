# Day 072 DSA — Unweighted distance

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Unweighted distance** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-72. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 71](../../day-071-reachability/dsa_reachability/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 71](../../day-071-reachability/dsa_reachability/README.md), [day 65](../../day-065-merge-sorted-streams/dsa_merge-sorted-streams/README.md), [day 51](../../day-051-enumerate-permutations/dsa_enumerate-permutations/README.md)
...
**Unweighted distance.** Return fewest edges from src to dst in an undirected graph, or -1.
