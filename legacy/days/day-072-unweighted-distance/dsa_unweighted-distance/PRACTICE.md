...
Return fewest edges from src to dst in an undirected graph, or -1.
...
Input:
```json
{"n":4,"edges":[[0,1],[1,2],[0,3],[3,2]],"src":0,"dst":2}
```
...
5. Run `python course.py practice 72` from the repository root. The starter is intentionally RED.
