# Day 071 DSA — Reachability

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Reachability** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-71. **Theme:** Graph traversal and dependencies.

## Prerequisite and recall

Prior DSA session: [day 70](../../day-070-week-10-review/dsa_week-10-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 70](../../day-070-week-10-review/dsa_week-10-dsa-review/README.md), [day 64](../../day-064-k-largest-stream-values/dsa_k-largest-stream-values/README.md), [day 50](../../day-050-enumerate-subsets/dsa_enumerate-subsets/README.md)
...
**Reachability.** Given n vertices 0..n-1 and undirected edges, return whether src reaches dst.
