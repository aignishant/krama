...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Least frequently used cache** is not yet expanded.
...
Prior DSA session: [day 135](../../day-135-frequency-stack/dsa_frequency-stack/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 135](../../day-135-frequency-stack/dsa_frequency-stack/README.md), [day 129](../../day-129-redundant-undirected-edge/dsa_redundant-undirected-edge/README.md), [day 115](../../day-115-modular-power/dsa_modular-power/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Expected O(1) operations; stretch.
