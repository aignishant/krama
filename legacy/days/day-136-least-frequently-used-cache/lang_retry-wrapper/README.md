# Day 136 — Retry wrapper

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Retry wrapper** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-136.
**Weekly theme:** Production Python service code.

## Assignment

Inject clock, sleep and operation dependencies into a bounded retry function; test without real delays.
