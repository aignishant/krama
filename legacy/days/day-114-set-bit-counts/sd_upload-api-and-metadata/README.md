# Day 114 — Upload API and metadata

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Upload API and metadata** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-114.
**Weekly theme:** Upload and media case study.

## Assignment

Separate file bytes from metadata; specify upload session and completion contract.
