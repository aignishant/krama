# Day 114 DSA — Set bit counts

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Set bit counts** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-114. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 113](../../day-113-single-unmatched-value/dsa_single-unmatched-value/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 113](../../day-113-single-unmatched-value/dsa_single-unmatched-value/README.md), [day 107](../../day-107-equal-partition/dsa_equal-partition/README.md), [day 93](../../day-093-nonadjacent-loot/dsa_nonadjacent-loot/README.md)
...
**Set bit counts.** Return popcount for every integer from 0 through n, where n >= 0.
