# Day 114 — Unicode normalization

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Unicode normalization** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-114.
**Weekly theme:** Files, text and data boundaries.

## Assignment

Compare canonically equivalent strings before and after normalization; distinguish code points from displayed characters.
