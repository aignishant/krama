# Day 069 — Debugging workflow

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Debugging workflow** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-69.
**Weekly theme:** Testing and debugging.

## Assignment

Reproduce one failure, minimize its input, inspect state, then keep a regression test.
