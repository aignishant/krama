# Day 133 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/)

**Difficulty:** Hard. **Original course day:** 127.

**Contract comparison:** Related longest-path DAG with implicit matrix edges; local practice receives explicit edges and counts edges.

Official page checked on 2026-09-18; premium statements were not accessible.

## 834. Sum of Distances in Tree

[Open the official problem](https://leetcode.com/problems/sum-of-distances-in-tree/)

**Difficulty:** Hard. **Original course day:** 131.
