...
Original reading, after cold recall: [Day 127](../../day-127-longest-dag-path/lang_import-execution/README.md) · [Day 128](../../day-128-minimum-effort-grid-route/lang_circular-imports/README.md) · [Day 129](../../day-129-redundant-undirected-edge/lang_entry-points/README.md) · [Day 130](../../day-130-subtree-sizes/lang_package-layout/README.md) · [Day 131](../../day-131-tree-distance-sums/lang_environment-isolation/README.md) · [Day 132](../../day-132-bipartite-matching/lang_dependency-policy/README.md).

[Back to the day hub](../LESSON.md) · [Independent study and progress](../../../docs/STUDY_WORKFLOW.md)

**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-133.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Revisit days 127–132. From memory reproduce one surprising behavior, write a regression test for its repair, and explain the mechanism.
