# Day 129 — Entry points

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Entry points** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-129.
**Weekly theme:** Modules, imports and packaging.

## Assignment

Separate reusable functions from the __main__ entry point and test importing without side effects.
