# Day 061 DSA — Tree diameter

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Tree diameter** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-61. **Theme:** Binary trees and search trees.

## Prerequisite and recall

Prior DSA session: [day 60](../../day-060-kth-tree-value/dsa_kth-tree-value/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 60](../../day-060-kth-tree-value/dsa_kth-tree-value/README.md), [day 54](../../day-054-word-search/dsa_word-search/README.md), [day 40](../../day-040-remove-from-end/dsa_remove-from-end/README.md)
...
**Tree diameter.** Return maximum edges on any path between two nodes; empty and singleton have diameter 0.
