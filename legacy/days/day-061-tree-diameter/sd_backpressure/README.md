# Day 061 — Backpressure

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Backpressure** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-61.
**Weekly theme:** Queues and event processing.

## Assignment

Given arrival rate above processing rate, calculate backlog growth and compare buffering, shedding and throttling.
