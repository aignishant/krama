# Day 157 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/number-of-ways-to-arrive-at-destination/)

**Difficulty:** Medium. **Original course day:** 157.

**Contract comparison:** Online has positive weighted roads and modular path counts; local practice uses unweighted edges and exact counts.
