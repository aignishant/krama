...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock graph** is not yet expanded.
...
Prior DSA session: [day 156](../../day-156-mock-search/dsa_mock-search/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 156](../../day-156-mock-search/dsa_mock-search/README.md), [day 150](../../day-150-maximum-path-sum/dsa_maximum-path-sum/README.md), [day 136](../../day-136-least-frequently-used-cache/dsa_least-frequently-used-cache/README.md)
