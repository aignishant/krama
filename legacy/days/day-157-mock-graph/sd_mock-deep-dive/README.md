# Day 157 — Mock deep dive

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mock deep dive** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-157.
**Weekly theme:** Design interviews and critique.

## Assignment

Handle a worker dying after executing a job but before acknowledging it; state side-effect deduplication requirements.
