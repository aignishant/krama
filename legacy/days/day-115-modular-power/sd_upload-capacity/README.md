# Day 115 — Upload capacity

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Upload capacity** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-115.
**Weekly theme:** Upload and media case study.

## Assignment

Estimate bandwidth and storage; distinguish ingress, transcoding and egress workloads.
