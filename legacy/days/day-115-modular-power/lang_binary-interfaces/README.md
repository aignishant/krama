# Day 115 — Binary interfaces

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Binary interfaces** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-115.
**Weekly theme:** Files, text and data boundaries.

## Assignment

Use bytes, bytearray and memoryview to demonstrate immutable, mutable and view behavior.
