# Day 066 DSA — Running median

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Running median** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-66. **Theme:** Heaps, tries and tree construction.

## Prerequisite and recall

Prior DSA session: [day 65](../../day-065-merge-sorted-streams/dsa_merge-sorted-streams/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 65](../../day-065-merge-sorted-streams/dsa_merge-sorted-streams/README.md), [day 59](../../day-059-validate-search-tree/dsa_validate-search-tree/README.md), [day 45](../../day-045-minimum-stack/dsa_minimum-stack/README.md)
...
**Running median.** After each integer insertion return the current median as a number.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) per insertion.
