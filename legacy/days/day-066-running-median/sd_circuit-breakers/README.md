# Day 066 — Circuit breakers

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Circuit breakers** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-66.
**Weekly theme:** Reliability patterns.

## Assignment

Specify closed/open/half-open transitions and what callers receive when the breaker opens.
