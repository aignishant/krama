# Day 094 — Shortener capacity

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Shortener capacity** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-94.
**Weekly theme:** URL shortener case study.

## Assignment

Compute peak redirect QPS, new-record storage and cache working set using your assumptions.
