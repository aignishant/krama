# Day 165 DSA — Range capstone

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Range capstone** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-165. **Theme:** Capstone and retention.

## Prerequisite and recall

Prior DSA session: [day 164](../../day-164-search-capstone/dsa_search-capstone/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 164](../../day-164-search-capstone/dsa_search-capstone/README.md), [day 158](../../day-158-mock-dp/dsa_mock-dp/README.md), [day 144](../../day-144-top-frequent-words/dsa_top-frequent-words/README.md)
...
**Range capstone.** Process inclusive range queries [left,right] returning number of distinct values in nums; indices valid.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O((n+q) log n) offline target; stretch.
