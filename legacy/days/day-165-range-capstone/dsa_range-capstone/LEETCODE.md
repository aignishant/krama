# Day 165 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/count-of-smaller-numbers-after-self/)

**Difficulty:** Hard. **Original course day:** 165.

**Contract comparison:** Related offline order-statistics/range-count drill, not distinct values per interval. Retain the local exercise for its latest-occurrence technique.
