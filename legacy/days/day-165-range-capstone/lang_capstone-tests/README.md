# Day 165 — Capstone tests

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Capstone tests** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-165.
**Weekly theme:** Python capstone and retention.

## Assignment

Add fake-clock tests for timeout/retry decisions and a real failure-path test.
