# Day 130 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label/)

**Difficulty:** Medium. **Original course day:** 130.

**Contract comparison:** Online subtree counts are label-specific; local practice counts every node in each subtree.
