...
Given tree edges on 0..n-1 rooted at 0, return subtree sizes by vertex index; n >= 1.
...
5. Run `python course.py practice 130` from the repository root. The starter is intentionally RED.
