# Day 130 DSA — Subtree sizes

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Subtree sizes** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-130. **Theme:** Advanced graph and tree practice.

## Prerequisite and recall

Prior DSA session: [day 129](../../day-129-redundant-undirected-edge/dsa_redundant-undirected-edge/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 129](../../day-129-redundant-undirected-edge/dsa_redundant-undirected-edge/README.md), [day 123](../../day-123-rolling-hash-matching/dsa_rolling-hash-matching/README.md), [day 109](../../day-109-weighted-scheduling/dsa_weighted-scheduling/README.md)
...
**Subtree sizes.** Given tree edges on 0..n-1 rooted at 0, return subtree sizes by vertex index; n >= 1.
