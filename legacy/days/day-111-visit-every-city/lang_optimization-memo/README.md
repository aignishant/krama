# Day 111 — Optimization memo

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Optimization memo** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-111.
**Weekly theme:** Profiling and memory.

## Assignment

Optimize one measured hotspot, keep behavior tests and record before/after measurements without universal speed claims.
