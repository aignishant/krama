# Day 117 — Upload deep dive

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Upload deep dive** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-117.
**Weekly theme:** Upload and media case study.

## Assignment

Handle chunk checksums, resumability and an upload completed after session expiry.
