# Day 117 DSA — Mutable range sums

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Mutable range sums** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-117. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 116](../../day-116-primes-below-a-bound/dsa_primes-below-a-bound/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 116](../../day-116-primes-below-a-bound/dsa_primes-below-a-bound/README.md), [day 110](../../day-110-matrix-chain-cost/dsa_matrix-chain-cost/README.md), [day 96](../../day-096-increasing-subsequence/dsa_increasing-subsequence/README.md)
...
**Mutable range sums.** Process [add,index,delta] and [sum,left,right] inclusive over nums; valid indices. Return sums. Use a binary indexed tree.
