# Day 126 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/valid-palindrome/)

**Difficulty:** Easy. **Original course day:** 120.

**Contract comparison:** Related text-normalization drill with a palindrome decision; local practice returns normalized code points.

Official page checked on 2026-09-18; premium statements were not accessible.

## 76. Minimum Window Substring

[Open the official problem](https://leetcode.com/problems/minimum-window-substring/)

**Difficulty:** Hard. **Original course day:** 124.
