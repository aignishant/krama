# Day 144 DSA — Top frequent words

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Top frequent words** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-144. **Theme:** Mixed pattern selection I.

## Prerequisite and recall

Prior DSA session: [day 143](../../day-143-trapped-rainwater/dsa_trapped-rainwater/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 143](../../day-143-trapped-rainwater/dsa_trapped-rainwater/README.md), [day 137](../../day-137-order-statistic-stream/dsa_order-statistic-stream/README.md), [day 123](../../day-123-rolling-hash-matching/dsa_rolling-hash-matching/README.md)
...
**Top frequent words.** Return top k distinct words by descending count then lexicographic order; 0 <= k <= distinct count.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Count then O(u log u) baseline; heap extension.
