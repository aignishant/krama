# Day 116 DSA — Primes below a bound

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Primes below a bound** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-116. **Theme:** Bits, arithmetic and range structures.

## Prerequisite and recall

Prior DSA session: [day 115](../../day-115-modular-power/dsa_modular-power/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 115](../../day-115-modular-power/dsa_modular-power/README.md), [day 109](../../day-109-weighted-scheduling/dsa_weighted-scheduling/README.md), [day 95](../../day-095-coin-combinations/dsa_coin-combinations/README.md)
...
**Primes below a bound.** Return all primes strictly less than n for n >= 0.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(n log log n) sieve target.
