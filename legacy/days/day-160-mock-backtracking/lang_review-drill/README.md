# Day 160 — Review drill

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Review drill** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-160.
**Weekly theme:** Python interview drills.

## Assignment

Review one DSA solution for clarity, complexity accounting, mutation, tests and Python-specific hidden costs.
