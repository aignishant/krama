# Day 160 — Repair round

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Repair round** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-160.
**Weekly theme:** Design interviews and critique.

## Assignment

Rewrite the weakest two sections and answer a changed requirement without replacing the whole architecture.
