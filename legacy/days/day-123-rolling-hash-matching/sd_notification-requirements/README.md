# Day 123 — Notification requirements

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Notification requirements** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-123.
**Weekly theme:** Search and notifications case studies.

## Assignment

Define email/push channels, preference checks and urgency classes.
