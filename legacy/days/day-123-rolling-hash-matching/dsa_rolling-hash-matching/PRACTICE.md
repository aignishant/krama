# Practice — Rolling hash matching
...
Return first index of pattern in text or -1; empty pattern returns 0. Use rolling hash and verify equal hashes by direct comparison.
...
5. Run `python course.py practice 123` from the repository root. The starter is intentionally RED.
...
9. Explain correctness, time, auxiliary space and output space. Target: **Expected linear; explain worst-case collisions**.
