# Day 145 — Version compatibility

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Version compatibility** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-145.
**Weekly theme:** Internals and version-aware Python.

## Assignment

Choose one feature newer than the local interpreter, read its official version note and design a fallback without pretending it ran locally.
