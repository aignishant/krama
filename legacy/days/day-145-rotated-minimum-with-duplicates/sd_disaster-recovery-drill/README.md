# Day 145 — Disaster recovery drill

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Disaster recovery drill** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-145.
**Weekly theme:** Multi-region and advanced tradeoffs.

## Assignment

Write a restore checklist and observable acceptance tests; distinguish backup existence from successful recovery.
