# Day 059 — Finally behavior

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Finally behavior** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-59.
**Weekly theme:** Exceptions and resource lifetime.

## Assignment

Demonstrate why returning from finally can hide an exception; remove that behavior.
