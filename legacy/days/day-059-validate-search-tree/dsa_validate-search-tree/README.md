# Day 059 DSA — Validate search tree

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Validate search tree** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-59. **Theme:** Binary trees and search trees.

## Prerequisite and recall

Prior DSA session: [day 58](../../day-058-level-order/dsa_level-order/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 58](../../day-058-level-order/dsa_level-order/README.md), [day 52](../../day-052-combination-sum/dsa_combination-sum/README.md), [day 38](../../day-038-cycle-entry/dsa_cycle-entry/README.md)
...
**Validate search tree.** Return whether every left descendant is strictly smaller and every right descendant strictly larger. Duplicates invalid.
