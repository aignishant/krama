...
Return ways to climb n steps using 1 or 2 steps; n >= 0 and there is one empty route for n=0.
...
5. Run `python course.py practice 92` from the repository root. The starter is intentionally RED.
