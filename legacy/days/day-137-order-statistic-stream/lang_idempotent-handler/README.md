# Day 137 — Idempotent handler

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Idempotent handler** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-137.
**Weekly theme:** Production Python service code.

## Assignment

Implement a small in-memory event handler with duplicate detection; state restart and concurrency limitations.
