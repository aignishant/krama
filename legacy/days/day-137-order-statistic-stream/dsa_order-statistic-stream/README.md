# Day 137 DSA — Order statistic stream

## Navigation — where to start

1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Order statistic stream** is not yet expanded.
...
**Budget:** 60 minutes. **Outcome:** DSA-137. **Theme:** Data structure design and tradeoffs.

## Prerequisite and recall

Prior DSA session: [day 136](../../day-136-least-frequently-used-cache/dsa_least-frequently-used-cache/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 136](../../day-136-least-frequently-used-cache/dsa_least-frequently-used-cache/README.md), [day 130](../../day-130-subtree-sizes/dsa_subtree-sizes/README.md), [day 116](../../day-116-primes-below-a-bound/dsa_primes-below-a-bound/README.md)
...
**Order statistic stream.** After each insertion return the kth largest so far, or null until k values exist; k >= 1.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log k) per insertion.
