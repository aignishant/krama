# Day 052 — Consistency models

## Navigation — where to start

1. **Prepare before practice:** read the [design method](../../../docs/SD_DESIGN_GUIDE.md). This is a shared preparation guide; the full explanation of **Consistency models** is not yet expanded.
...
**Track:** sd. **Budget:** 30 minutes (5 recall + 10 concept/reference + 12 design + 3 critique). **Outcome:** SD-52.
**Weekly theme:** Replication and consistency.

## Assignment

Write one history permitted by eventual consistency but forbidden by linearizability.
