...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Combination sum** is not yet expanded.
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Output-sensitive exponential search.
