# Day 052 — Literal states

## Navigation — where to start

1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Literal states** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-52.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Use Literal for a finite mode and exhaustive branching; keep runtime validation at the external boundary.
