...
**Budget:** 60 minutes. **Outcome:** DSA-22. **Theme:** Binary search and ordered answers.

## Prerequisite and recall

Prior DSA session: [day 21](../../day-021-week-3-review/dsa_week-3-dsa-review/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 21](../../day-021-week-3-review/dsa_week-3-dsa-review/README.md), [day 15](../../day-015-sorted-pair-existence/dsa_sorted-pair-existence/README.md), [day 1](../../day-001-count-target-values/dsa_count-target-values/README.md)
...
**Lower bound.** Return first index with nums[i] >= target, or len(nums), for sorted nums.

After learning the topic, open [PRACTICE.md](PRACTICE.md). General mechanisms belong in
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: O(log n) time; O(1) space.
