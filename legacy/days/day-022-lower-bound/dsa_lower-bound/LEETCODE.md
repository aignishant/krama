# Day 022 — LeetCode interview practice
...
[Open the official problem](https://leetcode.com/problems/search-insert-position/)

**Difficulty:** Easy. **Original course day:** 22.

**Contract comparison:** Online inputs are strictly increasing; local lower-bound practice also tests duplicates.
