...
1. **Prepare before practice:** read the [DSA pattern guide](../../../docs/DSA_PATTERN_GUIDE.md). This is a shared preparation guide; the full explanation of **Nonattacking queens** is not yet expanded.
...
Prior DSA session: [day 54](../../day-054-word-search/dsa_word-search/README.md). Read only its notes if already comfortable.
Recall one candidate, not all of them: [day 54](../../day-054-word-search/dsa_word-search/README.md), [day 48](../../day-048-sliding-window-maxima/dsa_sliding-window-maxima/README.md), [day 34](../../day-034-count-inversions/dsa_count-inversions/README.md)
...
the explanation; [HINTS.md](HINTS.md) helps apply them after an attempt. Expected target: Exponential search with pruning.
