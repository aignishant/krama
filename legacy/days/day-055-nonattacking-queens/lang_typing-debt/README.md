...
1. **Prepare before practice:** read the [Python lab method](../../../docs/PYTHON_LAB_GUIDE.md). This is a shared preparation guide; the full explanation of **Typing debt** is not yet expanded.
...
**Track:** lang. **Budget:** 15 minutes (3 predict + 8 experiment + 4 explain/test). **Outcome:** PY-55.
**Weekly theme:** Advanced typing and API contracts.

## Assignment

Review one existing practice solution and replace Any only where it clarifies a real interface.
